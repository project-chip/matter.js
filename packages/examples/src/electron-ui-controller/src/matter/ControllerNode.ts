...
export class ControllerNode {
    ...
    async start(
        ...
        // Electron's node.js Crypto differs from node.js default Crypto (openssl/boringssl)
        // use matter.js Crypto instead
        ...
        console.log(`Storage location: ${controllerStorage} (Directory)`);
        ...
        logger.info(`await commissioningController.start()`);
        /** Start the Matter Controller Node */
        await commissioningController.start();
        logger.info(`await commissioningController.start() done`);
        ...
        try {
            ...
            console.log(
                ...
                nodeDetails.find(node => node.nodeId === nodeId),
            );
