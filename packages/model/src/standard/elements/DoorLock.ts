...
export const DoorLock = Cluster({
    ...
    children: [
        ...
        Command({
            ...
            children: [Field({ name: "LogIndex", id: 0x0, type: "uint16", conformance: "M", constraint: "desc" })]
        }),
        ...
        Command({
            ...
            children: [Field({ name: "UserId", id: 0x0, type: "uint16", conformance: "M", constraint: "desc" })]
        }),
        ...
        Command({
            ...
            children: [
                ...
                Field({
                    name: "ProgramEventCode", id: 0x1, type: "ProgrammingEventCodeEnum", conformance: "M",
                    constraint: "desc"
                }),
                Field({
        ...
        Datatype({
            ...
            children: [
                ...
                Field({
                    name: "WrongCodeEntryLimit", constraint: "4", description: "Tamper Alarm - wrong code entry limit"
                }),
                Field({
                ...
                Field({
                    name: "DoorForcedOpen", constraint: "6",
        ...
        Datatype({
            name: "EventMaskBitmap", type: "map16",
        ...
        Datatype({
            ...
            children: [
                ...
                Field({
                    name: "Eurocylinder", id: 0xb, conformance: "M", description: "Physical lock type is euro cylinder"
                })
            ]
        }),
        ...
        Datatype({
            ...
            children: [
                ...
                Field({
                    name: "LedSignalAll", id: 0x2, conformance: "M",
        ...
        Datatype({
            name: "EventSourceEnum", type: "enum8",
