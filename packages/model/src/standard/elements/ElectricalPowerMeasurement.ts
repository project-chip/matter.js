...
export const ElectricalPowerMeasurement = Cluster({
    ...
    children: [
        ...
        Attribute({
            ...
            children: [Field({ name: "entry", type: "MeasurementAccuracyStruct" })]
        }),
        ...
        Attribute({
            ...
            children: [Field({ name: "entry", type: "MeasurementRangeStruct" })]
        }),
        ...
        Attribute({
            ...
            children: [Field({ name: "entry", type: "HarmonicMeasurementStruct" })]
        }),
