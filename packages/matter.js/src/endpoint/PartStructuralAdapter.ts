...
import { EndpointStructuralAdapter, ClusterStructuralAdapter as BehaviorStructuralAdapter } from "../endpoint/StructuralAdapter.js";
...
function BehaviorStructuralAdapter<C extends Cluster<any, any, any, any, any>>(agent: Agent, cluster: string): undefined | BehaviorStructuralAdapter<C> {
