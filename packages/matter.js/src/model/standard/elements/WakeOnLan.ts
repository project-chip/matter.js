...
Matter.children.push(Cluster({
    name: "WakeOnLan", id: 0x503, classification: "application", description: "Wake on LAN",
    ...
    children: [
        ...
        Attribute({
            name: "MacAddress", id: 0x0, type: "hwadr", access: "R V", conformance: "O", constraint: "max 32",
            quality: "F",
