...
Matter.children.push(Cluster({
    name: "SoftwareDiagnostics", id: 0x34, classification: "node", description: "Software Diagnostics",
    ...
    children: [
        ...
        Attribute({
            name: "CurrentHeapFree", id: 0x1, type: "uint64", access: "R V", conformance: "O", default: 0,
        ...
        Attribute({
            name: "CurrentHeapUsed", id: 0x2, type: "uint64", access: "R V", conformance: "O", default: 0,
