    ...
    children: [
        ...
        Command({
            ...
            children: [Field({
                ...
                children: [Field({ name: "entry", type: "ChargingTargetScheduleStruct" })]
            })]
        }),
        ...
        Datatype({
            ...
            children: [
                ...
                Field({
                    name: "PowerLoss", id: 0x8, conformance: "M", description: "The EVSE has detected a loss in power."
                }),
                Field({
                ...
                Field({
                    name: "EmergencyStop", id: 0xb, conformance: "M",
        ...
        Datatype({
            ...
            children: [
                Field({
                    name: "DayOfWeekForSequence", id: 0x0, type: "TargetDayOfWeekBitmap", access: "M",
                    constraint: "desc"
                }),
                Field({
                    name: "ChargingTargets", id: 0x1, type: "list", access: "M", constraint: "max 10",
                    children: [Field({ name: "entry", type: "ChargingTargetStruct" })]
                })
            ]
        })
    ]
...
Matter.children.push(EnergyEvse);
