    ...
    children: [
        ...
        Attribute({
            ...
            children: [
                ...
                Field({
                    name: "TT", constraint: "3", description: "TextTracks",
                    details: "Device or app supports Text Tracks."
                }),
                Field({
                    name: "AT", constraint: "4", description: "AudioTracks",
                    details: "Device or app supports Audio Tracks."
                })
            ]
        }),
        ...
        Datatype({
            ...
            children: [
                ...
                Field({
                    ...
                    children: [Field({ name: "entry", type: "TrackPreferenceStruct" })]
                })
            ]
        }),
