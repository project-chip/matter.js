...
export const DeviceEnergyManagement = Cluster({
    ...
    children: [
        ...
        Attribute({
            ...
            children: [Field({ name: "entry", type: "PowerAdjustStruct" })]
        }),
        ...
        Command({
            ...
            children: [
                ...
                Field({
                    ...
                    children: [Field({ name: "entry", type: "SlotAdjustmentStruct" })]
                }),
        ...
        Command({
            ...
            children: [
                Field({
                    ...
                    children: [Field({ name: "entry", type: "ConstraintsStruct" })]
                }),
        ...
        Datatype({
            ...
            children: [
                ...
                Field({
                    name: "BatteryStorage", id: 0x5, conformance: "O", description: "Battery Electric Storage System"
                }),
                ...
                Field({
                    name: "HomeWaterPump", id: 0xb, conformance: "O",
        ...
        Datatype({
            ...
            children: [
                ...
                Field({
                    name: "Cancelled", id: 0x4, conformance: "O",
        ...
        Datatype({
            ...
            children: [
                ...
                Field({
                    name: "GridOptimization", id: 0x2, conformance: "O",
        ...
        Datatype({
            ...
            children: [
                ...
                Field({
                    ...
                    children: [Field({ name: "entry", type: "SlotStruct" })]
                }),
        ...
        Datatype({
            ...
            children: [
                ...
                Field({
                    ...
                    children: [Field({ name: "entry", type: "CostStruct" })]
                }),
...
Matter.children.push(DeviceEnergyManagement);
