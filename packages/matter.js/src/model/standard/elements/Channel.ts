    ...
    children: [
        ...
        Attribute({
            ...
            children: [
                ...
                Field({
                    name: "RP", constraint: "3", description: "RecordProgram",
                    details: "Provides ability to record program."
                })
            ]
        }),
        ...
        Command({
            ...
            children: [
                ...
                Field({
                    ...
                    children: [Field({ name: "entry", type: "ProgramStruct" })]
                })
            ]
        }),
        ...
        Datatype({
            ...
            children: [
                ...
                Field({
                    name: "Cable", id: 0x1, conformance: "M",
                ...
                Field({
                    name: "Ott", id: 0x3, conformance: "M", description: "The channel is sourced from an OTT provider."
                })
            ]
        }),
        ...
        Datatype({
            ...
            children: [
                ...
                Field({
                    ...
                    children: [Field({ name: "entry", type: "ProgramCategoryStruct" })]
                }),
                ...
                Field({
                    ...
                    children: [Field({ name: "entry", type: "ProgramCastStruct" })]
                }),
