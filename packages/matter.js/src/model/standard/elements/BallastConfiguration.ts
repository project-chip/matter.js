...
Matter.children.push(Cluster({
    ...
    children: [
        ...
        Attribute({
            name: "BallastStatus", id: 0x2, type: "map8", access: "R V", conformance: "O", default: 0,
        ...
        Attribute({
            name: "PowerOnLevel", id: 0x12, type: "uint8", access: "RW VM", conformance: "D",
            constraint: "1 to 254", default: { type: "reference", name: "PhysicalMaxLevel" },
            xref: { document: "cluster", section: "3.3.7" }
        }),
        Attribute({
            name: "PowerOnFadeTime", id: 0x13, type: "uint16", access: "RW VM", conformance: "D", default: 0,
            xref: { document: "cluster", section: "3.3.7" }
        }),
        ...
        Attribute({
            name: "LampAlarmMode", id: 0x34, type: "map8", access: "RW VM", conformance: "O", default: 0,
