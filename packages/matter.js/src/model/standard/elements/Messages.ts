...
export const Messages = Cluster({
    ...
    children: [
        ...
        Attribute({
            ...
            children: [Field({ name: "entry", type: "MessageStruct" })]
        }),
        ...
        Attribute({
            ...
            children: [Field({ name: "entry", type: "MessageID" })]
        }),
        ...
        Datatype({
            ...
            children: [
                ...
                Field({
                    name: "Increased", id: 0x1, conformance: "M",
                    description: "Similar messages should be sent more often"
                }),
                Field({
                    name: "Reduced", id: 0x2, conformance: "M",
                    description: "Similar messages should be sent less often"
                }),
                Field({
                    name: "Disallowed", id: 0x3, conformance: "M", description: "Similar messages should not be sent"
                }),
