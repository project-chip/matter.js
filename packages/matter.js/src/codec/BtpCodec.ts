...
export class BtpCodec {
    ...
    static encodeHandshakeResponse({ payload }: HandshakeResponse): ByteArray {
    ...
    private static encodeResponsePayload({ finalVersion, attMtu, windowSize }: HandshakeResponsePayload): ByteArray {

        const writer = new DataWriter(Endian.Little);

        // how to add finalversion and sereved bits here?
