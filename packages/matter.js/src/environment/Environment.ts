 ...
 * * `network.interfaceNameTypeMap` - Map of interface names to types, expected to be defined as array of `{name: string, type: number}` objects with types: 1=Wifi, 2=Ethernet, 3=Cellular, 4=Thread
 *
