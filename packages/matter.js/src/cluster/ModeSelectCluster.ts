...
import { Attribute, OptionalAttribute, OptionalWritableAttribute, WritableAttrinute, Cluster, ClusterExtend, Command, TlvNoResponse } from "./Cluster.js";
...
export const TlvSemanticTag = TlvObject({
    mfgCode: TlvField(0x0, TlvNullable(TlvVendorId)),
    value: TlvField(0x1, TlvUInt16), // enum16 in Standard, but values not defined "standard" or "Manufacturer sepcific"
});

/** @see {@link MatterApplicationClusterSpecificationV1_0} § 1.8.8.1  */
const TlvModeOption = TlvObject({
    label: TlvField(0x0, TlvString64max),
    mode: TlvField(0x1, TlvUInt8),
    semanticTags: TlvField(0x2, TlvArray(TlvSemanticTag, { maxLength: 64 })),
});

/** @see {@link MatterApplicationClusterSpecificationV1_0} § 1.8.6.1 */
const TlvChangeToModeRequest = TlvObject({
...
export const ModeSelectCluster = Cluster({
    ...
    revision: 1,
    features: {
        /** Dependency with an On/Off cluster on same endpoint. */
        onOff: BitFlag(0),
    },
    supportedFeatures: {
        onOff: false
    ...
    attributes: {
        ...
        description: Attribute(0x0, TlvString64max), // TODO Fixed
        ...
        /** 
          ...
          */
        standardNamespace: Attribute(0x1, TlvNullable(TlvInt16), { default: null }), // TODO Fixed

        /** Supported modes that may be selected for the CurrentMode attribute */
        supportedModes: Attribute(0x2, TlvArray(TlvModeOption, { maxLength: 255 })), // TODO Fixed
        ...
        startUpMode: OptionalWritableAttribute(0x4, TlvNullable(TlvInt8), { persistent: true }),
    },
...
export const ModeSelectClusterWithOnOffDependency = ClusterExtend(ModeSelectCluster, {
    supportedFeatures: {
        onOff: true
    },
    attributes: {
