...
export const TlvOccupancyBitmap = TlvBitmap(TlvUInt8, {
    occupied: BitFlag(0),
});
...
export const TlvOccupancySensorTypeBitmap = TlvBitmap(TlvUInt8, {
    PIR: BitFlag(0),
 ...
 */
export const OccupancySensingClusterSchema = Cluster({
    id: 0x0406,
    ...
    attributes: {
        ...
        occupancy: Attribute(0x0000, TlvOccupancyBitmap),
        ...
        occupancySensorTypeBitmap: Attribute(0x0002, TlvOccupancySensorTypeBitmap),
