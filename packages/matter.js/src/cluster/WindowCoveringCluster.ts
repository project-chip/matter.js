...
import { BitFlag, BitmapSchema } from "../schema/index.js";
...
const LF = BitmapSchema(WindowCoveringFeatures).encode({
  ...FeatureBase,
  lift: true,
});
const LF_ABS = BitmapSchema(WindowCoveringFeatures).encode({
  ...FeatureBase,
  lift: true,
  absolutePosition: true,
});
const LF_PALF = BitmapSchema(WindowCoveringFeatures).encode({
  ...FeatureBase,
  lift: true,
  positionAwareLift: true,
});
const LF_PALF_ABS = BitmapSchema(WindowCoveringFeatures).encode({
  ...FeatureBase,
  lift: true,
  positionAwareLift: true,
});

const TL = BitmapSchema(WindowCoveringFeatures).encode({
  ...FeatureBase,
  tilt: true,
});
const TL_ABS = BitmapSchema(WindowCoveringFeatures).encode({
  ...FeatureBase,
  tilt: true,
  absolutePosition: true,
});
const TL_PATL = BitmapSchema(WindowCoveringFeatures).encode({
  ...FeatureBase,
  tilt: true,
  positionAwareTilt: true,
});
const TL_PATL_ABS = BitmapSchema(WindowCoveringFeatures).encode({
  ...FeatureBase,
  tilt: true,
  positionAwareTilt: true,
  absolutePosition: true,
