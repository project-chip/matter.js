...
export const SwitchCluster = Cluster({
    ...
    attributes: {
        ...
        multiPressMax: OptionalAttribute(2, TlvUInt8.bound({ min: 2 }), { default: 2 }),
    },
    ...
    events: {
        ...
        MultiPressOngoing: OptionalEvent(5, EventPriority.Info, { newPosition: TlvField(0, TlvUInt8), currentNumberOfPressesCounted: TlvField(1, TlvUInt8) }),

        /** Indicates how many times the switch has been pressed after it has been detected that the sequence has ended. */
        MultiPressComplete: OptionalEvent(6, EventPriority.Info, { previousPosition: TlvField(0, TlvUInt8), totalNumberOfPressesCounted: TlvField(1, TlvUInt8) }),
    }
});
