 ...
 */
export enum PulseWidthModulationFeature {
    /**
     * OnOff
     *
 ...
 */
export const PulseWidthModulationCluster = ExtensibleCluster({
    ...PulseWidthModulationBase,
     ...
     * each {@link PulseWidthModulationFeature} you wish to support.
     *
     * @param features the optional features to support
     * @returns a PulseWidthModulation cluster with specified features enabled
     * @throws {IllegalClusterError} if the feature combination is disallowed by the Matter specification
     */
    factory: <T extends `${PulseWidthModulationFeature}`[]>(...features: [...T]) => {
        validateFeatureSelection(features, PulseWidthModulationFeature);
        const cluster = Cluster({
            ...PulseWidthModulationBase,
            supportedFeatures: BitFlags(PulseWidthModulationBase.features, ...features)
        });
        extendCluster(cluster, FrequencyComponent, { frequency: true });
        return cluster as unknown as PulseWidthModulationExtension<BitFlags<typeof PulseWidthModulationBase.features, T>>;
    }
});

export type PulseWidthModulationExtension<SF extends TypeFromPartialBitSchema<typeof PulseWidthModulationBase.features>> =
    ClusterForBaseCluster<typeof PulseWidthModulationBase, SF>
