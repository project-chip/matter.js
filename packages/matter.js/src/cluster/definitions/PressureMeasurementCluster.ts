 ...
 */
export enum PressureMeasurementFeature {
    /**
     * Extended
     *
 ...
 */
export const PressureMeasurementCluster = ExtensibleCluster({
    ...PressureMeasurementBase,

    /**
     * Use this factory method to create a PressureMeasurement cluster with support for optional features. Include each
     * {@link PressureMeasurementFeature} you wish to support.
     *
     * @param features the optional features to support
     * @returns a PressureMeasurement cluster with specified features enabled
     * @throws {IllegalClusterError} if the feature combination is disallowed by the Matter specification
     */
    factory: <T extends `${PressureMeasurementFeature}`[]>(...features: [...T]) => {
        validateFeatureSelection(features, PressureMeasurementFeature);
        const cluster = Cluster({
            ...PressureMeasurementBase,
            supportedFeatures: BitFlags(PressureMeasurementBase.features, ...features)
        });
        return cluster as unknown as PressureMeasurementExtension<BitFlags<typeof PressureMeasurementBase.features, T>>;
    }
});

export type PressureMeasurementExtension<SF extends TypeFromPartialBitSchema<typeof PressureMeasurementBase.features>> =
    ClusterForBaseCluster<typeof PressureMeasurementBase, SF>
