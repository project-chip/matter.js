 ...
 */
export enum PowerSourceFeature {
    /**
     * Wired
     *
 ...
 */
export const PowerSourceBase = BaseClusterComponent({
    id: 0x2f,
    name: "PowerSource",
    revision: 1,
    ...
    attributes: {
         ...
         * power. A source with a lower order shall be selected by the Node to provide power before any other source
...
export const WiredComponent = ClusterComponent({
    attributes: {
         ...
         * as specified in WiredCurrentTypeEnum.
         *
         ...
         * in mV (millivolts), expected to be provided by the hard-wired source.
         *
         ...
         * in mA (milliamps), expected to be provided by the hard-wired source.
         *
         ...
         * This set is represented as a list of WiredFaultEnum. When the Node detects a fault has been raised, the
         * appropriate WiredFaultEnum value shall be added to this list, provided it is not already present. This list
...
export const BatteryComponent = ClusterComponent({
    attributes: {
         ...
         * longer be able to provide power to the Node. Values are expressed in half percent units, ranging from 0 to
         * 200. E.g. a value of 48 is equivalent to 24%. A value of NULL shall indicate the Node is currently unable to
         * assess the value.
         *
         ...
         * provide power to the Node. A value of NULL shall indicate the Node is currently unable to assess the value.
         *
         ...
         * This set is represented as a list of BatFaultEnum. When the Node detects a fault has been raised, the
         * appropriate BatFaultEnum value shall be added to this list, provided it is not already present. This list
...
export const RechargeableComponent = ClusterComponent({
    attributes: {
        /**
         * This attribute shall indicate the current state of the battery source with respect to charging as specified
         * in BatChargeStateEnum.
         *
         ...
         * source. A value of NULL shall indicate the Node is currently unable to assess the value.
         *
         ...
         * This set is represented as a list of BatChargeFaultEnum. When the Node detects a fault has been raised, the
         * appropriate BatChargeFaultEnum value shall be added to this list, provided it is not already present. This
    ...
    events: {
         ...
         *
         * detected by the Node on this battery power source changes. This event shall correspond to a change in value
 ...
 * to the Node. In case the Node has multiple power sources, each is described by its own Power Source cluster. The
 ...
 */
export const PowerSourceCluster = ExtensibleCluster({
    ...PowerSourceBase,

    /**
     * Use this factory method to create a PowerSource cluster with support for optional features. Include each
     * {@link PowerSourceFeature} you wish to support.
     *
     * @param features the optional features to support
     * @returns a PowerSource cluster with specified features enabled
     * @throws {IllegalClusterError} if the feature combination is disallowed by the Matter specification
     */
    factory: <T extends `${PowerSourceFeature}`[]>(...features: [...T]) => {
        validateFeatureSelection(features, PowerSourceFeature);
        const cluster = Cluster({ ...PowerSourceBase, supportedFeatures: BitFlags(PowerSourceBase.features, ...features) });
        ...
        return cluster as unknown as PowerSourceExtension<BitFlags<typeof PowerSourceBase.features, T>>;
    }
});

export type PowerSourceExtension<SF extends TypeFromPartialBitSchema<typeof PowerSourceBase.features>> =
    ClusterForBaseCluster<typeof PowerSourceBase, SF>
