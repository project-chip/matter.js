...
export const OccupancySensingCluster = Cluster({
    ...
    attributes: {
         ...
         *
         * The value of the OccupancySensorTypeBitmap attribute and the OccupancySensorType attribute shall be aligned
         * as defined below.
         *
         ...
         * occur in the period PIRUnoccupiedToOccupiedDelay, before the PIR sensor changes to its occupied state. This
         ...
         * Ultrasonic sensor changes to its unoccupied state after the last detection of movement in the sensed area.
         *
        ...
        /**
         * The UltrasonicUnoccupiedToOccupiedThreshold attribute specifies the number of movement detection events that
         * must occur in the period UltrasonicUnoccupiedToOccupiedDelay, before the Ultrasonic sensor changes to its
         * occupied state. This attribute is mandatory if the UltrasonicUnoccupiedToOccupiedDelay attribute is
         * implemented.
         *
         ...
         * physical contact occupancy sensor changes to its unoccupied state after detecting the unoccupied event. The
         * null value indicates that the sensor does not report occupied to unoccupied transition.
         *
        ...
        /**
         * The PhysicalContactUnoccupiedToOccupiedThreshold attribute specifies the number of movement detection events
         * that must occur in the period PhysicalContactUnoccupiedToOccupiedDelay, before the PIR sensor changes to its
         * occupied state. This attribute is mandatory if the PhysicalContactUnoccupiedToOccupiedDelay attribute is
         * implemented.
         *
