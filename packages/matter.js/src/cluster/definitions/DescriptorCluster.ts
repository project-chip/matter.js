...
import { Cluster, FixedAttribute, Attribute } from "../../cluster/Cluster.js";
...
export const DescriptorCluster = Cluster({
    ...
    attributes: {
         ...
         * common for more than one device type in the DeviceTypeList shall be supported as a shared cluster instance
         * on the endpoint.
         *
         ...
         * include the endpoints in this list. See Endpoint Composition for more information which endpoints to include
         * in this list.
         *
