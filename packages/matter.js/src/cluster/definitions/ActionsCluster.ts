...
import { Cluster, Attribute, OptionalAttribute, OptionalCommand, TlvNoResponse, Event, EventPriority } from "../../cluster/Cluster.js";
 ...
 *
 *   • Information about named actions that can be performed on such a group of endpoints (example: recall a scene for
 *     a group of lights by its name)
 *
