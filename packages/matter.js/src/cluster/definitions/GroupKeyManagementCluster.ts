...
export const TlvGroupKeySetStruct = TlvObject({
     ...
     *
     * When CacheAndSync is not supported in the FeatureMap of this cluster, any action attempting to set CacheAndSync
     * in the GroupKeySecurityPolicy field shall fail with an INVALID_COMMAND error.
     *
     ...
     * set.
     *
     * The PerGroupID method maximizes filtering of multicast messages, so that receiving nodes receive only multicast
     * messages for groups to which they are subscribed.
     *
 ...
 */
export enum GroupKeyManagementFeature {
    /**
     * CacheAndSync
     *
