...
export const BallastConfigurationCluster = Cluster({
    ...
    attributes: {
        /**
         * The PhysicalMinLevel attribute specifies the minimum light output the ballast can achieve according to the
         * dimming light curve (see The Dimming Light Curve).
         *
         ...
         * specified in Bit Usage of the BallastStatus Attribute. Where a function is active, the corresponding bit
         * shall be set to 1. Where a function is not active, the corresponding bit shall be set to 0.
         *
         * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.3.6.3
         */
         ...
         * The Dimming Light Curve) when the Level Control Cluster’s CurrentLevel attribute equals to 1 (and the On/Off
         ...
         * to MaxLevel. If an attempt is made to set this attribute to a level where these conditions are not met, a
         * response shall be returned with status code set to CONSTRAINT_ERROR, and the level shall not be set.
         *
         ...
         * The Dimming Light Curve) when the Level Control Cluster’s CurrentLevel attribute equals to 254 (and the
         ...
         * to MinLevel. If an attempt is made to set this attribute to a level where these conditions are not met, a
         * response shall be returned with status code set to CONSTRAINT_ERROR, and the level shall not be set.
         *
         ...
         * the configured light output of the lamps. A typical usage of this mechanism is to compensate for reduction
         ...
         * level that cannot be supported, a response shall be returned with status code set to CONSTRAINT_ERROR, and
