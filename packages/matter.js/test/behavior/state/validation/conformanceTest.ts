            ...
            mandatory: Tests(Fields({ conformance: "M" }), {
                ...
                requires: {
                    error: {
                        ...
                        message: '(128) Validating Test.Test: Conformance "M": Field must be defined',
                    },
                },
            }),
        ...
        feature: Tests(Features({ F: "Foo" }), {
            mandatory: Tests(Fields({ conformance: "F" }), {
                ...
                "requires if enabled": {
                    ...
                    error: {
                        type: ConformanceError,
                        message: '(128) Validating Test.Test: Conformance "F": Field must be defined',
                    },
                },
                ...
                "disallows if disabled": {
                    ...
                    error: {
                        type: ConformanceError,
                        message: '(128) Validating Test.Test: Conformance "F": Field must not be defined',
                    },
                },
            ...
            disjunction: Tests({
                mandatory: Tests(Fields({ conformance: "F | B" }), {
                    ...
                    "disallows if disabled": {
                        ...
                        error: {
                            type: ConformanceError,
                            message: '(128) Validating Test.Test: Conformance "F | B": Field must not be defined',
                        },
                    },
            ...
            conjunction: Tests({
                mandatory: Tests(Fields({ conformance: "F & B" }), {
                    ...
                    "requires if enabled": {
                        ...
                        error: {
                            type: ConformanceError,
                            message: '(128) Validating Test.Test: Conformance "F & B": Field must be defined',
                        },
                    },
        ...
        "trinary logical feature": Tests(Features({ A: "Aye", B: "Bee", C: "See" }), {
            conjunction: Tests(Fields({ conformance: "A & B & C" }), {
                ...
                "requires if enabled": {
                    ...
                    error: {
                        type: ConformanceError,
                        message: '(128) Validating Test.Test: Conformance "A & B & C": Field must be defined',
                    },
                },
                ...
                "disallows if disabled (RHS & LHS enabled)": {
                    ...
                    error: {
                        type: ConformanceError,
                        message: '(128) Validating Test.Test: Conformance "A & B & C": Field must not be defined',
                    },
                },
        ...
        choice: Tests({
            "exactly one": Tests(Fields({ name: "Test1", conformance: "O.a" }, { name: "Test2", conformance: "O.a" }), {
                ...
                "requires one field": {
                    error: {
                        type: ConformanceError,
                        message: '(128) Validating Test: Conformance choice "a": Too few fields present (0 of min 1)',
                    },
                },
                ...
                "disallows multiple fields": {
                    ...
                    error: {
                        type: ConformanceError,
                        message: '(128) Validating Test: Conformance choice "a": Too many fields present (2 of max 1)',
                    },
                },
            }),
                ...
                ),
                {
                    ...
                    "disallows no fields": {
                        error: {
                            type: ConformanceError,
                            message:
                                '(128) Validating Test: Conformance choice "a": Too few fields present (0 of min 2)',
                        },
                    },
                    ...
                    "disallows one field": {
                        ...
                        error: {
                            type: ConformanceError,
                            message:
                                '(128) Validating Test: Conformance choice "a": Too few fields present (1 of min 2)',
                        },
                    },
                    ...
                    "disallows three fields": {
                        ...
                        error: {
                            type: ConformanceError,
                            message:
                                '(128) Validating Test: Conformance choice "a": Too many fields present (3 of max 2)',
                        },
                    },
                },
            ),
                ...
                Fields({ name: "Test1", conformance: "O.a+" }, { name: "Test2", conformance: "O.a+" }),
                {
                    ...
                    "requires one field": {
                        error: {
                            type: ConformanceError,
                            message:
                                '(128) Validating Test: Conformance choice "a": Too few fields present (0 of min 1)',
                        },
                    },
