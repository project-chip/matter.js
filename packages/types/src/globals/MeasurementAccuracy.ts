...
export const TlvMeasurementAccuracy = TlvObject({
     ...
     *
     * @see {@link MatterSpecification.v141.Cluster} § 2.1.4.4.2
     */
     ...
     *
     * @see {@link MatterSpecification.v141.Cluster} § 2.1.4.4.5
     */
