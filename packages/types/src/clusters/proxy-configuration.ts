...
export namespace ProxyConfiguration {
    /**
     * @see {@link MatterSpecification.v141.Core} § 9.15.13.4.1
     */
    export const TlvConfiguration = TlvObject({
         ...
         *
         * @see {@link MatterSpecification.v141.Core} § 9.15.13.4.1.1
         */
         ...
         * specifically proxy.
         *
         * @see {@link MatterSpecification.v141.Core} § 9.15.13.4.1.2
         */
    ...
    export const ClusterInstance = MutableCluster({
        ...
        attributes: {
             ...
             *
             * @see {@link MatterSpecification.v141.Core} § 9.15.13.5.1
             */
     ...
     *
     * @see {@link MatterSpecification.v141.Core} § 9.15.13
     */
