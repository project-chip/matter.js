...
export namespace RvcRunMode {
     ...
     *
     * @see {@link MatterSpecification.v141.Cluster} § 7.2.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v141.Cluster} § 7.2.7.2
         */
        Auto = 0,
         ...
         *
         * @see {@link MatterSpecification.v141.Cluster} § 7.2.7.2.1
         */
        Idle = 16384,
         ...
         *
         * @see {@link MatterSpecification.v141.Cluster} § 7.2.7.2.2
         */
        Cleaning = 16385,
         ...
         *   experience.
         *
         * @see {@link MatterSpecification.v141.Cluster} § 7.2.7.2.3
         */
        Mapping = 16386
    }
     ...
     *
     * @see {@link MatterSpecification.v141.Cluster} § 7.2.5.1
     */
    ...
    export enum ModeChangeStatus {
        /**
         * @see {@link MatterSpecification.v141.Cluster} § 7.2.7.1
         */
        Stuck = 65,
     ...
     *
     * @see {@link MatterSpecification.v141.Cluster} § 1.10.7.2
     */
    export const TlvChangeToModeResponse = TlvObject({
        /**
         * @see {@link MatterSpecification.v141.Cluster} § 1.10.7.2.1
         */
    ...
    export const Base = MutableCluster.Component({
        ...
        attributes: {
             ...
             * mode’s ModeTags.
             *
             * @see {@link MatterSpecification.v141.Cluster} § 7.2.6.1
             */
            ...
            /**
             * @see {@link MatterSpecification.v141.Cluster} § 7.2.6
             */
     ...
     * method.
     *
     * @see {@link MatterSpecification.v141.Cluster} § 7.2
     */
