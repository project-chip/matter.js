...
export namespace OvenMode {
     ...
     *
     * @see {@link MatterSpecification.v13.Cluster} § 8.11.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v13.Cluster} § 8.11.7.1
         */
        Auto = 0,
         ...
         *
         * @see {@link MatterSpecification.v13.Cluster} § 8.11.7.1.1
         */
        Bake = 16384,
         ...
         * duration.
         *
         * @see {@link MatterSpecification.v13.Cluster} § 8.11.7.1.2
         */
        Convection = 16385,
         ...
         * regions.
         *
         * @see {@link MatterSpecification.v13.Cluster} § 8.11.7.1.3
         */
        Grill = 16386,
         ...
         *
         * @see {@link MatterSpecification.v13.Cluster} § 8.11.7.1.4
         */
        Roast = 16387,
         ...
         *
         * @see {@link MatterSpecification.v13.Cluster} § 8.11.7.1.5
         */
        Clean = 16388,
         ...
         *
         * @see {@link MatterSpecification.v13.Cluster} § 8.11.7.1.8
         */
        Warming = 16391,
         ...
         *
         * @see {@link MatterSpecification.v13.Cluster} § 8.11.7.1.9
         */
        Proofing = 16392,
     ...
     *
     * @see {@link MatterSpecification.v13.Cluster} § 8.11.5.1
     */
    ...
    export const Base = MutableCluster.Component({
        ...
        attributes: {
             ...
             * list.
             *
             * @see {@link MatterSpecification.v13.Cluster} § 8.11.6.1
             */
            ...
            /**
             * @see {@link MatterSpecification.v13.Cluster} § 8.11.6
             */
