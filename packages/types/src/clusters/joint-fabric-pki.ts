...
export namespace JointFabricPki {
     ...
     *
     * @see {@link MatterSpecification.v13.Core} § 11.25.4.1
     */
     ...
     *
     * @see {@link MatterSpecification.v13.Core} § 11.25.5.2
     */
    export const TlvIcacsrResponse = TlvObject({
         ...
         *
         * @see {@link MatterSpecification.v13.Core} § 11.25.5.2.1
         */
         ...
         *
         * @see {@link MatterSpecification.v13.Core} § 11.25.5.2.2
         */
     ...
     *
     * @see {@link MatterSpecification.v13.Core} § 11.25.4.2
     */
     ...
     *
     * @see {@link MatterSpecification.v13.Core} § 11.25
     */
