...
export namespace WaterHeaterMode {
     ...
     *
     * @see {@link MatterSpecification.v13.Cluster} § 9.6.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v13.Cluster} § 9.6.7.1
         */
        Auto = 0,
         ...
         *
         * @see {@link MatterSpecification.v13.Cluster} § 9.6.7.1.1
         */
        Off = 16384,
         ...
         *
         * @see {@link MatterSpecification.v13.Cluster} § 9.6.7.1.2
         */
        Manual = 16385,
     ...
     *
     * @see {@link MatterSpecification.v13.Cluster} § 9.6.5.1
     */
    ...
    export const Base = MutableCluster.Component({
        ...
        attributes: {
            ...
            /**
             * @see {@link MatterSpecification.v13.Cluster} § 9.6.6
             */
