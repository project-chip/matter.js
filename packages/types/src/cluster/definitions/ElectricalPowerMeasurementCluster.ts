...
import { TlvEnum, TlvEpochS, TlvInt64, TlvSysTimeMS, TlvUInt8 } from "../../tlv/TlvNumber.js";
import { TlvField, TlvObject, TlvOptionalField } from "../../tlv/TlvObject.js";
import { TypeFromSchema } from "../../tlv/TlvSchema.js";
import { Attribute, EventPriority, FixedAttribute, OptionalAttribute, OptionalEvent } from "../Cluster.js";
...
export namespace ElectricalPowerMeasurement {
    ...
    export const AlternatingCurrentComponent = MutableCluster.Component({
        attributes: {
             ...
             */
            powerFactor: OptionalAttribute(0x11, TlvNullable(TlvInt64.bound({ min: -10000, max: 10000 })), {
                default: null,
            }),
        },
    });
    ...
    export const CompleteInstance = MutableCluster({
        ...
        attributes: {
            ...Base.attributes,
            reactiveCurrent: MutableCluster.AsConditional(AlternatingCurrentComponent.attributes.reactiveCurrent, {
                optionalIf: [ALTC],
            }),
            apparentCurrent: MutableCluster.AsConditional(AlternatingCurrentComponent.attributes.apparentCurrent, {
                optionalIf: [ALTC],
            }),
            reactivePower: MutableCluster.AsConditional(AlternatingCurrentComponent.attributes.reactivePower, {
                optionalIf: [ALTC],
            }),
            apparentPower: MutableCluster.AsConditional(AlternatingCurrentComponent.attributes.apparentPower, {
                optionalIf: [ALTC],
            }),
            rmsVoltage: MutableCluster.AsConditional(AlternatingCurrentComponent.attributes.rmsVoltage, {
                optionalIf: [ALTC],
            }),
            rmsCurrent: MutableCluster.AsConditional(AlternatingCurrentComponent.attributes.rmsCurrent, {
                optionalIf: [ALTC],
            }),
            rmsPower: MutableCluster.AsConditional(AlternatingCurrentComponent.attributes.rmsPower, {
                optionalIf: [ALTC],
            }),
            frequency: MutableCluster.AsConditional(AlternatingCurrentComponent.attributes.frequency, {
                optionalIf: [ALTC],
            }),
            harmonicCurrents: MutableCluster.AsConditional(HarmonicsComponent.attributes.harmonicCurrents, {
                mandatoryIf: [HARM],
            }),
            harmonicPhases: MutableCluster.AsConditional(PowerQualityComponent.attributes.harmonicPhases, {
                mandatoryIf: [PWRQ],
            }),
            powerFactor: MutableCluster.AsConditional(AlternatingCurrentComponent.attributes.powerFactor, {
                optionalIf: [ALTC],
            }),
            neutralCurrent: MutableCluster.AsConditional(PolyphasePowerComponent.attributes.neutralCurrent, {
                optionalIf: [POLY],
            }),
        },
