...
export abstract class Time {
    ...
    abstract getTimer(name: string, durationMs: number, callback: Timer.Callback): Timer;
    ...
    abstract getPeriodicTimer(name: string, intervalMs: number, callback: Timer.Callback): Timer;
