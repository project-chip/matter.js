...
const DECRYPTED_BYTES = ByteArray.fromHex("153600172403312504fcff18172402002403302404001817240200240330240401181724020024033024040218172402002403302404031817240200240328240402181724020024032824040418172403312404031818290324ff0118");
...
const MESSAGE: Message = {
    ...
    payload: ByteArray.fromHex(""),
};
...
describe("SecureSession", () => {
    const secureSession = new SecureSession({} as any, 1, undefined, UNDEFINED_NODE_ID, 0x8d4b, Buffer.alloc(0), DECRYPT_KEY, ENCRYPT_KEY, Buffer.alloc(0), () => { /* do nothing */ });
