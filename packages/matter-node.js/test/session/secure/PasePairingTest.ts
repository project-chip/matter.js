    ...
    describe("Test PASE Spake2 process", () => {
        it("test fix for elliptic library failure", async () => {
            ...
            const serverPbkdfParameters = {
                iterations: 1000,
                salt: ByteArray.fromHex("03959ebc20b8fcbda262d97f9a7a9e76e32d7a1b9c5166b6a3721e88acad8808"),
            };
            ...
            //const peerRandom = ByteArray.fromHex("94eab5c37d101df5ef01b2c8ecada03a7c3b0cf5e26a08feda72617f9cd391a6");
            //const peerSessionId = 71;
            //const passcodeId = DEFAULT_PASSCODE_ID;
            //const hasPbkdfParameters = false;
            //const sessionParams = undefined;
            const requestPayload = ByteArray.fromHex(
                "1530012094eab5c37d101df5ef01b2c8ecada03a7c3b0cf5e26a08feda72617f9cd391a6240247240300280418",
            );

            //const sessionId = 56919;
            //const random = ByteArray.fromHex("22820a42684102fd4a92c0bad66ad1f21f3c5366f5a6d84203035e2c7caf3bae");

            const responsePayload = ByteArray.fromHex(
            ...
            expect(verifier.toHex()).not.equal("13c986aeaf2415c3ae1228b213564fb10b66e013cc1cc9fa2c2b31e8b6c4b0db"); // That was old library
            expect(verifier.toHex()).equal("d6a13c26b6c5b7c514033a0370b1830dff5116fd53de43eb2374737e9b64e4bb");
        });

        it("do special successful pase process", async () => {
            const serverPbkdfParameters = {
                iterations: 1000,
                salt: ByteArray.fromHex("2bb41e9d75f30c2e6b2f059410c56965717cc2bf14ed6c73a169435326a89652"),
            };
            const { w0, L } = await Spake2p.computeW0L(serverPbkdfParameters, 20202021);
            ...
            //const peerRandom = ByteArray.fromHex("913cc0622eca85f8d4c132c89663c5d7afa780667be930e5c11bec865479c617");
            ...
            //const random = ByteArray.fromHex("5682c0732b37c045ebeb416904c187a58b5341088e0172123becfb855f94a72c");
            ...
            const { hBX: verifier } = await spake2p.computeSecretAndVerifiersFromX(L, X, Y);
            expect(verifier.toHex()).equal("52b9b5cb79dafd150b8729102ede22795d0f522ad884d29452818d8c54ca7508");
        });
    });
});
