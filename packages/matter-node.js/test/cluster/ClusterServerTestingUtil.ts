...
import { EndpointData, StatusCode } from "@project-chip/matter.js/interaction";
...
import { ClusterServerObj } from "@project-chip/matter.js/cluster";

// TODO make that nicer
export async function callCommandOnClusterServer(clusterServer: ClusterServerObj<any, any>, commandName: string, args: any, endpoint: EndpointData, session?: SecureSession<MatterDevice>, message?: Message): Promise<{ code: StatusCode, responseId: number, response: any }> {
