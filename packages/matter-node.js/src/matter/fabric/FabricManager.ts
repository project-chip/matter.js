...
export class FabricManager {
    ...
    constructor(persistenceManager: PersistenceManager) {
        ...
        fabrics.forEach(fabric => this.addFabric(Fabric.fromJson(fabric)));
        this.nextFabricIndex = this.fabricPersistence.get<number>("nextFabricIndex", this.nextFabricIndex);
    }

    persistFabrics() {
        this.fabricPersistence.set("fabrics", this.fabrics.map(fabric => fabric.toJson()));
