...
| 4.1              | On/Off Light  <br>(class: 0x0100)                      |            X            |       X       |      X     |        X        |       X      |     X    |                 X                 |
| 4.2              | Dimmable Light <br>(class: 0x0101)                     |            X            |       X       |      X     |        X        |       -      |     X    |                 X                 |
| 4.3              | Color Temperature Light  <br>(class: 0x010C)           |            X            |       X       |      X     |        X        |       -      |     X    |                 X                 |
| 4.4              | Extended Color Light <br>(class: 0x010D)               |            X            |       X       |      X     |        ?        |       -      |     ?    |                 X                 |
| 5                | **Smart Plugs/Outlets/Actuators**                      |                         |               |            |                 |              |          |                                   |
| 5.1              | On/Off Plug-in Unit <br>(class: 0x010A)                |            X            |       X       |      X     |        X        |       X      |     X    |                 X                 |
| 5.2              | Dimmable Plug-in Unit <br>(class: 0x010B)              |            ?            |       ?       |      ?     |        ?        |       -      |     ?    |                 ?                 |
| 5.3              | Pump <br>(class: 0x0303)                               |            -            |       -       |      -     |        -        |       -      |     -    |                 -                 |
| 6                | ** Switches and Control Device Types **                |                         |               |            |                 |              |          |                                   |
| 6.1              | On/Off Light Switch <br>(class: 0x0103)                |            x            |       x       |      ?     |        ?        |       ?      |     ?    |                 x                 |
| 6.2              | Dimmer Switch <br>(class: 0x0104)                      |            X            |       x       |      ?     |        ?        |       ?      |     ?    |                 x                 |
| 6.3              | Color Dimmer Switch <br>(class: 0x0105)                |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 6.4              | Control Bridge <br>(class: 0x0840)                     |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 6.5              | Pump Controller <br>(class: 0x0304)                    |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 6.6              | Generic Switch <br>(class: 0x000F)                     |            X            |       -       |      ?     |        ?        |       ?      |     ?    |                 X                 |
| 7                | **Sensor Device Types**                                |                         |               |            |                 |              |          |                                   |
| 7.1              | Contact Sensor <br>(class: 0x0015)                     |            X            |       X       |      X     |        X        |       ?      |     ?    |                 X                 |
| 7.2              | Light Sensor  <br>(class: 0x0106)                      |            X            |       X       |      -     |        X        |       ?      |     ?    |                 ?                 |
| 7.3              | Occupancy Sensor <br>(class: 0x0107)                   |            X            |       X       |      -     |        ?        |       ?      |     ?    |                 ?                 |
| 7.4              | Temperature Sensor <br>(class: 0x0302)                 |            X            |       X       |      -     |        X        |       ?      |     ?    |                 ?                 |
| 7.5              | Pressure Sensor <br>(class: 0x0305)                    |            -            |       X       |      -     |        ?        |       ?      |     ?    |                 ?                 |
| 7.6              | Flow Sensor  <br>(class: 0x0306)                       |            -            |       X       |      -     |        X        |       ?      |     ?    |                 ?                 |
| 7.7              | Humidity Sensor <br>(class: 0x0307)                    |            X            |       X       |      -     |        X        |       ?      |     ?    |                 ?                 |
| 7.8              | On/Off Sensor <br>(class: 0x0850)                      |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 7.9              | Smoke CO Alarm <br>(class: 0x0076)                     |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 8                | **Closure Device Types**                               |                         |               |            |                 |              |          |                                   |
| 8.1              | Door Lock <br>(class: 0x000A)                          |            X            |       X       |      X     |        X        |       ?      |     ?    |                 X                 |
| 8.2              | Door Lock Controller <br>(class: 0x000B)               |                         |               |            |                 |              |          |                 ?                 |
| 8.3              | * Window Covering <br>(class: 0x0202)                  |            X            | X (Lift only) |      -     |        ?        |       ?      |     ?    |                 X                 |
| 8.4              | * Window Covering Controller <br>(class: 0x0203)       |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 9                | **HVAC Device Types**                                  |                         |               |            |                 |              |          |                                   |
| 9.1              | * Heating/Cooling-Unit <br>(class: 0x0300)             |            -            |       -       |      -     |        -        |       ?      |     ?    |                 ?                 |
| 9.2              | * Thermostat <br>(class: 0x0301)                       |            X            |       X       |      X     |        ?        |       ?      |     ?    |                 ?                 |
| 9.3              | * Fan <br>(class: 0x002B)                              |            -            |       -       |      -     |        -        |       ?      |     ?    |                 ?                 |
| 9.4              | * Air Purifier <br>(class: 0x002D)                     |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 9.5              | * Air Quality Sensor <br>(class: 0x002C)               |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 10               | **Media Devices**                                      |                         |               |            |                 |              |          |                                   |
| 10.1             | * Video Player Architecture                            |            -            |       -       |      -     |        -        |       ?      |     -    |                 ?                 |
| 10.2             | Basic Video Player <br>(class: 0x0028)                 |            -            |       -       |      -     |        -        |       ?      |     -    |                 ?                 |
| 10.3             | Casting Video Player <br>(class: 0x0023)               |            -            |       -       |      -     |        -        |       ?      |     -    |                 ?                 |
| 10.4             | Speaker <br>(class: 0x0022)                            |                         |       X       |      -     |        -        |       ?      |     -    |                 ?                 |
| 10.5             | Content App <br>(class: 0x0024)                        |            -            |       -       |      -     |        -        |       ?      |     -    |                 ?                 |
| 10.6             | Casting Video Client <br>(class: 0x0029)               |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 10.7             | * Video Remote Control <br>(class: 0x002A)             |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 11               | **Generic Devices**                                    |                         |               |            |                 |              |          |                                   |
| 11.1             | Mode Select <br>(class: 0x0027)                        |            -            |       -       |      X     |        -        |       ?      |     -    |                 ?                 |
| 12               | ** Robotic Device Types **                             |                         |               |            |                 |              |          |                                   |
| 12.1             | Robotic Vacuum Cleaner Device Type <br>(class: 0x0074) |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 13               | ** Appliance Device Types **                           |                         |               |            |                 |              |          |                                   |
| 13.1             | Laundry Washer <br>(class: 0x0073)                     |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 13.2             | Refrigerator <br>(class: 0x0070)                       |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 13.3             | Room Air Conditioner <br>(class: 0x0072)               |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 13.4             | Temperature Controlled Cabinet <br>(class: 0x0071)     |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
| 13.5             | Dishwasher <br>(class: 0x0075)                         |            ?            |       ?       |      ?     |        ?        |       ?      |     ?    |                 ?                 |
