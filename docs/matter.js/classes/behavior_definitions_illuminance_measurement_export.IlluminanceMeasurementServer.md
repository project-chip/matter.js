[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/illuminance-measurement/export](../modules/behavior_definitions_illuminance_measurement_export.md) / IlluminanceMeasurementServer

# Class: IlluminanceMeasurementServer

[behavior/definitions/illuminance-measurement/export](../modules/behavior_definitions_illuminance_measurement_export.md).IlluminanceMeasurementServer

This is the default server implementation of [IlluminanceMeasurementBehavior](../modules/behavior_definitions_illuminance_measurement_export.md#illuminancemeasurementbehavior).
...
- [constructor](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#constructor)

### Properties

- [#agent](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md##agent)
- [[reference]](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#[reference])
- [agent](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#agent)
- [cluster](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#cluster)
- [context](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#context)
- [endpoint](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#endpoint)
- [events](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#events)
- [features](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#features)
- [session](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#session)
- [state](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#state)
- [Events](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#events-1)
- [ExtensionInterface](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#extensioninterface)
- [Interface](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#interface)
- [Internal](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#internal)
- [State](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#state-1)
- [cluster](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#cluster-1)
- [defaults](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#defaults)
- [dependencies](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#dependencies)
- [early](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#early)
- [id](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#id)
- [name](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#name)
- [schema](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#schema)
- [supervisor](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#supervisor)
- [supports](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#supports)

### Methods

- [[asyncDispose]](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#[asyncdispose])
- [asAdmin](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#assertattributeenabled)
- [callback](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#callback)
- [initialize](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#initialize)
- [reactTo](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#reactto)
- [requireAttributeEnabled](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#requireattributeenabled)
- [toString](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#tostring)
- [alter](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#alter)
- [enable](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#enable)
- [for](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#for)
- [set](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#set)
- [with](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md#with)

## Constructors

### constructor

• **new IlluminanceMeasurementServer**(`agent`, `backing`): [`IlluminanceMeasurementServer`](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md)
...
[`IlluminanceMeasurementServer`](behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementServer.md)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[#agent](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md##agent)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[[reference]](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#[reference])
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[cluster](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#cluster)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[context](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#context)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[endpoint](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#endpoint)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[events](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#events)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[features](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#features)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[session](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#session)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[state](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#state)
...
▪ `Static` `Readonly` **Events**: [`Type`](../modules/behavior_cluster_export.ClusterEvents.md#type)\<[`Cluster`](../interfaces/cluster_export.IlluminanceMeasurement.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>
...
▪ `Static` `Readonly` **State**: () => [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.IlluminanceMeasurement.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>

#### Type declaration

• **new State**(): [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.IlluminanceMeasurement.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>

##### Returns

[`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.IlluminanceMeasurement.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>
...
▪ `Static` `Readonly` **cluster**: [`Cluster`](../interfaces/cluster_export.IlluminanceMeasurement.Cluster.md)
...
▪ `Static` `Readonly` **defaults**: [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.IlluminanceMeasurement.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[[asyncDispose]](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#[asyncdispose])
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[asAdmin](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#asadmin)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[assertAttributeEnabled](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#assertattributeenabled)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[callback](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#callback)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[initialize](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#initialize)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[reactTo](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#reactto)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[requireAttributeEnabled](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#requireattributeenabled)
...
[IlluminanceMeasurementBehavior](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md).[toString](../interfaces/behavior_definitions_illuminance_measurement_export.IlluminanceMeasurementBehavior-1.md#tostring)
