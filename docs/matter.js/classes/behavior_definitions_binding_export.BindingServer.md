[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/binding/export](../modules/behavior_definitions_binding_export.md) / BindingServer

# Class: BindingServer

[behavior/definitions/binding/export](../modules/behavior_definitions_binding_export.md).BindingServer

This is the default server implementation of [BindingBehavior](../modules/behavior_definitions_binding_export.md#bindingbehavior).
...
- [constructor](behavior_definitions_binding_export.BindingServer.md#constructor)

### Properties

- [#agent](behavior_definitions_binding_export.BindingServer.md##agent)
- [[reference]](behavior_definitions_binding_export.BindingServer.md#[reference])
- [agent](behavior_definitions_binding_export.BindingServer.md#agent)
- [cluster](behavior_definitions_binding_export.BindingServer.md#cluster)
- [context](behavior_definitions_binding_export.BindingServer.md#context)
- [endpoint](behavior_definitions_binding_export.BindingServer.md#endpoint)
- [events](behavior_definitions_binding_export.BindingServer.md#events)
- [features](behavior_definitions_binding_export.BindingServer.md#features)
- [session](behavior_definitions_binding_export.BindingServer.md#session)
- [state](behavior_definitions_binding_export.BindingServer.md#state)
- [Events](behavior_definitions_binding_export.BindingServer.md#events-1)
- [ExtensionInterface](behavior_definitions_binding_export.BindingServer.md#extensioninterface)
- [Interface](behavior_definitions_binding_export.BindingServer.md#interface)
- [Internal](behavior_definitions_binding_export.BindingServer.md#internal)
- [State](behavior_definitions_binding_export.BindingServer.md#state-1)
- [cluster](behavior_definitions_binding_export.BindingServer.md#cluster-1)
- [defaults](behavior_definitions_binding_export.BindingServer.md#defaults)
- [dependencies](behavior_definitions_binding_export.BindingServer.md#dependencies)
- [early](behavior_definitions_binding_export.BindingServer.md#early)
- [id](behavior_definitions_binding_export.BindingServer.md#id)
- [name](behavior_definitions_binding_export.BindingServer.md#name)
- [schema](behavior_definitions_binding_export.BindingServer.md#schema)
- [supervisor](behavior_definitions_binding_export.BindingServer.md#supervisor)
- [supports](behavior_definitions_binding_export.BindingServer.md#supports)

### Methods

- [[asyncDispose]](behavior_definitions_binding_export.BindingServer.md#[asyncdispose])
- [asAdmin](behavior_definitions_binding_export.BindingServer.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_binding_export.BindingServer.md#assertattributeenabled)
- [callback](behavior_definitions_binding_export.BindingServer.md#callback)
- [initialize](behavior_definitions_binding_export.BindingServer.md#initialize)
- [reactTo](behavior_definitions_binding_export.BindingServer.md#reactto)
- [requireAttributeEnabled](behavior_definitions_binding_export.BindingServer.md#requireattributeenabled)
- [toString](behavior_definitions_binding_export.BindingServer.md#tostring)
- [alter](behavior_definitions_binding_export.BindingServer.md#alter)
- [enable](behavior_definitions_binding_export.BindingServer.md#enable)
- [for](behavior_definitions_binding_export.BindingServer.md#for)
- [set](behavior_definitions_binding_export.BindingServer.md#set)
- [with](behavior_definitions_binding_export.BindingServer.md#with)

## Constructors

### constructor

• **new BindingServer**(`agent`, `backing`): [`BindingServer`](behavior_definitions_binding_export.BindingServer.md)
...
[`BindingServer`](behavior_definitions_binding_export.BindingServer.md)
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[#agent](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md##agent)
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[[reference]](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#[reference])
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[cluster](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#cluster)
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[context](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#context)
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[endpoint](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#endpoint)
...
• `Readonly` **events**: [`EventEmitter`](util_export.EventEmitter-1.md) & `Omit`\<[`EventEmitter`](util_export.EventEmitter-1.md), `never`\> & \{ `binding$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`WritableFabricScopedAttribute`](../interfaces/cluster_export.WritableFabricScopedAttribute.md)\<[`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `cluster`: [`OptionalFieldType`](../interfaces/tlv_export.OptionalFieldType.md)\<[`ClusterId`](../modules/datatype_export.md#clusterid)\<`number`\>\> ; `endpoint`: [`OptionalFieldType`](../interfaces/tlv_export.OptionalFieldType.md)\<[`EndpointNumber`](../modules/datatype_export.md#endpointnumber)\> ; `fabricIndex`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<[`FabricIndex`](../modules/datatype_export.md#fabricindex)\> ; `group`: [`OptionalFieldType`](../interfaces/tlv_export.OptionalFieldType.md)\<[`GroupId`](../modules/datatype_export.md#groupid)\> ; `node`: [`OptionalFieldType`](../interfaces/tlv_export.OptionalFieldType.md)\<[`NodeId`](../modules/datatype_export.md#nodeid)\>  }\>[], `any`\>\>  } & {} & \{ `binding$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`WritableFabricScopedAttribute`](../interfaces/cluster_export.WritableFabricScopedAttribute.md)\<[`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `cluster`: [`OptionalFieldType`](../interfaces/tlv_export.OptionalFieldType.md)\<[`ClusterId`](../modules/datatype_export.md#clusterid)\<`number`\>\> ; `endpoint`: [`OptionalFieldType`](../interfaces/tlv_export.OptionalFieldType.md)\<[`EndpointNumber`](../modules/datatype_export.md#endpointnumber)\> ; `fabricIndex`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<[`FabricIndex`](../modules/datatype_export.md#fabricindex)\> ; `group`: [`OptionalFieldType`](../interfaces/tlv_export.OptionalFieldType.md)\<[`GroupId`](../modules/datatype_export.md#groupid)\> ; `node`: [`OptionalFieldType`](../interfaces/tlv_export.OptionalFieldType.md)\<[`NodeId`](../modules/datatype_export.md#nodeid)\>  }\>[], `any`\>\>  } & {} & {} & {}

Access the behavior's events.

#### Inherited from

[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[events](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#events)
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[features](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#features)
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[session](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#session)
...
• `Readonly` **state**: `Omit`\<{}, `never`\> & \{ `binding`: [`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `cluster`: [`OptionalFieldType`](../interfaces/tlv_export.OptionalFieldType.md)\<[`ClusterId`](../modules/datatype_export.md#clusterid)\<`number`\>\> ; `endpoint`: [`OptionalFieldType`](../interfaces/tlv_export.OptionalFieldType.md)\<[`EndpointNumber`](../modules/datatype_export.md#endpointnumber)\> ; `fabricIndex`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<[`FabricIndex`](../modules/datatype_export.md#fabricindex)\> ; `group`: [`OptionalFieldType`](../interfaces/tlv_export.OptionalFieldType.md)\<[`GroupId`](../modules/datatype_export.md#groupid)\> ; `node`: [`OptionalFieldType`](../interfaces/tlv_export.OptionalFieldType.md)\<[`NodeId`](../modules/datatype_export.md#nodeid)\>  }\>[]  } & {} & {} & {}

Access the behavior's state.

#### Inherited from

[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[state](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#state)
...
▪ `Static` `Readonly` **Events**: [`Type`](../modules/behavior_cluster_export.ClusterEvents.md#type)\<[`Cluster`](../interfaces/cluster_export.Binding.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>

#### Inherited from

BindingBehavior.Events
...
BindingBehavior.ExtensionInterface
...
▪ `Static` `Readonly` **State**: () => [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.Binding.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>

#### Type declaration

• **new State**(): [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.Binding.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>

##### Returns

[`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.Binding.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>
...
▪ `Static` `Readonly` **cluster**: [`Cluster`](../interfaces/cluster_export.Binding.Cluster.md)

Base cluster state include all attribute values but may be extended by subclasses.

#### Inherited from

BindingBehavior.cluster
...
▪ `Static` `Readonly` **defaults**: [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.Binding.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>

#### Inherited from

BindingBehavior.defaults
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[[asyncDispose]](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#[asyncdispose])
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[asAdmin](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#asadmin)
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[assertAttributeEnabled](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#assertattributeenabled)
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[callback](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#callback)
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[initialize](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#initialize)
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[reactTo](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#reactto)
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[requireAttributeEnabled](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#requireattributeenabled)
...
[BindingBehavior](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md).[toString](../interfaces/behavior_definitions_binding_export.BindingBehavior-1.md#tostring)
