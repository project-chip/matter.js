[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/wake-on-lan/export](../modules/behavior_definitions_wake_on_lan_export.md) / WakeOnLanServer

# Class: WakeOnLanServer

[behavior/definitions/wake-on-lan/export](../modules/behavior_definitions_wake_on_lan_export.md).WakeOnLanServer

This is the default server implementation of [WakeOnLanBehavior](../modules/behavior_definitions_wake_on_lan_export.md#wakeonlanbehavior).
...
- [constructor](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#constructor)

### Properties

- [#agent](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md##agent)
- [[reference]](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#[reference])
- [agent](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#agent)
- [cluster](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#cluster)
- [context](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#context)
- [endpoint](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#endpoint)
- [events](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#events)
- [features](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#features)
- [session](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#session)
- [state](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#state)
- [Events](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#events-1)
- [ExtensionInterface](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#extensioninterface)
- [Interface](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#interface)
- [Internal](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#internal)
- [State](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#state-1)
- [cluster](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#cluster-1)
- [defaults](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#defaults)
- [dependencies](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#dependencies)
- [early](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#early)
- [id](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#id)
- [name](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#name)
- [schema](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#schema)
- [supervisor](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#supervisor)
- [supports](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#supports)

### Methods

- [[asyncDispose]](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#[asyncdispose])
- [asAdmin](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#assertattributeenabled)
- [callback](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#callback)
- [initialize](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#initialize)
- [reactTo](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#reactto)
- [requireAttributeEnabled](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#requireattributeenabled)
- [toString](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#tostring)
- [alter](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#alter)
- [enable](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#enable)
- [for](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#for)
- [set](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#set)
- [with](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md#with)

## Constructors

### constructor

• **new WakeOnLanServer**(`agent`, `backing`): [`WakeOnLanServer`](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md)
...
[`WakeOnLanServer`](behavior_definitions_wake_on_lan_export.WakeOnLanServer.md)
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[#agent](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md##agent)
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[[reference]](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#[reference])
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[cluster](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#cluster)
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[context](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#context)
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[endpoint](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#endpoint)
...
• `Readonly` **events**: [`EventEmitter`](util_export.EventEmitter-1.md) & `Omit`\<[`EventEmitter`](util_export.EventEmitter-1.md), `never`\> & {} & \{ `linkLocalAddress$Changing`: `undefined` \| [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`OptionalFixedAttribute`](../interfaces/cluster_export.OptionalFixedAttribute.md)\<`Uint8Array`, `any`\>\> ; `macAddress$Changing`: `undefined` \| [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`OptionalFixedAttribute`](../interfaces/cluster_export.OptionalFixedAttribute.md)\<`Uint8Array`, `any`\>\>  } & {} & \{ `linkLocalAddress$Changed`: `undefined` \| [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`OptionalFixedAttribute`](../interfaces/cluster_export.OptionalFixedAttribute.md)\<`Uint8Array`, `any`\>\> ; `macAddress$Changed`: `undefined` \| [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`OptionalFixedAttribute`](../interfaces/cluster_export.OptionalFixedAttribute.md)\<`Uint8Array`, `any`\>\>  } & {} & {}

Access the behavior's events.

#### Inherited from

[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[events](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#events)
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[features](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#features)
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[session](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#session)
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[state](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#state)
...
▪ `Static` `Readonly` **Events**: [`Type`](../modules/behavior_cluster_export.ClusterEvents.md#type)\<[`Cluster`](../interfaces/cluster_export.WakeOnLan.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>
...
▪ `Static` `Readonly` **State**: () => [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.WakeOnLan.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>

#### Type declaration

• **new State**(): [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.WakeOnLan.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>

##### Returns

[`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.WakeOnLan.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>
...
▪ `Static` `Readonly` **cluster**: [`Cluster`](../interfaces/cluster_export.WakeOnLan.Cluster.md)
...
▪ `Static` `Readonly` **defaults**: [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.WakeOnLan.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[[asyncDispose]](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#[asyncdispose])
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[asAdmin](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#asadmin)
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[assertAttributeEnabled](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#assertattributeenabled)
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[callback](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#callback)
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[initialize](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#initialize)
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[reactTo](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#reactto)
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[requireAttributeEnabled](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#requireattributeenabled)
...
[WakeOnLanBehavior](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md).[toString](../interfaces/behavior_definitions_wake_on_lan_export.WakeOnLanBehavior-1.md#tostring)
