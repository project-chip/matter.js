[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/keypad-input/export](../modules/behavior_definitions_keypad_input_export.md) / KeypadInputServer

# Class: KeypadInputServer

[behavior/definitions/keypad-input/export](../modules/behavior_definitions_keypad_input_export.md).KeypadInputServer

This is the default server implementation of [KeypadInputBehavior](../modules/behavior_definitions_keypad_input_export.md#keypadinputbehavior).
...
- [constructor](behavior_definitions_keypad_input_export.KeypadInputServer.md#constructor)

### Properties

- [#agent](behavior_definitions_keypad_input_export.KeypadInputServer.md##agent)
- [[reference]](behavior_definitions_keypad_input_export.KeypadInputServer.md#[reference])
- [agent](behavior_definitions_keypad_input_export.KeypadInputServer.md#agent)
- [cluster](behavior_definitions_keypad_input_export.KeypadInputServer.md#cluster)
- [context](behavior_definitions_keypad_input_export.KeypadInputServer.md#context)
- [endpoint](behavior_definitions_keypad_input_export.KeypadInputServer.md#endpoint)
- [events](behavior_definitions_keypad_input_export.KeypadInputServer.md#events)
- [features](behavior_definitions_keypad_input_export.KeypadInputServer.md#features)
- [session](behavior_definitions_keypad_input_export.KeypadInputServer.md#session)
- [state](behavior_definitions_keypad_input_export.KeypadInputServer.md#state)
- [Events](behavior_definitions_keypad_input_export.KeypadInputServer.md#events-1)
- [ExtensionInterface](behavior_definitions_keypad_input_export.KeypadInputServer.md#extensioninterface)
- [Interface](behavior_definitions_keypad_input_export.KeypadInputServer.md#interface)
- [Internal](behavior_definitions_keypad_input_export.KeypadInputServer.md#internal)
- [State](behavior_definitions_keypad_input_export.KeypadInputServer.md#state-1)
- [cluster](behavior_definitions_keypad_input_export.KeypadInputServer.md#cluster-1)
- [defaults](behavior_definitions_keypad_input_export.KeypadInputServer.md#defaults)
- [dependencies](behavior_definitions_keypad_input_export.KeypadInputServer.md#dependencies)
- [early](behavior_definitions_keypad_input_export.KeypadInputServer.md#early)
- [id](behavior_definitions_keypad_input_export.KeypadInputServer.md#id)
- [name](behavior_definitions_keypad_input_export.KeypadInputServer.md#name)
- [schema](behavior_definitions_keypad_input_export.KeypadInputServer.md#schema)
- [supervisor](behavior_definitions_keypad_input_export.KeypadInputServer.md#supervisor)
- [supports](behavior_definitions_keypad_input_export.KeypadInputServer.md#supports)

### Methods

- [[asyncDispose]](behavior_definitions_keypad_input_export.KeypadInputServer.md#[asyncdispose])
- [asAdmin](behavior_definitions_keypad_input_export.KeypadInputServer.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_keypad_input_export.KeypadInputServer.md#assertattributeenabled)
- [callback](behavior_definitions_keypad_input_export.KeypadInputServer.md#callback)
- [initialize](behavior_definitions_keypad_input_export.KeypadInputServer.md#initialize)
- [reactTo](behavior_definitions_keypad_input_export.KeypadInputServer.md#reactto)
- [requireAttributeEnabled](behavior_definitions_keypad_input_export.KeypadInputServer.md#requireattributeenabled)
- [sendKey](behavior_definitions_keypad_input_export.KeypadInputServer.md#sendkey)
- [toString](behavior_definitions_keypad_input_export.KeypadInputServer.md#tostring)
- [alter](behavior_definitions_keypad_input_export.KeypadInputServer.md#alter)
- [enable](behavior_definitions_keypad_input_export.KeypadInputServer.md#enable)
- [for](behavior_definitions_keypad_input_export.KeypadInputServer.md#for)
- [set](behavior_definitions_keypad_input_export.KeypadInputServer.md#set)
- [with](behavior_definitions_keypad_input_export.KeypadInputServer.md#with)

## Constructors

### constructor

• **new KeypadInputServer**(`agent`, `backing`): [`KeypadInputServer`](behavior_definitions_keypad_input_export.KeypadInputServer.md)
...
[`KeypadInputServer`](behavior_definitions_keypad_input_export.KeypadInputServer.md)

#### Inherited from

KeypadInputBehavior.constructor
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[#agent](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md##agent)
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[[reference]](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#[reference])
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[cluster](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#cluster)
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[context](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#context)
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[endpoint](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#endpoint)
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[events](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#events)
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[features](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#features)
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[session](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#session)
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[state](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#state)
...
KeypadInputBehavior.ExtensionInterface
...
▪ `Static` `Readonly` **Interface**: [`KeypadInputInterface`](../modules/behavior_definitions_keypad_input_export.md#keypadinputinterface)

#### Inherited from

KeypadInputBehavior.Interface
...
▪ `Static` `Readonly` **State**: () => [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.KeypadInput.Cluster.md), [`Type`](../interfaces/behavior_cluster_export.ClusterBehavior.Type.md)\<[`Of`](../interfaces/cluster_export.ClusterType.Of.md)\<\{ `attributes`: {} = \{}; `commands`: {} = \{}; `events`: {} = \{}; `id`: ``0`` = 0; `name`: ``"Unknown"`` = "Unknown"; `revision`: ``0`` = 0 }\>, typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md), [`KeypadInputInterface`](../modules/behavior_definitions_keypad_input_export.md#keypadinputinterface)\>\>
...
▪ `Static` `Readonly` **cluster**: [`Cluster`](../interfaces/cluster_export.KeypadInput.Cluster.md)

Base cluster state include all attribute values but may be extended by subclasses.

#### Inherited from

KeypadInputBehavior.cluster
...
KeypadInputBehavior.dependencies
...
▪ `Static` `Readonly` **id**: ``"keypadInput"``

The behavior ID for ClusterBehaviors is the name of the cluster.

#### Inherited from

KeypadInputBehavior.id
...
KeypadInputBehavior.supervisor
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[[asyncDispose]](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#[asyncdispose])
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[asAdmin](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#asadmin)
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[assertAttributeEnabled](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#assertattributeenabled)
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[callback](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#callback)
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[initialize](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#initialize)
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[reactTo](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#reactto)
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[requireAttributeEnabled](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#requireattributeenabled)
...
▸ **sendKey**(`request`): [`MaybePromise`](../modules/util_export.md#maybepromise)\<[`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `status`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<[`Status`](../enums/cluster_export.KeypadInput.Status.md)\>  }\>\>
...
| Name | Type |
| :------ | :------ |
| `request` | [`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `keyCode`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<[`CecKeyCode`](../enums/cluster_export.KeypadInput.CecKeyCode.md)\>  }\> |

#### Returns

[`MaybePromise`](../modules/util_export.md#maybepromise)\<[`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `status`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<[`Status`](../enums/cluster_export.KeypadInput.Status.md)\>  }\>\>
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[sendKey](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#sendkey)

#### Defined in

[packages/matter.js/src/behavior/definitions/keypad-input/KeypadInputInterface.ts:42](https://github.com/project-chip/matter.js/blob/2d9f2165d2672864fda3496a6d0d5f93597f82c6/packages/matter.js/src/behavior/definitions/keypad-input/KeypadInputInterface.ts#L42)
...
[KeypadInputBehavior](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md).[toString](../interfaces/behavior_definitions_keypad_input_export.KeypadInputBehavior-1.md#tostring)
