[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [node/export](../modules/node_export.md) / [\<internal\>](../modules/node_export._internal_.md) / PartsBehavior

# Class: PartsBehavior

[node/export](../modules/node_export.md).[\<internal\>](../modules/node_export._internal_.md).PartsBehavior
...
- [constructor](node_export._internal_.PartsBehavior.md#constructor)

### Properties

- [#agent](node_export._internal_.PartsBehavior.md##agent)
- [events](node_export._internal_.PartsBehavior.md#events)
- [state](node_export._internal_.PartsBehavior.md#state)
- [Events](node_export._internal_.PartsBehavior.md#events-1)
- [Internal](node_export._internal_.PartsBehavior.md#internal)
- [State](node_export._internal_.PartsBehavior.md#state-1)
- [dependencies](node_export._internal_.PartsBehavior.md#dependencies)
- [early](node_export._internal_.PartsBehavior.md#early)
- [id](node_export._internal_.PartsBehavior.md#id)
- [schema](node_export._internal_.PartsBehavior.md#schema)

### Accessors

- [[reference]](node_export._internal_.PartsBehavior.md#[reference])
- [agent](node_export._internal_.PartsBehavior.md#agent)
- [context](node_export._internal_.PartsBehavior.md#context)
- [endpoint](node_export._internal_.PartsBehavior.md#endpoint)
- [session](node_export._internal_.PartsBehavior.md#session)
- [defaults](node_export._internal_.PartsBehavior.md#defaults)
- [supervisor](node_export._internal_.PartsBehavior.md#supervisor)

### Methods

- [[asyncDispose]](node_export._internal_.PartsBehavior.md#[asyncdispose])
- [[iterator]](node_export._internal_.PartsBehavior.md#[iterator])
- [add](node_export._internal_.PartsBehavior.md#add)
- [asAdmin](node_export._internal_.PartsBehavior.md#asadmin)
- [callback](node_export._internal_.PartsBehavior.md#callback)
- [clear](node_export._internal_.PartsBehavior.md#clear)
- [delete](node_export._internal_.PartsBehavior.md#delete)
- [has](node_export._internal_.PartsBehavior.md#has)
- [indexOf](node_export._internal_.PartsBehavior.md#indexof)
- [initialize](node_export._internal_.PartsBehavior.md#initialize)
- [reactTo](node_export._internal_.PartsBehavior.md#reactto)
- [toString](node_export._internal_.PartsBehavior.md#tostring)
- [set](node_export._internal_.PartsBehavior.md#set)
- [supports](node_export._internal_.PartsBehavior.md#supports)

## Constructors

### constructor

• **new PartsBehavior**(`agent`, `backing`): [`PartsBehavior`](node_export._internal_.PartsBehavior.md)
...
[packages/matter.js/src/behavior/Behavior.ts:178](https://github.com/project-chip/matter.js/blob/6d3b6a5d957d88a9231d6ecab4bb41f8133112be/packages/matter.js/src/behavior/Behavior.ts#L178)
...
[packages/matter.js/src/behavior/Behavior.ts:173](https://github.com/project-chip/matter.js/blob/6d3b6a5d957d88a9231d6ecab4bb41f8133112be/packages/matter.js/src/behavior/Behavior.ts#L173)
...
[packages/matter.js/src/behavior/Behavior.ts:75](https://github.com/project-chip/matter.js/blob/6d3b6a5d957d88a9231d6ecab4bb41f8133112be/packages/matter.js/src/behavior/Behavior.ts#L75)

___

### id

▪ `Static` `Readonly` **id**: ``"parts"``
...
[packages/matter.js/src/behavior/system/parts/PartsBehavior.ts:16](https://github.com/project-chip/matter.js/blob/6d3b6a5d957d88a9231d6ecab4bb41f8133112be/packages/matter.js/src/behavior/system/parts/PartsBehavior.ts#L16)
...
▸ **[iterator]**(): `Generator`\<[`Instance`](../modules/endpoint_export.Agent.md#instance)\<[`Empty`](../interfaces/behavior_cluster_export._internal_.Empty.md)\>, `void`, `unknown`\>

#### Returns

`Generator`\<[`Instance`](../modules/endpoint_export.Agent.md#instance)\<[`Empty`](../interfaces/behavior_cluster_export._internal_.Empty.md)\>, `void`, `unknown`\>

#### Defined in

[packages/matter.js/src/behavior/system/parts/PartsBehavior.ts:38](https://github.com/project-chip/matter.js/blob/6d3b6a5d957d88a9231d6ecab4bb41f8133112be/packages/matter.js/src/behavior/system/parts/PartsBehavior.ts#L38)
...
[packages/matter.js/src/behavior/system/parts/PartsBehavior.ts:18](https://github.com/project-chip/matter.js/blob/6d3b6a5d957d88a9231d6ecab4bb41f8133112be/packages/matter.js/src/behavior/system/parts/PartsBehavior.ts#L18)
...
[packages/matter.js/src/behavior/system/parts/PartsBehavior.ts:26](https://github.com/project-chip/matter.js/blob/6d3b6a5d957d88a9231d6ecab4bb41f8133112be/packages/matter.js/src/behavior/system/parts/PartsBehavior.ts#L26)
...
[packages/matter.js/src/behavior/system/parts/PartsBehavior.ts:22](https://github.com/project-chip/matter.js/blob/6d3b6a5d957d88a9231d6ecab4bb41f8133112be/packages/matter.js/src/behavior/system/parts/PartsBehavior.ts#L22)
...
[packages/matter.js/src/behavior/system/parts/PartsBehavior.ts:30](https://github.com/project-chip/matter.js/blob/6d3b6a5d957d88a9231d6ecab4bb41f8133112be/packages/matter.js/src/behavior/system/parts/PartsBehavior.ts#L30)
...
[packages/matter.js/src/behavior/system/parts/PartsBehavior.ts:34](https://github.com/project-chip/matter.js/blob/6d3b6a5d957d88a9231d6ecab4bb41f8133112be/packages/matter.js/src/behavior/system/parts/PartsBehavior.ts#L34)
