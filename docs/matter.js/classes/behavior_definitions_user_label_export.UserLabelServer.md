[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/user-label/export](../modules/behavior_definitions_user_label_export.md) / UserLabelServer

# Class: UserLabelServer

[behavior/definitions/user-label/export](../modules/behavior_definitions_user_label_export.md).UserLabelServer

This is the default server implementation of [UserLabelBehavior](../modules/behavior_definitions_user_label_export.md#userlabelbehavior).
...
- [constructor](behavior_definitions_user_label_export.UserLabelServer.md#constructor)

### Properties

- [#agent](behavior_definitions_user_label_export.UserLabelServer.md##agent)
- [[reference]](behavior_definitions_user_label_export.UserLabelServer.md#[reference])
- [agent](behavior_definitions_user_label_export.UserLabelServer.md#agent)
- [cluster](behavior_definitions_user_label_export.UserLabelServer.md#cluster)
- [context](behavior_definitions_user_label_export.UserLabelServer.md#context)
- [endpoint](behavior_definitions_user_label_export.UserLabelServer.md#endpoint)
- [events](behavior_definitions_user_label_export.UserLabelServer.md#events)
- [features](behavior_definitions_user_label_export.UserLabelServer.md#features)
- [session](behavior_definitions_user_label_export.UserLabelServer.md#session)
- [state](behavior_definitions_user_label_export.UserLabelServer.md#state)
- [Events](behavior_definitions_user_label_export.UserLabelServer.md#events-1)
- [ExtensionInterface](behavior_definitions_user_label_export.UserLabelServer.md#extensioninterface)
- [Interface](behavior_definitions_user_label_export.UserLabelServer.md#interface)
- [Internal](behavior_definitions_user_label_export.UserLabelServer.md#internal)
- [State](behavior_definitions_user_label_export.UserLabelServer.md#state-1)
- [cluster](behavior_definitions_user_label_export.UserLabelServer.md#cluster-1)
- [defaults](behavior_definitions_user_label_export.UserLabelServer.md#defaults)
- [dependencies](behavior_definitions_user_label_export.UserLabelServer.md#dependencies)
- [early](behavior_definitions_user_label_export.UserLabelServer.md#early)
- [id](behavior_definitions_user_label_export.UserLabelServer.md#id)
- [name](behavior_definitions_user_label_export.UserLabelServer.md#name)
- [schema](behavior_definitions_user_label_export.UserLabelServer.md#schema)
- [supervisor](behavior_definitions_user_label_export.UserLabelServer.md#supervisor)
- [supports](behavior_definitions_user_label_export.UserLabelServer.md#supports)

### Methods

- [[asyncDispose]](behavior_definitions_user_label_export.UserLabelServer.md#[asyncdispose])
- [asAdmin](behavior_definitions_user_label_export.UserLabelServer.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_user_label_export.UserLabelServer.md#assertattributeenabled)
- [callback](behavior_definitions_user_label_export.UserLabelServer.md#callback)
- [initialize](behavior_definitions_user_label_export.UserLabelServer.md#initialize)
- [reactTo](behavior_definitions_user_label_export.UserLabelServer.md#reactto)
- [requireAttributeEnabled](behavior_definitions_user_label_export.UserLabelServer.md#requireattributeenabled)
- [toString](behavior_definitions_user_label_export.UserLabelServer.md#tostring)
- [alter](behavior_definitions_user_label_export.UserLabelServer.md#alter)
- [enable](behavior_definitions_user_label_export.UserLabelServer.md#enable)
- [for](behavior_definitions_user_label_export.UserLabelServer.md#for)
- [set](behavior_definitions_user_label_export.UserLabelServer.md#set)
- [with](behavior_definitions_user_label_export.UserLabelServer.md#with)

## Constructors

### constructor

• **new UserLabelServer**(`agent`, `backing`): [`UserLabelServer`](behavior_definitions_user_label_export.UserLabelServer.md)
...
[`UserLabelServer`](behavior_definitions_user_label_export.UserLabelServer.md)

#### Inherited from

UserLabelBehavior.constructor
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[#agent](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md##agent)
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[[reference]](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#[reference])
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[cluster](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#cluster)
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[context](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#context)
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[endpoint](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#endpoint)
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[features](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#features)
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[session](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#session)
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[state](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#state)
...
▪ `Static` `Readonly` **Events**: [`Type`](../modules/behavior_cluster_export.ClusterEvents.md#type)\<[`Cluster`](../interfaces/cluster_export.UserLabel.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>

#### Inherited from

UserLabelBehavior.Events
...
UserLabelBehavior.ExtensionInterface
...
▪ `Static` `Readonly` **State**: () => [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.UserLabel.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>

#### Type declaration

• **new State**(): [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.UserLabel.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>

##### Returns

[`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.UserLabel.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>

#### Inherited from

UserLabelBehavior.State
...
▪ `Static` `Readonly` **cluster**: [`Cluster`](../interfaces/cluster_export.UserLabel.Cluster.md)

Base cluster state include all attribute values but may be extended by subclasses.

#### Inherited from

UserLabelBehavior.cluster
...
▪ `Static` `Readonly` **defaults**: [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.UserLabel.Cluster.md), typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>

#### Inherited from

UserLabelBehavior.defaults
...
UserLabelBehavior.dependencies
...
▪ `Static` `Readonly` **id**: ``"userLabel"``

The behavior ID for ClusterBehaviors is the name of the cluster.

#### Inherited from

UserLabelBehavior.id
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[[asyncDispose]](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#[asyncdispose])
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[asAdmin](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#asadmin)
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[assertAttributeEnabled](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#assertattributeenabled)
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[callback](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#callback)
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[initialize](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#initialize)
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[reactTo](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#reactto)
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[requireAttributeEnabled](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#requireattributeenabled)
...
[UserLabelBehavior](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md).[toString](../interfaces/behavior_definitions_user_label_export.UserLabelBehavior-1.md#tostring)
