[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/media-input/export](../modules/behavior_definitions_media_input_export.md) / MediaInputServer

# Class: MediaInputServer

[behavior/definitions/media-input/export](../modules/behavior_definitions_media_input_export.md).MediaInputServer

This is the default server implementation of [MediaInputBehavior](../modules/behavior_definitions_media_input_export.md#mediainputbehavior).
...
- [constructor](behavior_definitions_media_input_export.MediaInputServer.md#constructor)

### Properties

- [#agent](behavior_definitions_media_input_export.MediaInputServer.md##agent)
- [[reference]](behavior_definitions_media_input_export.MediaInputServer.md#[reference])
- [agent](behavior_definitions_media_input_export.MediaInputServer.md#agent)
- [cluster](behavior_definitions_media_input_export.MediaInputServer.md#cluster)
- [context](behavior_definitions_media_input_export.MediaInputServer.md#context)
- [endpoint](behavior_definitions_media_input_export.MediaInputServer.md#endpoint)
- [events](behavior_definitions_media_input_export.MediaInputServer.md#events)
- [features](behavior_definitions_media_input_export.MediaInputServer.md#features)
- [session](behavior_definitions_media_input_export.MediaInputServer.md#session)
- [state](behavior_definitions_media_input_export.MediaInputServer.md#state)
- [Events](behavior_definitions_media_input_export.MediaInputServer.md#events-1)
- [ExtensionInterface](behavior_definitions_media_input_export.MediaInputServer.md#extensioninterface)
- [Interface](behavior_definitions_media_input_export.MediaInputServer.md#interface)
- [Internal](behavior_definitions_media_input_export.MediaInputServer.md#internal)
- [State](behavior_definitions_media_input_export.MediaInputServer.md#state-1)
- [cluster](behavior_definitions_media_input_export.MediaInputServer.md#cluster-1)
- [defaults](behavior_definitions_media_input_export.MediaInputServer.md#defaults)
- [dependencies](behavior_definitions_media_input_export.MediaInputServer.md#dependencies)
- [early](behavior_definitions_media_input_export.MediaInputServer.md#early)
- [id](behavior_definitions_media_input_export.MediaInputServer.md#id)
- [name](behavior_definitions_media_input_export.MediaInputServer.md#name)
- [schema](behavior_definitions_media_input_export.MediaInputServer.md#schema)
- [supervisor](behavior_definitions_media_input_export.MediaInputServer.md#supervisor)
- [supports](behavior_definitions_media_input_export.MediaInputServer.md#supports)

### Methods

- [[asyncDispose]](behavior_definitions_media_input_export.MediaInputServer.md#[asyncdispose])
- [asAdmin](behavior_definitions_media_input_export.MediaInputServer.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_media_input_export.MediaInputServer.md#assertattributeenabled)
- [callback](behavior_definitions_media_input_export.MediaInputServer.md#callback)
- [hideInputStatus](behavior_definitions_media_input_export.MediaInputServer.md#hideinputstatus)
- [initialize](behavior_definitions_media_input_export.MediaInputServer.md#initialize)
- [reactTo](behavior_definitions_media_input_export.MediaInputServer.md#reactto)
- [requireAttributeEnabled](behavior_definitions_media_input_export.MediaInputServer.md#requireattributeenabled)
- [selectInput](behavior_definitions_media_input_export.MediaInputServer.md#selectinput)
- [showInputStatus](behavior_definitions_media_input_export.MediaInputServer.md#showinputstatus)
- [toString](behavior_definitions_media_input_export.MediaInputServer.md#tostring)
- [alter](behavior_definitions_media_input_export.MediaInputServer.md#alter)
- [enable](behavior_definitions_media_input_export.MediaInputServer.md#enable)
- [for](behavior_definitions_media_input_export.MediaInputServer.md#for)
- [set](behavior_definitions_media_input_export.MediaInputServer.md#set)
- [with](behavior_definitions_media_input_export.MediaInputServer.md#with)

## Constructors

### constructor

• **new MediaInputServer**(`agent`, `backing`): [`MediaInputServer`](behavior_definitions_media_input_export.MediaInputServer.md)
...
[`MediaInputServer`](behavior_definitions_media_input_export.MediaInputServer.md)

#### Inherited from

MediaInputBehavior.constructor
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[#agent](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md##agent)
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[[reference]](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#[reference])
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[cluster](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#cluster)
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[context](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#context)
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[endpoint](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#endpoint)
...
• `Readonly` **events**: [`EventEmitter`](util_export.EventEmitter-1.md) & `Omit`\<[`ClusterEvents`](../modules/behavior_cluster_export.md#clusterevents)\<[`Of`](../interfaces/cluster_export.ClusterType.Of.md)\<\{ `attributes`: {} = \{}; `commands`: {} = \{}; `events`: {} = \{}; `id`: ``0`` = 0; `name`: ``"Unknown"`` = "Unknown"; `revision`: ``0`` = 0 }\>, typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>, `never`\> & \{ `currentInput$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](../interfaces/cluster_export.Attribute.md)\<`number`, `any`\>\> ; `inputList$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](../interfaces/cluster_export.Attribute.md)\<[`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `description`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<`string`\> ; `index`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<`number`\> ; `inputType`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<[`InputType`](../enums/cluster_export.MediaInput.InputType.md)\> ; `name`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<`string`\>  }\>[], `any`\>\>  } & {} & \{ `currentInput$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](../interfaces/cluster_export.Attribute.md)\<`number`, `any`\>\> ; `inputList$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](../interfaces/cluster_export.Attribute.md)\<[`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `description`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<`string`\> ; `index`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<`number`\> ; `inputType`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<[`InputType`](../enums/cluster_export.MediaInput.InputType.md)\> ; `name`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<`string`\>  }\>[], `any`\>\>  } & {} & {} & {}

Access the behavior's events.

#### Inherited from

[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[events](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#events)
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[features](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#features)
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[session](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#session)
...
• `Readonly` **state**: `Omit`\<[`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Of`](../interfaces/cluster_export.ClusterType.Of.md)\<\{ `attributes`: {} = \{}; `commands`: {} = \{}; `events`: {} = \{}; `id`: ``0`` = 0; `name`: ``"Unknown"`` = "Unknown"; `revision`: ``0`` = 0 }\>, typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>, `never`\> & \{ `currentInput`: `number` ; `inputList`: [`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `description`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<`string`\> ; `index`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<`number`\> ; `inputType`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<[`InputType`](../enums/cluster_export.MediaInput.InputType.md)\> ; `name`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<`string`\>  }\>[]  } & {} & {} & {}

Access the behavior's state.

#### Inherited from

[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[state](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#state)
...
MediaInputBehavior.ExtensionInterface
...
▪ `Static` `Readonly` **Interface**: [`MediaInputInterface`](../modules/behavior_definitions_media_input_export.md#mediainputinterface)

#### Inherited from

MediaInputBehavior.Interface
...
▪ `Static` `Readonly` **State**: () => [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.MediaInput.Cluster.md), [`Type`](../interfaces/behavior_cluster_export.ClusterBehavior.Type.md)\<[`Of`](../interfaces/cluster_export.ClusterType.Of.md)\<\{ `attributes`: {} = \{}; `commands`: {} = \{}; `events`: {} = \{}; `id`: ``0`` = 0; `name`: ``"Unknown"`` = "Unknown"; `revision`: ``0`` = 0 }\>, typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md), [`MediaInputInterface`](../modules/behavior_definitions_media_input_export.md#mediainputinterface)\>\>
...
▪ `Static` `Readonly` **cluster**: [`Cluster`](../interfaces/cluster_export.MediaInput.Cluster.md)

Base cluster state include all attribute values but may be extended by subclasses.

#### Inherited from

MediaInputBehavior.cluster
...
MediaInputBehavior.dependencies
...
▪ `Static` `Readonly` **id**: ``"mediaInput"``

The behavior ID for ClusterBehaviors is the name of the cluster.

#### Inherited from

MediaInputBehavior.id
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[[asyncDispose]](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#[asyncdispose])
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[asAdmin](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#asadmin)
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[assertAttributeEnabled](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#assertattributeenabled)
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[callback](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#callback)
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[hideInputStatus](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#hideinputstatus)

#### Defined in

[packages/matter.js/src/behavior/definitions/media-input/MediaInputInterface.ts:50](https://github.com/project-chip/matter.js/blob/0c058ae17fdba4c0b89b8b13c309011d51782299/packages/matter.js/src/behavior/definitions/media-input/MediaInputInterface.ts#L50)
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[initialize](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#initialize)
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[reactTo](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#reactto)
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[requireAttributeEnabled](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#requireattributeenabled)
...
| Name | Type |
| :------ | :------ |
| `request` | [`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `index`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<`number`\>  }\> |
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[selectInput](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#selectinput)

#### Defined in

[packages/matter.js/src/behavior/definitions/media-input/MediaInputInterface.ts:36](https://github.com/project-chip/matter.js/blob/0c058ae17fdba4c0b89b8b13c309011d51782299/packages/matter.js/src/behavior/definitions/media-input/MediaInputInterface.ts#L36)
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[showInputStatus](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#showinputstatus)

#### Defined in

[packages/matter.js/src/behavior/definitions/media-input/MediaInputInterface.ts:43](https://github.com/project-chip/matter.js/blob/0c058ae17fdba4c0b89b8b13c309011d51782299/packages/matter.js/src/behavior/definitions/media-input/MediaInputInterface.ts#L43)
...
[MediaInputBehavior](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md).[toString](../interfaces/behavior_definitions_media_input_export.MediaInputBehavior-1.md#tostring)
