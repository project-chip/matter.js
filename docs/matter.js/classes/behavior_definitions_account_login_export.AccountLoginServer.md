[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/account-login/export](../modules/behavior_definitions_account_login_export.md) / AccountLoginServer

# Class: AccountLoginServer

[behavior/definitions/account-login/export](../modules/behavior_definitions_account_login_export.md).AccountLoginServer

This is the default server implementation of [AccountLoginBehavior](../modules/behavior_definitions_account_login_export.md#accountloginbehavior).
...
- [constructor](behavior_definitions_account_login_export.AccountLoginServer.md#constructor)

### Properties

- [#agent](behavior_definitions_account_login_export.AccountLoginServer.md##agent)
- [[reference]](behavior_definitions_account_login_export.AccountLoginServer.md#[reference])
- [agent](behavior_definitions_account_login_export.AccountLoginServer.md#agent)
- [cluster](behavior_definitions_account_login_export.AccountLoginServer.md#cluster)
- [context](behavior_definitions_account_login_export.AccountLoginServer.md#context)
- [endpoint](behavior_definitions_account_login_export.AccountLoginServer.md#endpoint)
- [events](behavior_definitions_account_login_export.AccountLoginServer.md#events)
- [features](behavior_definitions_account_login_export.AccountLoginServer.md#features)
- [session](behavior_definitions_account_login_export.AccountLoginServer.md#session)
- [state](behavior_definitions_account_login_export.AccountLoginServer.md#state)
- [Events](behavior_definitions_account_login_export.AccountLoginServer.md#events-1)
- [ExtensionInterface](behavior_definitions_account_login_export.AccountLoginServer.md#extensioninterface)
- [Interface](behavior_definitions_account_login_export.AccountLoginServer.md#interface)
- [Internal](behavior_definitions_account_login_export.AccountLoginServer.md#internal)
- [State](behavior_definitions_account_login_export.AccountLoginServer.md#state-1)
- [cluster](behavior_definitions_account_login_export.AccountLoginServer.md#cluster-1)
- [defaults](behavior_definitions_account_login_export.AccountLoginServer.md#defaults)
- [dependencies](behavior_definitions_account_login_export.AccountLoginServer.md#dependencies)
- [early](behavior_definitions_account_login_export.AccountLoginServer.md#early)
- [id](behavior_definitions_account_login_export.AccountLoginServer.md#id)
- [name](behavior_definitions_account_login_export.AccountLoginServer.md#name)
- [schema](behavior_definitions_account_login_export.AccountLoginServer.md#schema)
- [supervisor](behavior_definitions_account_login_export.AccountLoginServer.md#supervisor)
- [supports](behavior_definitions_account_login_export.AccountLoginServer.md#supports)

### Methods

- [[asyncDispose]](behavior_definitions_account_login_export.AccountLoginServer.md#[asyncdispose])
- [asAdmin](behavior_definitions_account_login_export.AccountLoginServer.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_account_login_export.AccountLoginServer.md#assertattributeenabled)
- [callback](behavior_definitions_account_login_export.AccountLoginServer.md#callback)
- [getSetupPin](behavior_definitions_account_login_export.AccountLoginServer.md#getsetuppin)
- [initialize](behavior_definitions_account_login_export.AccountLoginServer.md#initialize)
- [login](behavior_definitions_account_login_export.AccountLoginServer.md#login)
- [logout](behavior_definitions_account_login_export.AccountLoginServer.md#logout)
- [reactTo](behavior_definitions_account_login_export.AccountLoginServer.md#reactto)
- [requireAttributeEnabled](behavior_definitions_account_login_export.AccountLoginServer.md#requireattributeenabled)
- [toString](behavior_definitions_account_login_export.AccountLoginServer.md#tostring)
- [alter](behavior_definitions_account_login_export.AccountLoginServer.md#alter)
- [enable](behavior_definitions_account_login_export.AccountLoginServer.md#enable)
- [for](behavior_definitions_account_login_export.AccountLoginServer.md#for)
- [set](behavior_definitions_account_login_export.AccountLoginServer.md#set)
- [with](behavior_definitions_account_login_export.AccountLoginServer.md#with)

## Constructors

### constructor

• **new AccountLoginServer**(`agent`, `backing`): [`AccountLoginServer`](behavior_definitions_account_login_export.AccountLoginServer.md)
...
[`AccountLoginServer`](behavior_definitions_account_login_export.AccountLoginServer.md)

#### Inherited from

AccountLoginBehavior.constructor
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[#agent](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md##agent)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[[reference]](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#[reference])
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[cluster](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#cluster)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[context](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#context)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[endpoint](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#endpoint)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[events](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#events)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[features](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#features)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[session](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#session)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[state](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#state)
...
AccountLoginBehavior.ExtensionInterface
...
▪ `Static` `Readonly` **Interface**: [`AccountLoginInterface`](../modules/behavior_definitions_account_login_export.md#accountlogininterface)

#### Inherited from

AccountLoginBehavior.Interface
...
▪ `Static` `Readonly` **State**: () => [`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Cluster`](../interfaces/cluster_export.AccountLogin.Cluster.md), [`Type`](../interfaces/behavior_cluster_export.ClusterBehavior.Type.md)\<[`Of`](../interfaces/cluster_export.ClusterType.Of.md)\<\{ `attributes`: {} = \{}; `commands`: {} = \{}; `events`: {} = \{}; `id`: ``0`` = 0; `name`: ``"Unknown"`` = "Unknown"; `revision`: ``0`` = 0 }\>, typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md), [`AccountLoginInterface`](../modules/behavior_definitions_account_login_export.md#accountlogininterface)\>\>
...
▪ `Static` `Readonly` **cluster**: [`Cluster`](../interfaces/cluster_export.AccountLogin.Cluster.md)

Base cluster state include all attribute values but may be extended by subclasses.

#### Inherited from

AccountLoginBehavior.cluster
...
AccountLoginBehavior.dependencies
...
▪ `Static` `Readonly` **id**: ``"accountLogin"``

The behavior ID for ClusterBehaviors is the name of the cluster.

#### Inherited from

AccountLoginBehavior.id
...
AccountLoginBehavior.supervisor
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[[asyncDispose]](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#[asyncdispose])
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[asAdmin](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#asadmin)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[assertAttributeEnabled](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#assertattributeenabled)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[callback](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#callback)
...
▸ **getSetupPin**(`request`): [`MaybePromise`](../modules/util_export.md#maybepromise)\<[`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `setupPin`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<``null`` \| `string`\>  }\>\>
...
| Name | Type |
| :------ | :------ |
| `request` | [`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `tempAccountIdentifier`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<`string`\>  }\> |

#### Returns

[`MaybePromise`](../modules/util_export.md#maybepromise)\<[`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `setupPin`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<``null`` \| `string`\>  }\>\>
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[getSetupPin](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#getsetuppin)

#### Defined in

[packages/matter.js/src/behavior/definitions/account-login/AccountLoginInterface.ts:154](https://github.com/project-chip/matter.js/blob/904d0c9b952b91f28a21803759c5e5c66ee4d272/packages/matter.js/src/behavior/definitions/account-login/AccountLoginInterface.ts#L154)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[initialize](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#initialize)
...
| Name | Type |
| :------ | :------ |
| `request` | [`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `setupPin`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<`string`\> ; `tempAccountIdentifier`: [`FieldType`](../interfaces/tlv_export.FieldType.md)\<`string`\>  }\> |
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[login](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#login)

#### Defined in

[packages/matter.js/src/behavior/definitions/account-login/AccountLoginInterface.ts:195](https://github.com/project-chip/matter.js/blob/904d0c9b952b91f28a21803759c5e5c66ee4d272/packages/matter.js/src/behavior/definitions/account-login/AccountLoginInterface.ts#L195)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[logout](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#logout)

#### Defined in

[packages/matter.js/src/behavior/definitions/account-login/AccountLoginInterface.ts:203](https://github.com/project-chip/matter.js/blob/904d0c9b952b91f28a21803759c5e5c66ee4d272/packages/matter.js/src/behavior/definitions/account-login/AccountLoginInterface.ts#L203)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[reactTo](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#reactto)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[requireAttributeEnabled](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#requireattributeenabled)
...
[AccountLoginBehavior](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md).[toString](../interfaces/behavior_definitions_account_login_export.AccountLoginBehavior-1.md#tostring)
