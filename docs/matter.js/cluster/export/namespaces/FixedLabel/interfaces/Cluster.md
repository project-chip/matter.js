...
[@project-chip/matter.js](../../../../../modules.md) / [cluster/export](../../../README.md) / [FixedLabel](../README.md) / Cluster
...
> `readonly` **labelList**: [`Attribute`](../../../interfaces/Attribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>[], `any`\>
...
> **id**: [`Branded`](../../../../../util/export/README.md#brandedtb)\<`64`, `"ClusterId"`\>
...
> `readonly` **name**: `"FixedLabel"` = `"FixedLabel"`
