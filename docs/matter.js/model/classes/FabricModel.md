...
[@project-chip/matter.js](../../modules.md) / [model](../README.md) / FabricModel
...
> **new FabricModel**(`definition`): [`FabricModel`](FabricModel.md)
...
[packages/matter.js/src/model/models/FabricModel.ts:28](https://github.com/project-chip/matter.js/blob/7a8cbb56b87d4ccf34bec5a9a95ab40a1711324f/packages/matter.js/src/model/models/FabricModel.ts#L28)
...
[`FabricElement`](../interfaces/FabricElement.md).[`description`](../interfaces/FabricElement.md#description)
...
[`FabricElement`](../interfaces/FabricElement.md).[`details`](../interfaces/FabricElement.md#details)
...
[`FabricElement`](../interfaces/FabricElement.md).[`global`](../interfaces/FabricElement.md#global)
...
[`FabricElement`](../interfaces/FabricElement.md).[`id`](../interfaces/FabricElement.md#id)
...
[packages/matter.js/src/model/models/FabricModel.ts:14](https://github.com/project-chip/matter.js/blob/7a8cbb56b87d4ccf34bec5a9a95ab40a1711324f/packages/matter.js/src/model/models/FabricModel.ts#L14)
...
[`FabricElement`](../interfaces/FabricElement.md).[`name`](../interfaces/FabricElement.md#name)
...
> **tag**: [`Fabric`](../enumerations/ElementTag.md#fabric) = `FabricElement.Tag`

#### Implementation of

[`FabricElement`](../interfaces/FabricElement.md).[`tag`](../interfaces/FabricElement.md#tag)
...
[packages/matter.js/src/model/models/FabricModel.ts:13](https://github.com/project-chip/matter.js/blob/7a8cbb56b87d4ccf34bec5a9a95ab40a1711324f/packages/matter.js/src/model/models/FabricModel.ts#L13)
...
[`FabricElement`](../interfaces/FabricElement.md).[`type`](../interfaces/FabricElement.md#type)
...
[`FabricElement`](../interfaces/FabricElement.md).[`xref`](../interfaces/FabricElement.md#xref)
...
> `get` **children**(): [`Children`](../-internal-/interfaces/Children.md)\<[`NodeModel`](NodeModel.md), [`NodeElement`](../README.md#nodeelement)\>
...
| Parameter | Type |
| :------ | :------ |
| `children` | ([`NodeElement`](../README.md#nodeelement) \| [`NodeModel`](NodeModel.md))[] |

#### Returns

[`Children`](../-internal-/interfaces/Children.md)\<[`NodeModel`](NodeModel.md), [`NodeElement`](../README.md#nodeelement)\>

#### Source

[packages/matter.js/src/model/models/FabricModel.ts:20](https://github.com/project-chip/matter.js/blob/7a8cbb56b87d4ccf34bec5a9a95ab40a1711324f/packages/matter.js/src/model/models/FabricModel.ts#L20)
...
> `get` **nodes**(): [`Children`](../-internal-/interfaces/Children.md)\<[`NodeModel`](NodeModel.md), [`NodeElement`](../README.md#nodeelement)\>
...
[packages/matter.js/src/model/models/FabricModel.ts:16](https://github.com/project-chip/matter.js/blob/7a8cbb56b87d4ccf34bec5a9a95ab40a1711324f/packages/matter.js/src/model/models/FabricModel.ts#L16)
