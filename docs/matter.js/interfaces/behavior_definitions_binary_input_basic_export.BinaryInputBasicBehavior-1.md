[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/binary-input-basic/export](../modules/behavior_definitions_binary_input_basic_export.md) / BinaryInputBasicBehavior

# Interface: BinaryInputBasicBehavior

[behavior/definitions/binary-input-basic/export](../modules/behavior_definitions_binary_input_basic_export.md).BinaryInputBasicBehavior

## Hierarchy

- [`BinaryInputBasicBehaviorType`](../modules/behavior_definitions_binary_input_basic_export._internal_.md#binaryinputbasicbehaviortype)
...
- [#agent](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md##agent)
- [[reference]](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#[reference])
- [agent](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#agent)
- [cluster](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#cluster)
- [context](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#context)
- [endpoint](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#endpoint)
- [events](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#events)
- [features](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#features)
- [session](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#session)
- [state](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#callback)
- [initialize](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#initialize)
- [reactTo](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_binary_input_basic_export.BinaryInputBasicBehavior-1.md#tostring)
...
BinaryInputBasicBehaviorType.#agent
...
BinaryInputBasicBehaviorType.[reference]
...
BinaryInputBasicBehaviorType.cluster
...
BinaryInputBasicBehaviorType.context
...
BinaryInputBasicBehaviorType.endpoint
...
BinaryInputBasicBehaviorType.features
...
BinaryInputBasicBehaviorType.session
...
BinaryInputBasicBehaviorType.state
...
BinaryInputBasicBehaviorType.[asyncDispose]
...
BinaryInputBasicBehaviorType.asAdmin
...
BinaryInputBasicBehaviorType.assertAttributeEnabled
...
BinaryInputBasicBehaviorType.callback
...
BinaryInputBasicBehaviorType.initialize
...
BinaryInputBasicBehaviorType.reactTo
...
BinaryInputBasicBehaviorType.requireAttributeEnabled
...
BinaryInputBasicBehaviorType.toString
