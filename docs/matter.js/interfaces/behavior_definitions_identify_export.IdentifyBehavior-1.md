[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/identify/export](../modules/behavior_definitions_identify_export.md) / IdentifyBehavior

# Interface: IdentifyBehavior

[behavior/definitions/identify/export](../modules/behavior_definitions_identify_export.md).IdentifyBehavior

## Hierarchy

- [`IdentifyBehaviorType`](../modules/behavior_definitions_identify_export._internal_.md#identifybehaviortype)
...
- [#agent](behavior_definitions_identify_export.IdentifyBehavior-1.md##agent)
- [[reference]](behavior_definitions_identify_export.IdentifyBehavior-1.md#[reference])
- [agent](behavior_definitions_identify_export.IdentifyBehavior-1.md#agent)
- [cluster](behavior_definitions_identify_export.IdentifyBehavior-1.md#cluster)
- [context](behavior_definitions_identify_export.IdentifyBehavior-1.md#context)
- [endpoint](behavior_definitions_identify_export.IdentifyBehavior-1.md#endpoint)
- [events](behavior_definitions_identify_export.IdentifyBehavior-1.md#events)
- [features](behavior_definitions_identify_export.IdentifyBehavior-1.md#features)
- [session](behavior_definitions_identify_export.IdentifyBehavior-1.md#session)
- [state](behavior_definitions_identify_export.IdentifyBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_identify_export.IdentifyBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_identify_export.IdentifyBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_identify_export.IdentifyBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_identify_export.IdentifyBehavior-1.md#callback)
- [identify](behavior_definitions_identify_export.IdentifyBehavior-1.md#identify)
- [initialize](behavior_definitions_identify_export.IdentifyBehavior-1.md#initialize)
- [reactTo](behavior_definitions_identify_export.IdentifyBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_identify_export.IdentifyBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_identify_export.IdentifyBehavior-1.md#tostring)
- [triggerEffect](behavior_definitions_identify_export.IdentifyBehavior-1.md#triggereffect)
...
IdentifyBehaviorType.[reference]
...
IdentifyBehaviorType.[asyncDispose]
...
IdentifyBehaviorType.assertAttributeEnabled
...
IdentifyBehaviorType.identify

#### Defined in

[packages/matter.js/src/behavior/definitions/identify/IdentifyInterface.ts:46](https://github.com/project-chip/matter.js/blob/5f71eedebdb9fa54338bde320c311bb359b7455d/packages/matter.js/src/behavior/definitions/identify/IdentifyInterface.ts#L46)
...
IdentifyBehaviorType.initialize
...
IdentifyBehaviorType.requireAttributeEnabled
...
IdentifyBehaviorType.triggerEffect
