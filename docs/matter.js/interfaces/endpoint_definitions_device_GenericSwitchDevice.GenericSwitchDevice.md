[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [endpoint/definitions/device/GenericSwitchDevice](../modules/endpoint_definitions_device_GenericSwitchDevice.md) / GenericSwitchDevice
