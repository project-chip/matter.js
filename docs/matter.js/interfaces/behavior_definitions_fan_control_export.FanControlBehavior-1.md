[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/fan-control/export](../modules/behavior_definitions_fan_control_export.md) / FanControlBehavior

# Interface: FanControlBehavior

[behavior/definitions/fan-control/export](../modules/behavior_definitions_fan_control_export.md).FanControlBehavior

## Hierarchy

- [`FanControlBehaviorType`](../modules/behavior_definitions_fan_control_export._internal_.md#fancontrolbehaviortype)
...
- [#agent](behavior_definitions_fan_control_export.FanControlBehavior-1.md##agent)
- [[reference]](behavior_definitions_fan_control_export.FanControlBehavior-1.md#[reference])
- [agent](behavior_definitions_fan_control_export.FanControlBehavior-1.md#agent)
- [cluster](behavior_definitions_fan_control_export.FanControlBehavior-1.md#cluster)
- [context](behavior_definitions_fan_control_export.FanControlBehavior-1.md#context)
- [endpoint](behavior_definitions_fan_control_export.FanControlBehavior-1.md#endpoint)
- [events](behavior_definitions_fan_control_export.FanControlBehavior-1.md#events)
- [features](behavior_definitions_fan_control_export.FanControlBehavior-1.md#features)
- [session](behavior_definitions_fan_control_export.FanControlBehavior-1.md#session)
- [state](behavior_definitions_fan_control_export.FanControlBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_fan_control_export.FanControlBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_fan_control_export.FanControlBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_fan_control_export.FanControlBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_fan_control_export.FanControlBehavior-1.md#callback)
- [initialize](behavior_definitions_fan_control_export.FanControlBehavior-1.md#initialize)
- [reactTo](behavior_definitions_fan_control_export.FanControlBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_fan_control_export.FanControlBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_fan_control_export.FanControlBehavior-1.md#tostring)
...
FanControlBehaviorType.[reference]
...
FanControlBehaviorType.cluster
...
FanControlBehaviorType.context
...
FanControlBehaviorType.endpoint
...
FanControlBehaviorType.features
...
FanControlBehaviorType.session
...
FanControlBehaviorType.[asyncDispose]
...
FanControlBehaviorType.asAdmin
...
FanControlBehaviorType.assertAttributeEnabled
...
FanControlBehaviorType.callback
...
FanControlBehaviorType.initialize
...
FanControlBehaviorType.reactTo
...
FanControlBehaviorType.requireAttributeEnabled
...
FanControlBehaviorType.toString
