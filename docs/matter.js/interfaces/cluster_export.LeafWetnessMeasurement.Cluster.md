[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [cluster/export](../modules/cluster_export.md) / [LeafWetnessMeasurement](../modules/cluster_export.LeafWetnessMeasurement.md) / Cluster

# Interface: Cluster

[cluster/export](../modules/cluster_export.md).[LeafWetnessMeasurement](../modules/cluster_export.LeafWetnessMeasurement.md).Cluster
...
[MatterApplicationClusterSpecificationV1_1](spec_export.MatterApplicationClusterSpecificationV1_1.md) § 2.6

## Hierarchy

- [`Identity`](../modules/util_export.md#identity)\<typeof [`ClusterInstance`](../modules/cluster_export.LeafWetnessMeasurement.md#clusterinstance)\>
...
- [attributes](cluster_export.LeafWetnessMeasurement.Cluster.md#attributes)
- [base](cluster_export.LeafWetnessMeasurement.Cluster.md#base)
- [commands](cluster_export.LeafWetnessMeasurement.Cluster.md#commands)
- [events](cluster_export.LeafWetnessMeasurement.Cluster.md#events)
- [extensions](cluster_export.LeafWetnessMeasurement.Cluster.md#extensions)
- [features](cluster_export.LeafWetnessMeasurement.Cluster.md#features)
- [id](cluster_export.LeafWetnessMeasurement.Cluster.md#id)
- [name](cluster_export.LeafWetnessMeasurement.Cluster.md#name)
- [revision](cluster_export.LeafWetnessMeasurement.Cluster.md#revision)
- [supportedFeatures](cluster_export.LeafWetnessMeasurement.Cluster.md#supportedfeatures)
- [unknown](cluster_export.LeafWetnessMeasurement.Cluster.md#unknown)

### Methods

- [alter](cluster_export.LeafWetnessMeasurement.Cluster.md#alter)
- [enable](cluster_export.LeafWetnessMeasurement.Cluster.md#enable)
- [set](cluster_export.LeafWetnessMeasurement.Cluster.md#set)
- [with](cluster_export.LeafWetnessMeasurement.Cluster.md#with)
