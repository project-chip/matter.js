[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/time-sync/export](../modules/behavior_definitions_time_sync_export.md) / TimeSyncBehavior

# Interface: TimeSyncBehavior

[behavior/definitions/time-sync/export](../modules/behavior_definitions_time_sync_export.md).TimeSyncBehavior

## Hierarchy

- [`TimeSyncBehaviorType`](../modules/behavior_definitions_time_sync_export._internal_.md#timesyncbehaviortype)
...
- [#agent](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md##agent)
- [[reference]](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#[reference])
- [agent](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#agent)
- [cluster](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#cluster)
- [context](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#context)
- [endpoint](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#endpoint)
- [events](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#events)
- [features](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#features)
- [session](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#session)
- [state](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#callback)
- [initialize](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#initialize)
- [reactTo](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#requireattributeenabled)
- [setUtcTime](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#setutctime)
- [toString](behavior_definitions_time_sync_export.TimeSyncBehavior-1.md#tostring)
...
TimeSyncBehaviorType.[reference]
...
• `Readonly` **events**: [`EventEmitter`](../classes/util_export.EventEmitter-1.md) & `Omit`\<[`ClusterEvents`](../modules/behavior_cluster_export.md#clusterevents)\<[`Of`](cluster_export.ClusterType.Of.md)\<\{ `attributes`: {} = \{}; `commands`: {} = \{}; `events`: {} = \{}; `id`: ``0`` = 0; `name`: ``"Unknown"`` = "Unknown"; `revision`: ``0`` = 0 }\>, typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>, `never`\> & \{ `granularity$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](cluster_export.Attribute.md)\<[`Granularity`](../enums/cluster_export.TimeSync.Granularity.md), `any`\>\> ; `trustedTimeNodeId$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`WritableAttribute`](cluster_export.WritableAttribute.md)\<``null`` \| [`NodeId`](../modules/datatype_export.md#nodeid), `any`\>\> ; `utcTime$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](cluster_export.Attribute.md)\<``null`` \| `number` \| `bigint`, `any`\>\>  } & \{ `timeSource$Changing`: `undefined` \| [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`OptionalAttribute`](cluster_export.OptionalAttribute.md)\<[`TimeSource`](../enums/cluster_export.TimeSync.TimeSource.md), `any`\>\>  } & \{ `granularity$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](cluster_export.Attribute.md)\<[`Granularity`](../enums/cluster_export.TimeSync.Granularity.md), `any`\>\> ; `trustedTimeNodeId$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`WritableAttribute`](cluster_export.WritableAttribute.md)\<``null`` \| [`NodeId`](../modules/datatype_export.md#nodeid), `any`\>\> ; `utcTime$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](cluster_export.Attribute.md)\<``null`` \| `number` \| `bigint`, `any`\>\>  } & \{ `timeSource$Changed`: `undefined` \| [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`OptionalAttribute`](cluster_export.OptionalAttribute.md)\<[`TimeSource`](../enums/cluster_export.TimeSync.TimeSource.md), `any`\>\>  } & {} & {}

Access the behavior's events.

#### Inherited from

TimeSyncBehaviorType.events
...
TimeSyncBehaviorType.[asyncDispose]
...
TimeSyncBehaviorType.assertAttributeEnabled
...
TimeSyncBehaviorType.initialize
...
TimeSyncBehaviorType.requireAttributeEnabled
...
TimeSyncBehaviorType.setUtcTime

#### Defined in

[packages/matter.js/src/behavior/definitions/time-sync/TimeSyncInterface.ts:54](https://github.com/project-chip/matter.js/blob/6d3b6a5d957d88a9231d6ecab4bb41f8133112be/packages/matter.js/src/behavior/definitions/time-sync/TimeSyncInterface.ts#L54)
