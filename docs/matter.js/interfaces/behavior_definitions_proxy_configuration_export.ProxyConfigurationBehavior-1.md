[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/proxy-configuration/export](../modules/behavior_definitions_proxy_configuration_export.md) / ProxyConfigurationBehavior

# Interface: ProxyConfigurationBehavior

[behavior/definitions/proxy-configuration/export](../modules/behavior_definitions_proxy_configuration_export.md).ProxyConfigurationBehavior

## Hierarchy

- [`ProxyConfigurationBehaviorType`](../modules/behavior_definitions_proxy_configuration_export._internal_.md#proxyconfigurationbehaviortype)
...
- [#agent](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md##agent)
- [[reference]](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#[reference])
- [agent](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#agent)
- [cluster](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#cluster)
- [context](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#context)
- [endpoint](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#endpoint)
- [events](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#events)
- [features](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#features)
- [session](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#session)
- [state](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#callback)
- [initialize](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#initialize)
- [reactTo](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_proxy_configuration_export.ProxyConfigurationBehavior-1.md#tostring)
...
• `Readonly` **events**: [`EventEmitter`](../classes/util_export.EventEmitter-1.md) & `Omit`\<[`EventEmitter`](../classes/util_export.EventEmitter-1.md), `never`\> & \{ `configurationList$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`WritableAttribute`](cluster_export.WritableAttribute.md)\<[`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `proxyAllNodes`: [`FieldType`](tlv_export.FieldType.md)\<`boolean`\> ; `sourceList`: [`FieldType`](tlv_export.FieldType.md)\<[`NodeId`](../modules/datatype_export.md#nodeid)[]\>  }\>[], `any`\>\>  } & {} & \{ `configurationList$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`WritableAttribute`](cluster_export.WritableAttribute.md)\<[`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `proxyAllNodes`: [`FieldType`](tlv_export.FieldType.md)\<`boolean`\> ; `sourceList`: [`FieldType`](tlv_export.FieldType.md)\<[`NodeId`](../modules/datatype_export.md#nodeid)[]\>  }\>[], `any`\>\>  } & {} & {} & {}
...
• `Readonly` **state**: `Omit`\<{}, `never`\> & \{ `configurationList`: [`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `proxyAllNodes`: [`FieldType`](tlv_export.FieldType.md)\<`boolean`\> ; `sourceList`: [`FieldType`](tlv_export.FieldType.md)\<[`NodeId`](../modules/datatype_export.md#nodeid)[]\>  }\>[]  } & {} & {} & {}
