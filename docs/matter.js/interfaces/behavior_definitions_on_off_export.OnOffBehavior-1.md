[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/on-off/export](../modules/behavior_definitions_on_off_export.md) / OnOffBehavior

# Interface: OnOffBehavior

[behavior/definitions/on-off/export](../modules/behavior_definitions_on_off_export.md).OnOffBehavior

## Hierarchy

- [`OnOffBehaviorType`](../modules/behavior_definitions_on_off_export._internal_.md#onoffbehaviortype)
...
- [#agent](behavior_definitions_on_off_export.OnOffBehavior-1.md##agent)
- [[reference]](behavior_definitions_on_off_export.OnOffBehavior-1.md#[reference])
- [agent](behavior_definitions_on_off_export.OnOffBehavior-1.md#agent)
- [cluster](behavior_definitions_on_off_export.OnOffBehavior-1.md#cluster)
- [context](behavior_definitions_on_off_export.OnOffBehavior-1.md#context)
- [endpoint](behavior_definitions_on_off_export.OnOffBehavior-1.md#endpoint)
- [events](behavior_definitions_on_off_export.OnOffBehavior-1.md#events)
- [features](behavior_definitions_on_off_export.OnOffBehavior-1.md#features)
- [session](behavior_definitions_on_off_export.OnOffBehavior-1.md#session)
- [state](behavior_definitions_on_off_export.OnOffBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_on_off_export.OnOffBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_on_off_export.OnOffBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_on_off_export.OnOffBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_on_off_export.OnOffBehavior-1.md#callback)
- [initialize](behavior_definitions_on_off_export.OnOffBehavior-1.md#initialize)
- [off](behavior_definitions_on_off_export.OnOffBehavior-1.md#off)
- [on](behavior_definitions_on_off_export.OnOffBehavior-1.md#on)
- [reactTo](behavior_definitions_on_off_export.OnOffBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_on_off_export.OnOffBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_on_off_export.OnOffBehavior-1.md#tostring)
- [toggle](behavior_definitions_on_off_export.OnOffBehavior-1.md#toggle)
...
• `Readonly` **state**: `Omit`\<[`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Of`](cluster_export.ClusterType.Of.md)\<\{ `attributes`: {} = \{}; `commands`: {} = \{}; `events`: {} = \{}; `id`: ``0`` = 0; `name`: ``"Unknown"`` = "Unknown"; `revision`: ``0`` = 0 }\>, typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>, `never`\> & \{ `onOff`: `boolean`  } & {} & {} & {}

Access the behavior's state.

#### Inherited from

OnOffBehaviorType.state
...
OnOffBehaviorType.[asyncDispose]
...
OnOffBehaviorType.assertAttributeEnabled
...
OnOffBehaviorType.off

#### Defined in

[packages/matter.js/src/behavior/definitions/on-off/OnOffInterface.ts:38](https://github.com/project-chip/matter.js/blob/904d0c9b952b91f28a21803759c5e5c66ee4d272/packages/matter.js/src/behavior/definitions/on-off/OnOffInterface.ts#L38)
...
OnOffBehaviorType.on

#### Defined in

[packages/matter.js/src/behavior/definitions/on-off/OnOffInterface.ts:45](https://github.com/project-chip/matter.js/blob/904d0c9b952b91f28a21803759c5e5c66ee4d272/packages/matter.js/src/behavior/definitions/on-off/OnOffInterface.ts#L45)
...
OnOffBehaviorType.requireAttributeEnabled
...
OnOffBehaviorType.toggle

#### Defined in

[packages/matter.js/src/behavior/definitions/on-off/OnOffInterface.ts:52](https://github.com/project-chip/matter.js/blob/904d0c9b952b91f28a21803759c5e5c66ee4d272/packages/matter.js/src/behavior/definitions/on-off/OnOffInterface.ts#L52)
