[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/diagnostic-logs/export](../modules/behavior_definitions_diagnostic_logs_export.md) / DiagnosticLogsBehavior

# Interface: DiagnosticLogsBehavior

[behavior/definitions/diagnostic-logs/export](../modules/behavior_definitions_diagnostic_logs_export.md).DiagnosticLogsBehavior

## Hierarchy

- [`DiagnosticLogsBehaviorType`](../modules/behavior_definitions_diagnostic_logs_export._internal_.md#diagnosticlogsbehaviortype)
...
- [#agent](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md##agent)
- [[reference]](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#[reference])
- [agent](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#agent)
- [cluster](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#cluster)
- [context](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#context)
- [endpoint](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#endpoint)
- [events](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#events)
- [features](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#features)
- [session](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#session)
- [state](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#callback)
- [initialize](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#initialize)
- [reactTo](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#requireattributeenabled)
- [retrieveLogsRequest](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#retrievelogsrequest)
- [toString](behavior_definitions_diagnostic_logs_export.DiagnosticLogsBehavior-1.md#tostring)
...
DiagnosticLogsBehaviorType.#agent
...
DiagnosticLogsBehaviorType.[reference]
...
DiagnosticLogsBehaviorType.cluster
...
DiagnosticLogsBehaviorType.context
...
DiagnosticLogsBehaviorType.endpoint
...
DiagnosticLogsBehaviorType.events
...
DiagnosticLogsBehaviorType.features
...
DiagnosticLogsBehaviorType.session
...
DiagnosticLogsBehaviorType.state
...
DiagnosticLogsBehaviorType.[asyncDispose]
...
DiagnosticLogsBehaviorType.asAdmin
...
DiagnosticLogsBehaviorType.assertAttributeEnabled
...
DiagnosticLogsBehaviorType.callback
...
DiagnosticLogsBehaviorType.initialize
...
DiagnosticLogsBehaviorType.reactTo
...
DiagnosticLogsBehaviorType.requireAttributeEnabled
...
DiagnosticLogsBehaviorType.retrieveLogsRequest

#### Defined in

[packages/matter.js/src/behavior/definitions/diagnostic-logs/DiagnosticLogsInterface.ts:35](https://github.com/project-chip/matter.js/blob/0c058ae17fdba4c0b89b8b13c309011d51782299/packages/matter.js/src/behavior/definitions/diagnostic-logs/DiagnosticLogsInterface.ts#L35)
...
DiagnosticLogsBehaviorType.toString
