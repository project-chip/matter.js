...
• `Readonly` **state**: `Omit`\<{}, `never`\> & \{ `partsList`: [`EndpointNumber`](../modules/datatype_export.md#endpointnumber)[]  } & {} & \{ `clientList`: [`ClusterId`](../modules/datatype_export.md#clusterid)[] ; `deviceTypeList`: [`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `deviceType`: [`FieldType`](tlv_export.FieldType.md)\<[`DeviceTypeId`](../modules/datatype_export.md#devicetypeid)\> ; `revision`: [`FieldType`](tlv_export.FieldType.md)\<`number`\>  }\>[] ; `serverList`: [`ClusterId`](../modules/datatype_export.md#clusterid)[]  } & {}
