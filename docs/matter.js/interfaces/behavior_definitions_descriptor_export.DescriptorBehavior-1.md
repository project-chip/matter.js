[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/descriptor/export](../modules/behavior_definitions_descriptor_export.md) / DescriptorBehavior

# Interface: DescriptorBehavior

[behavior/definitions/descriptor/export](../modules/behavior_definitions_descriptor_export.md).DescriptorBehavior

## Hierarchy

- [`DescriptorBehaviorType`](../modules/behavior_definitions_descriptor_export._internal_.md#descriptorbehaviortype)
...
- [#agent](behavior_definitions_descriptor_export.DescriptorBehavior-1.md##agent)
- [[reference]](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#[reference])
- [agent](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#agent)
- [cluster](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#cluster)
- [context](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#context)
- [endpoint](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#endpoint)
- [events](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#events)
- [features](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#features)
- [session](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#session)
- [state](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#callback)
- [initialize](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#initialize)
- [reactTo](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_descriptor_export.DescriptorBehavior-1.md#tostring)
...
• `Readonly` **events**: [`EventEmitter`](../classes/util_export.EventEmitter-1.md) & `Omit`\<[`EventEmitter`](../classes/util_export.EventEmitter-1.md), `never`\> & \{ `clientList$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`FixedAttribute`](cluster_export.FixedAttribute.md)\<[`ClusterId`](../modules/datatype_export.md#clusterid)\<`number`\>[], `any`\>\> ; `deviceTypeList$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`FixedAttribute`](cluster_export.FixedAttribute.md)\<[`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `deviceType`: [`FieldType`](tlv_export.FieldType.md)\<[`DeviceTypeId`](../modules/datatype_export.md#devicetypeid)\<`number`\>\> ; `revision`: [`FieldType`](tlv_export.FieldType.md)\<`number`\>  }\>[], `any`\>\> ; `partsList$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](cluster_export.Attribute.md)\<[`EndpointNumber`](../modules/datatype_export.md#endpointnumber)[], `any`\>\> ; `serverList$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`FixedAttribute`](cluster_export.FixedAttribute.md)\<[`ClusterId`](../modules/datatype_export.md#clusterid)\<`number`\>[], `any`\>\>  } & {} & \{ `clientList$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`FixedAttribute`](cluster_export.FixedAttribute.md)\<[`ClusterId`](../modules/datatype_export.md#clusterid)\<`number`\>[], `any`\>\> ; `deviceTypeList$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`FixedAttribute`](cluster_export.FixedAttribute.md)\<[`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `deviceType`: [`FieldType`](tlv_export.FieldType.md)\<[`DeviceTypeId`](../modules/datatype_export.md#devicetypeid)\<`number`\>\> ; `revision`: [`FieldType`](tlv_export.FieldType.md)\<`number`\>  }\>[], `any`\>\> ; `partsList$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](cluster_export.Attribute.md)\<[`EndpointNumber`](../modules/datatype_export.md#endpointnumber)[], `any`\>\> ; `serverList$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`FixedAttribute`](cluster_export.FixedAttribute.md)\<[`ClusterId`](../modules/datatype_export.md#clusterid)\<`number`\>[], `any`\>\>  } & {} & {} & {}
...
• `Readonly` **state**: `Omit`\<{}, `never`\> & \{ `partsList`: [`EndpointNumber`](../modules/datatype_export.md#endpointnumber)[]  } & {} & \{ `clientList`: [`ClusterId`](../modules/datatype_export.md#clusterid)\<`number`\>[] ; `deviceTypeList`: [`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `deviceType`: [`FieldType`](tlv_export.FieldType.md)\<[`DeviceTypeId`](../modules/datatype_export.md#devicetypeid)\<`number`\>\> ; `revision`: [`FieldType`](tlv_export.FieldType.md)\<`number`\>  }\>[] ; `serverList`: [`ClusterId`](../modules/datatype_export.md#clusterid)\<`number`\>[]  } & {}
