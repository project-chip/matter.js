[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [endpoint/definitions/device/HumiditySensorDevice](../modules/endpoint_definitions_device_HumiditySensorDevice.md) / HumiditySensorDevice
