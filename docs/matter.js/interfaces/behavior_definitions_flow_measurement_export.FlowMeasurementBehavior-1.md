[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/flow-measurement/export](../modules/behavior_definitions_flow_measurement_export.md) / FlowMeasurementBehavior

# Interface: FlowMeasurementBehavior

[behavior/definitions/flow-measurement/export](../modules/behavior_definitions_flow_measurement_export.md).FlowMeasurementBehavior

## Hierarchy

- [`FlowMeasurementBehaviorType`](../modules/behavior_definitions_flow_measurement_export._internal_.md#flowmeasurementbehaviortype)
...
- [#agent](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md##agent)
- [[reference]](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#[reference])
- [agent](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#agent)
- [cluster](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#cluster)
- [context](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#context)
- [endpoint](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#endpoint)
- [events](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#events)
- [features](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#features)
- [session](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#session)
- [state](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#callback)
- [initialize](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#initialize)
- [reactTo](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_flow_measurement_export.FlowMeasurementBehavior-1.md#tostring)
...
FlowMeasurementBehaviorType.#agent
...
FlowMeasurementBehaviorType.[reference]
...
FlowMeasurementBehaviorType.cluster
...
FlowMeasurementBehaviorType.context
...
FlowMeasurementBehaviorType.endpoint
...
FlowMeasurementBehaviorType.events
...
FlowMeasurementBehaviorType.features
...
FlowMeasurementBehaviorType.session
...
FlowMeasurementBehaviorType.state
...
FlowMeasurementBehaviorType.[asyncDispose]
...
FlowMeasurementBehaviorType.asAdmin
...
FlowMeasurementBehaviorType.assertAttributeEnabled
...
FlowMeasurementBehaviorType.callback
...
FlowMeasurementBehaviorType.initialize
...
FlowMeasurementBehaviorType.reactTo
...
FlowMeasurementBehaviorType.requireAttributeEnabled
...
FlowMeasurementBehaviorType.toString
