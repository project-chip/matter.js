[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/power-source/export](../modules/behavior_definitions_power_source_export.md) / PowerSourceBehavior

# Interface: PowerSourceBehavior

[behavior/definitions/power-source/export](../modules/behavior_definitions_power_source_export.md).PowerSourceBehavior

## Hierarchy

- [`PowerSourceBehaviorType`](../modules/behavior_definitions_power_source_export._internal_.md#powersourcebehaviortype)
...
- [#agent](behavior_definitions_power_source_export.PowerSourceBehavior-1.md##agent)
- [[reference]](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#[reference])
- [agent](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#agent)
- [cluster](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#cluster)
- [context](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#context)
- [endpoint](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#endpoint)
- [events](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#events)
- [features](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#features)
- [session](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#session)
- [state](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#callback)
- [initialize](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#initialize)
- [reactTo](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_power_source_export.PowerSourceBehavior-1.md#tostring)
...
PowerSourceBehaviorType.[reference]
...
PowerSourceBehaviorType.cluster
...
PowerSourceBehaviorType.context
...
PowerSourceBehaviorType.endpoint
...
• `Readonly` **events**: [`EventEmitter`](../classes/util_export.EventEmitter-1.md) & `Omit`\<[`EventEmitter`](../classes/util_export.EventEmitter-1.md), `never`\> & \{ `description$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`FixedAttribute`](cluster_export.FixedAttribute.md)\<`string`, `any`\>\> ; `order$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](cluster_export.Attribute.md)\<`number`, `any`\>\> ; `status$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](cluster_export.Attribute.md)\<[`PowerSourceStatus`](../enums/cluster_export.PowerSource.PowerSourceStatus.md), `any`\>\>  } & {} & \{ `description$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`FixedAttribute`](cluster_export.FixedAttribute.md)\<`string`, `any`\>\> ; `order$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](cluster_export.Attribute.md)\<`number`, `any`\>\> ; `status$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](cluster_export.Attribute.md)\<[`PowerSourceStatus`](../enums/cluster_export.PowerSource.PowerSourceStatus.md), `any`\>\>  } & {} & {} & {}

Access the behavior's events.

#### Inherited from

PowerSourceBehaviorType.events
...
PowerSourceBehaviorType.features
...
PowerSourceBehaviorType.session
...
PowerSourceBehaviorType.[asyncDispose]
...
PowerSourceBehaviorType.asAdmin
...
PowerSourceBehaviorType.assertAttributeEnabled
...
PowerSourceBehaviorType.callback
...
PowerSourceBehaviorType.initialize
...
PowerSourceBehaviorType.reactTo
...
PowerSourceBehaviorType.requireAttributeEnabled
...
PowerSourceBehaviorType.toString
