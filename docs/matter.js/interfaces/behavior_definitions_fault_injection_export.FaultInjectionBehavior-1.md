[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/fault-injection/export](../modules/behavior_definitions_fault_injection_export.md) / FaultInjectionBehavior

# Interface: FaultInjectionBehavior

[behavior/definitions/fault-injection/export](../modules/behavior_definitions_fault_injection_export.md).FaultInjectionBehavior

## Hierarchy

- [`FaultInjectionBehaviorType`](../modules/behavior_definitions_fault_injection_export._internal_.md#faultinjectionbehaviortype)
...
- [#agent](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md##agent)
- [[reference]](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#[reference])
- [agent](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#agent)
- [cluster](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#cluster)
- [context](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#context)
- [endpoint](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#endpoint)
- [events](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#events)
- [features](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#features)
- [session](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#session)
- [state](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#callback)
- [failAtFault](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#failatfault)
- [failRandomlyAtFault](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#failrandomlyatfault)
- [initialize](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#initialize)
- [reactTo](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_fault_injection_export.FaultInjectionBehavior-1.md#tostring)
...
FaultInjectionBehaviorType.#agent
...
FaultInjectionBehaviorType.[reference]
...
FaultInjectionBehaviorType.cluster
...
FaultInjectionBehaviorType.context
...
FaultInjectionBehaviorType.endpoint
...
FaultInjectionBehaviorType.events
...
FaultInjectionBehaviorType.features
...
FaultInjectionBehaviorType.session
...
FaultInjectionBehaviorType.state
...
FaultInjectionBehaviorType.[asyncDispose]
...
FaultInjectionBehaviorType.asAdmin
...
FaultInjectionBehaviorType.assertAttributeEnabled
...
FaultInjectionBehaviorType.callback
...
FaultInjectionBehaviorType.failAtFault
...
FaultInjectionBehaviorType.failRandomlyAtFault
...
FaultInjectionBehaviorType.initialize
...
FaultInjectionBehaviorType.reactTo
...
FaultInjectionBehaviorType.requireAttributeEnabled
...
FaultInjectionBehaviorType.toString
