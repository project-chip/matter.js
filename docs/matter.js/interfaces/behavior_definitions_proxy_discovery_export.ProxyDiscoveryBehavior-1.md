[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/proxy-discovery/export](../modules/behavior_definitions_proxy_discovery_export.md) / ProxyDiscoveryBehavior

# Interface: ProxyDiscoveryBehavior

[behavior/definitions/proxy-discovery/export](../modules/behavior_definitions_proxy_discovery_export.md).ProxyDiscoveryBehavior

## Hierarchy

- [`ProxyDiscoveryBehaviorType`](../modules/behavior_definitions_proxy_discovery_export._internal_.md#proxydiscoverybehaviortype)
...
- [#agent](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md##agent)
- [[reference]](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#[reference])
- [agent](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#agent)
- [cluster](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#cluster)
- [context](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#context)
- [endpoint](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#endpoint)
- [events](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#events)
- [features](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#features)
- [session](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#session)
- [state](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#callback)
- [initialize](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#initialize)
- [proxyDiscoverRequest](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#proxydiscoverrequest)
- [reactTo](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_proxy_discovery_export.ProxyDiscoveryBehavior-1.md#tostring)
...
ProxyDiscoveryBehaviorType.#agent
...
ProxyDiscoveryBehaviorType.[reference]
...
ProxyDiscoveryBehaviorType.cluster
...
ProxyDiscoveryBehaviorType.context
...
ProxyDiscoveryBehaviorType.endpoint
...
ProxyDiscoveryBehaviorType.events
...
ProxyDiscoveryBehaviorType.features
...
ProxyDiscoveryBehaviorType.session
...
ProxyDiscoveryBehaviorType.state
...
ProxyDiscoveryBehaviorType.[asyncDispose]
...
ProxyDiscoveryBehaviorType.asAdmin
...
ProxyDiscoveryBehaviorType.assertAttributeEnabled
...
ProxyDiscoveryBehaviorType.callback
...
ProxyDiscoveryBehaviorType.initialize
...
ProxyDiscoveryBehaviorType.proxyDiscoverRequest
...
ProxyDiscoveryBehaviorType.reactTo
...
ProxyDiscoveryBehaviorType.requireAttributeEnabled
...
ProxyDiscoveryBehaviorType.toString
