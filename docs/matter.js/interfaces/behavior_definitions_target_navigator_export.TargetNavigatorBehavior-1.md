[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/target-navigator/export](../modules/behavior_definitions_target_navigator_export.md) / TargetNavigatorBehavior

# Interface: TargetNavigatorBehavior

[behavior/definitions/target-navigator/export](../modules/behavior_definitions_target_navigator_export.md).TargetNavigatorBehavior

## Hierarchy

- [`TargetNavigatorBehaviorType`](../modules/behavior_definitions_target_navigator_export._internal_.md#targetnavigatorbehaviortype)
...
- [#agent](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md##agent)
- [[reference]](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#[reference])
- [agent](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#agent)
- [cluster](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#cluster)
- [context](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#context)
- [endpoint](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#endpoint)
- [events](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#events)
- [features](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#features)
- [session](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#session)
- [state](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#callback)
- [initialize](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#initialize)
- [navigateTarget](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#navigatetarget)
- [reactTo](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_target_navigator_export.TargetNavigatorBehavior-1.md#tostring)
...
TargetNavigatorBehaviorType.#agent
...
TargetNavigatorBehaviorType.[reference]
...
TargetNavigatorBehaviorType.cluster
...
TargetNavigatorBehaviorType.context
...
TargetNavigatorBehaviorType.endpoint
...
TargetNavigatorBehaviorType.features
...
TargetNavigatorBehaviorType.session
...
TargetNavigatorBehaviorType.[asyncDispose]
...
TargetNavigatorBehaviorType.asAdmin
...
TargetNavigatorBehaviorType.assertAttributeEnabled
...
TargetNavigatorBehaviorType.callback
...
TargetNavigatorBehaviorType.initialize
...
TargetNavigatorBehaviorType.navigateTarget

#### Defined in

[packages/matter.js/src/behavior/definitions/target-navigator/TargetNavigatorInterface.ts:34](https://github.com/project-chip/matter.js/blob/0c058ae17fdba4c0b89b8b13c309011d51782299/packages/matter.js/src/behavior/definitions/target-navigator/TargetNavigatorInterface.ts#L34)
...
TargetNavigatorBehaviorType.reactTo
...
TargetNavigatorBehaviorType.requireAttributeEnabled
...
TargetNavigatorBehaviorType.toString
