[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/boolean-state/export](../modules/behavior_definitions_boolean_state_export.md) / BooleanStateBehavior

# Interface: BooleanStateBehavior

[behavior/definitions/boolean-state/export](../modules/behavior_definitions_boolean_state_export.md).BooleanStateBehavior

## Hierarchy

- [`BooleanStateBehaviorType`](../modules/behavior_definitions_boolean_state_export._internal_.md#booleanstatebehaviortype)
...
- [#agent](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md##agent)
- [[reference]](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#[reference])
- [agent](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#agent)
- [cluster](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#cluster)
- [context](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#context)
- [endpoint](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#endpoint)
- [events](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#events)
- [features](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#features)
- [session](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#session)
- [state](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#callback)
- [initialize](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#initialize)
- [reactTo](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_boolean_state_export.BooleanStateBehavior-1.md#tostring)
...
BooleanStateBehaviorType.#agent
...
BooleanStateBehaviorType.[reference]
...
BooleanStateBehaviorType.cluster
...
BooleanStateBehaviorType.context
...
BooleanStateBehaviorType.endpoint
...
• `Readonly` **events**: [`EventEmitter`](../classes/util_export.EventEmitter-1.md) & `Omit`\<[`EventEmitter`](../classes/util_export.EventEmitter-1.md), `never`\> & \{ `stateValue$Changing`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](cluster_export.Attribute.md)\<`boolean`, `any`\>\>  } & {} & \{ `stateValue$Changed`: [`AttributeObservable`](../modules/behavior_cluster_export.ClusterEvents.md#attributeobservable)\<[`Attribute`](cluster_export.Attribute.md)\<`boolean`, `any`\>\>  } & {} & {} & \{ `stateChange?`: [`EventObservable`](../modules/behavior_cluster_export.ClusterEvents.md#eventobservable)\<[`OptionalEvent`](cluster_export.OptionalEvent.md)\<[`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `stateValue`: [`FieldType`](tlv_export.FieldType.md)\<`boolean`\>  }\>, `any`\>\>  }

Access the behavior's events.

#### Inherited from

BooleanStateBehaviorType.events
...
BooleanStateBehaviorType.features
...
BooleanStateBehaviorType.session
...
BooleanStateBehaviorType.state
...
BooleanStateBehaviorType.[asyncDispose]
...
BooleanStateBehaviorType.asAdmin
...
BooleanStateBehaviorType.assertAttributeEnabled
...
BooleanStateBehaviorType.callback
...
BooleanStateBehaviorType.initialize
...
BooleanStateBehaviorType.reactTo
...
BooleanStateBehaviorType.requireAttributeEnabled
...
BooleanStateBehaviorType.toString
