[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/user-label/export](../modules/behavior_definitions_user_label_export.md) / UserLabelBehavior

# Interface: UserLabelBehavior

[behavior/definitions/user-label/export](../modules/behavior_definitions_user_label_export.md).UserLabelBehavior

## Hierarchy

- [`UserLabelBehaviorType`](../modules/behavior_definitions_user_label_export._internal_.md#userlabelbehaviortype)
...
- [#agent](behavior_definitions_user_label_export.UserLabelBehavior-1.md##agent)
- [[reference]](behavior_definitions_user_label_export.UserLabelBehavior-1.md#[reference])
- [agent](behavior_definitions_user_label_export.UserLabelBehavior-1.md#agent)
- [cluster](behavior_definitions_user_label_export.UserLabelBehavior-1.md#cluster)
- [context](behavior_definitions_user_label_export.UserLabelBehavior-1.md#context)
- [endpoint](behavior_definitions_user_label_export.UserLabelBehavior-1.md#endpoint)
- [events](behavior_definitions_user_label_export.UserLabelBehavior-1.md#events)
- [features](behavior_definitions_user_label_export.UserLabelBehavior-1.md#features)
- [session](behavior_definitions_user_label_export.UserLabelBehavior-1.md#session)
- [state](behavior_definitions_user_label_export.UserLabelBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_user_label_export.UserLabelBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_user_label_export.UserLabelBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_user_label_export.UserLabelBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_user_label_export.UserLabelBehavior-1.md#callback)
- [initialize](behavior_definitions_user_label_export.UserLabelBehavior-1.md#initialize)
- [reactTo](behavior_definitions_user_label_export.UserLabelBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_user_label_export.UserLabelBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_user_label_export.UserLabelBehavior-1.md#tostring)
...
UserLabelBehaviorType.[reference]
...
UserLabelBehaviorType.endpoint
...
UserLabelBehaviorType.features
...
UserLabelBehaviorType.[asyncDispose]
...
UserLabelBehaviorType.assertAttributeEnabled
...
UserLabelBehaviorType.callback
...
UserLabelBehaviorType.initialize
...
UserLabelBehaviorType.requireAttributeEnabled
...
UserLabelBehaviorType.toString
