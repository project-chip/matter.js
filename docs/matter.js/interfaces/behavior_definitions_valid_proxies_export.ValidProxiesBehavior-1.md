[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/valid-proxies/export](../modules/behavior_definitions_valid_proxies_export.md) / ValidProxiesBehavior

# Interface: ValidProxiesBehavior

[behavior/definitions/valid-proxies/export](../modules/behavior_definitions_valid_proxies_export.md).ValidProxiesBehavior

## Hierarchy

- [`ValidProxiesBehaviorType`](../modules/behavior_definitions_valid_proxies_export._internal_.md#validproxiesbehaviortype)
...
- [#agent](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md##agent)
- [[reference]](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#[reference])
- [agent](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#agent)
- [cluster](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#cluster)
- [context](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#context)
- [endpoint](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#endpoint)
- [events](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#events)
- [features](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#features)
- [session](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#session)
- [state](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#callback)
- [getValidProxiesRequest](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#getvalidproxiesrequest)
- [initialize](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#initialize)
- [reactTo](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_valid_proxies_export.ValidProxiesBehavior-1.md#tostring)
...
ValidProxiesBehaviorType.#agent
...
ValidProxiesBehaviorType.[reference]
...
ValidProxiesBehaviorType.cluster
...
ValidProxiesBehaviorType.context
...
ValidProxiesBehaviorType.endpoint
...
ValidProxiesBehaviorType.features
...
ValidProxiesBehaviorType.session
...
• `Readonly` **state**: `Omit`\<[`Type`](../modules/behavior_cluster_export.ClusterState.md#type)\<[`Of`](cluster_export.ClusterType.Of.md)\<\{ `attributes`: {} = \{}; `commands`: {} = \{}; `events`: {} = \{}; `id`: ``0`` = 0; `name`: ``"Unknown"`` = "Unknown"; `revision`: ``0`` = 0 }\>, typeof [`ClusterBehavior`](../modules/behavior_cluster_export.ClusterBehavior.md)\>, `never`\> & {} & {} & \{ `validProxyList`: [`TypeFromFields`](../modules/tlv_export.md#typefromfields)\<\{ `nodeId`: [`FieldType`](tlv_export.FieldType.md)\<[`NodeId`](../modules/datatype_export.md#nodeid)\>  }\>[]  } & {}

Access the behavior's state.

#### Inherited from

ValidProxiesBehaviorType.state
...
ValidProxiesBehaviorType.[asyncDispose]
...
ValidProxiesBehaviorType.asAdmin
...
ValidProxiesBehaviorType.assertAttributeEnabled
...
ValidProxiesBehaviorType.callback
...
ValidProxiesBehaviorType.getValidProxiesRequest
...
ValidProxiesBehaviorType.initialize
...
ValidProxiesBehaviorType.reactTo
...
ValidProxiesBehaviorType.requireAttributeEnabled
...
ValidProxiesBehaviorType.toString
