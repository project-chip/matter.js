[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/ethernet-network-diagnostics/export](../modules/behavior_definitions_ethernet_network_diagnostics_export.md) / EthernetNetworkDiagnosticsBehavior

# Interface: EthernetNetworkDiagnosticsBehavior

[behavior/definitions/ethernet-network-diagnostics/export](../modules/behavior_definitions_ethernet_network_diagnostics_export.md).EthernetNetworkDiagnosticsBehavior

## Hierarchy

- [`EthernetNetworkDiagnosticsBehaviorType`](../modules/behavior_definitions_ethernet_network_diagnostics_export._internal_.md#ethernetnetworkdiagnosticsbehaviortype)
...
- [#agent](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md##agent)
- [[reference]](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#[reference])
- [agent](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#agent)
- [cluster](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#cluster)
- [context](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#context)
- [endpoint](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#endpoint)
- [events](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#events)
- [features](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#features)
- [session](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#session)
- [state](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#callback)
- [initialize](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#initialize)
- [reactTo](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_ethernet_network_diagnostics_export.EthernetNetworkDiagnosticsBehavior-1.md#tostring)
...
EthernetNetworkDiagnosticsBehaviorType.#agent
...
EthernetNetworkDiagnosticsBehaviorType.[reference]
...
EthernetNetworkDiagnosticsBehaviorType.cluster
...
EthernetNetworkDiagnosticsBehaviorType.context
...
EthernetNetworkDiagnosticsBehaviorType.endpoint
...
EthernetNetworkDiagnosticsBehaviorType.events
...
EthernetNetworkDiagnosticsBehaviorType.features
...
EthernetNetworkDiagnosticsBehaviorType.session
...
EthernetNetworkDiagnosticsBehaviorType.state
...
EthernetNetworkDiagnosticsBehaviorType.[asyncDispose]
...
EthernetNetworkDiagnosticsBehaviorType.asAdmin
...
EthernetNetworkDiagnosticsBehaviorType.assertAttributeEnabled
...
EthernetNetworkDiagnosticsBehaviorType.callback
...
EthernetNetworkDiagnosticsBehaviorType.initialize
...
EthernetNetworkDiagnosticsBehaviorType.reactTo
...
EthernetNetworkDiagnosticsBehaviorType.requireAttributeEnabled
...
EthernetNetworkDiagnosticsBehaviorType.toString
