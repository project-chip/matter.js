[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/on-off-switch-configuration/export](../modules/behavior_definitions_on_off_switch_configuration_export.md) / OnOffSwitchConfigurationBehavior

# Interface: OnOffSwitchConfigurationBehavior

[behavior/definitions/on-off-switch-configuration/export](../modules/behavior_definitions_on_off_switch_configuration_export.md).OnOffSwitchConfigurationBehavior

## Hierarchy

- [`OnOffSwitchConfigurationBehaviorType`](../modules/behavior_definitions_on_off_switch_configuration_export._internal_.md#onoffswitchconfigurationbehaviortype)
...
- [#agent](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md##agent)
- [[reference]](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#[reference])
- [agent](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#agent)
- [cluster](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#cluster)
- [context](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#context)
- [endpoint](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#endpoint)
- [events](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#events)
- [features](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#features)
- [session](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#session)
- [state](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#callback)
- [initialize](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#initialize)
- [reactTo](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_on_off_switch_configuration_export.OnOffSwitchConfigurationBehavior-1.md#tostring)
...
OnOffSwitchConfigurationBehaviorType.#agent
...
OnOffSwitchConfigurationBehaviorType.[reference]
...
OnOffSwitchConfigurationBehaviorType.cluster
...
OnOffSwitchConfigurationBehaviorType.context
...
OnOffSwitchConfigurationBehaviorType.endpoint
...
OnOffSwitchConfigurationBehaviorType.features
...
OnOffSwitchConfigurationBehaviorType.session
...
OnOffSwitchConfigurationBehaviorType.state
...
OnOffSwitchConfigurationBehaviorType.[asyncDispose]
...
OnOffSwitchConfigurationBehaviorType.asAdmin
...
OnOffSwitchConfigurationBehaviorType.assertAttributeEnabled
...
OnOffSwitchConfigurationBehaviorType.callback
...
OnOffSwitchConfigurationBehaviorType.initialize
...
OnOffSwitchConfigurationBehaviorType.reactTo
...
OnOffSwitchConfigurationBehaviorType.requireAttributeEnabled
...
OnOffSwitchConfigurationBehaviorType.toString
