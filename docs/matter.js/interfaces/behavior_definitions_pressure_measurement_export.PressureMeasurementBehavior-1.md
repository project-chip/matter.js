[@project-chip/matter.js](../README.md) / [Modules](../modules.md) / [behavior/definitions/pressure-measurement/export](../modules/behavior_definitions_pressure_measurement_export.md) / PressureMeasurementBehavior

# Interface: PressureMeasurementBehavior

[behavior/definitions/pressure-measurement/export](../modules/behavior_definitions_pressure_measurement_export.md).PressureMeasurementBehavior

## Hierarchy

- [`PressureMeasurementBehaviorType`](../modules/behavior_definitions_pressure_measurement_export._internal_.md#pressuremeasurementbehaviortype)
...
- [#agent](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md##agent)
- [[reference]](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#[reference])
- [agent](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#agent)
- [cluster](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#cluster)
- [context](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#context)
- [endpoint](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#endpoint)
- [events](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#events)
- [features](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#features)
- [session](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#session)
- [state](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#state)

### Methods

- [[asyncDispose]](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#[asyncdispose])
- [asAdmin](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#asadmin)
- [assertAttributeEnabled](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#assertattributeenabled)
- [callback](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#callback)
- [initialize](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#initialize)
- [reactTo](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#reactto)
- [requireAttributeEnabled](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#requireattributeenabled)
- [toString](behavior_definitions_pressure_measurement_export.PressureMeasurementBehavior-1.md#tostring)
...
PressureMeasurementBehaviorType.#agent
...
PressureMeasurementBehaviorType.[reference]
...
PressureMeasurementBehaviorType.cluster
...
PressureMeasurementBehaviorType.context
...
PressureMeasurementBehaviorType.endpoint
...
PressureMeasurementBehaviorType.events
...
PressureMeasurementBehaviorType.features
...
PressureMeasurementBehaviorType.session
...
PressureMeasurementBehaviorType.state
...
PressureMeasurementBehaviorType.[asyncDispose]
...
PressureMeasurementBehaviorType.asAdmin
...
PressureMeasurementBehaviorType.assertAttributeEnabled
...
PressureMeasurementBehaviorType.callback
...
PressureMeasurementBehaviorType.initialize
...
PressureMeasurementBehaviorType.reactTo
...
PressureMeasurementBehaviorType.requireAttributeEnabled
...
PressureMeasurementBehaviorType.toString
