...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/proxy-discovery/export](../README.md) / ProxyDiscoveryServer

# Class: ProxyDiscoveryServer

This is the default server implementation of [ProxyDiscoveryBehavior](../README.md#proxydiscoverybehavior).
...
### new ProxyDiscoveryServer()

> **new ProxyDiscoveryServer**(`agent`, `backing`): [`ProxyDiscoveryServer`](ProxyDiscoveryServer.md)
...
[`ProxyDiscoveryServer`](ProxyDiscoveryServer.md)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`#agent`](../interfaces/ProxyDiscoveryBehavior.md##agent)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`[reference]`](../interfaces/ProxyDiscoveryBehavior.md#%5Breference%5D)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`cluster`](../interfaces/ProxyDiscoveryBehavior.md#cluster)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`context`](../interfaces/ProxyDiscoveryBehavior.md#context)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`endpoint`](../interfaces/ProxyDiscoveryBehavior.md#endpoint)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`events`](../interfaces/ProxyDiscoveryBehavior.md#events)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`features`](../interfaces/ProxyDiscoveryBehavior.md#features)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`session`](../interfaces/ProxyDiscoveryBehavior.md#session)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`state`](../interfaces/ProxyDiscoveryBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/ProxyDiscovery/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`ProxyDiscoveryInterface`](../README.md#proxydiscoveryinterface)\>\>
...
> `static` `readonly` **Interface**: [`ProxyDiscoveryInterface`](../README.md#proxydiscoveryinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/ProxyDiscovery/interfaces/Cluster.md)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`[asyncDispose]`](../interfaces/ProxyDiscoveryBehavior.md#%5Basyncdispose%5D)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`asAdmin`](../interfaces/ProxyDiscoveryBehavior.md#asadmin)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`assertAttributeEnabled`](../interfaces/ProxyDiscoveryBehavior.md#assertattributeenabled)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`callback`](../interfaces/ProxyDiscoveryBehavior.md#callback)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`initialize`](../interfaces/ProxyDiscoveryBehavior.md#initialize)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`proxyDiscoverRequest`](../interfaces/ProxyDiscoveryBehavior.md#proxydiscoverrequest)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`reactTo`](../interfaces/ProxyDiscoveryBehavior.md#reactto)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`requireAttributeEnabled`](../interfaces/ProxyDiscoveryBehavior.md#requireattributeenabled)
...
[`ProxyDiscoveryBehavior`](../interfaces/ProxyDiscoveryBehavior.md).[`toString`](../interfaces/ProxyDiscoveryBehavior.md#tostring)
