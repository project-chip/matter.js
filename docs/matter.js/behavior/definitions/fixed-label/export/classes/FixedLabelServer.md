...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/fixed-label/export](../README.md) / FixedLabelServer

# Class: FixedLabelServer

This is the default server implementation of [FixedLabelBehavior](../README.md#fixedlabelbehavior).
...
### new FixedLabelServer()

> **new FixedLabelServer**(`agent`, `backing`): [`FixedLabelServer`](FixedLabelServer.md)
...
[`FixedLabelServer`](FixedLabelServer.md)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`#agent`](../interfaces/FixedLabelBehavior.md##agent)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`[reference]`](../interfaces/FixedLabelBehavior.md#%5Breference%5D)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`cluster`](../interfaces/FixedLabelBehavior.md#cluster)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`context`](../interfaces/FixedLabelBehavior.md#context)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`endpoint`](../interfaces/FixedLabelBehavior.md#endpoint)
...
> **labelList$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>[], `any`\>\>

#### Type declaration

##### labelList$Changed

> **labelList$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>[], `any`\>\>

#### Inherited from

[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`events`](../interfaces/FixedLabelBehavior.md#events)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`features`](../interfaces/FixedLabelBehavior.md#features)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`session`](../interfaces/FixedLabelBehavior.md#session)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`state`](../interfaces/FixedLabelBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/FixedLabel/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **State**: () => [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/FixedLabel/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>

#### Returns

[`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/FixedLabel/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/FixedLabel/interfaces/Cluster.md)
...
> `static` `readonly` **defaults**: [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/FixedLabel/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`[asyncDispose]`](../interfaces/FixedLabelBehavior.md#%5Basyncdispose%5D)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`asAdmin`](../interfaces/FixedLabelBehavior.md#asadmin)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`assertAttributeEnabled`](../interfaces/FixedLabelBehavior.md#assertattributeenabled)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`callback`](../interfaces/FixedLabelBehavior.md#callback)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`initialize`](../interfaces/FixedLabelBehavior.md#initialize)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`reactTo`](../interfaces/FixedLabelBehavior.md#reactto)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`requireAttributeEnabled`](../interfaces/FixedLabelBehavior.md#requireattributeenabled)
...
[`FixedLabelBehavior`](../interfaces/FixedLabelBehavior.md).[`toString`](../interfaces/FixedLabelBehavior.md#tostring)
