...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/proxy-configuration/export](../README.md) / ProxyConfigurationServer

# Class: ProxyConfigurationServer

This is the default server implementation of [ProxyConfigurationBehavior](../README.md#proxyconfigurationbehavior).
...
### new ProxyConfigurationServer()

> **new ProxyConfigurationServer**(`agent`, `backing`): [`ProxyConfigurationServer`](ProxyConfigurationServer.md)
...
[`ProxyConfigurationServer`](ProxyConfigurationServer.md)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`#agent`](../interfaces/ProxyConfigurationBehavior.md##agent)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`[reference]`](../interfaces/ProxyConfigurationBehavior.md#%5Breference%5D)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`cluster`](../interfaces/ProxyConfigurationBehavior.md#cluster)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`context`](../interfaces/ProxyConfigurationBehavior.md#context)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`endpoint`](../interfaces/ProxyConfigurationBehavior.md#endpoint)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`events`](../interfaces/ProxyConfigurationBehavior.md#events)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`features`](../interfaces/ProxyConfigurationBehavior.md#features)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`session`](../interfaces/ProxyConfigurationBehavior.md#session)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`state`](../interfaces/ProxyConfigurationBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/ProxyConfiguration/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **State**: () => [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/ProxyConfiguration/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>

#### Returns

[`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/ProxyConfiguration/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/ProxyConfiguration/interfaces/Cluster.md)
...
> `static` `readonly` **defaults**: [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/ProxyConfiguration/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`[asyncDispose]`](../interfaces/ProxyConfigurationBehavior.md#%5Basyncdispose%5D)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`asAdmin`](../interfaces/ProxyConfigurationBehavior.md#asadmin)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`assertAttributeEnabled`](../interfaces/ProxyConfigurationBehavior.md#assertattributeenabled)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`callback`](../interfaces/ProxyConfigurationBehavior.md#callback)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`initialize`](../interfaces/ProxyConfigurationBehavior.md#initialize)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`reactTo`](../interfaces/ProxyConfigurationBehavior.md#reactto)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`requireAttributeEnabled`](../interfaces/ProxyConfigurationBehavior.md#requireattributeenabled)
...
[`ProxyConfigurationBehavior`](../interfaces/ProxyConfigurationBehavior.md).[`toString`](../interfaces/ProxyConfigurationBehavior.md#tostring)
