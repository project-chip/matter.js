...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/keypad-input/export](../README.md) / KeypadInputServer

# Class: KeypadInputServer

This is the default server implementation of [KeypadInputBehavior](../README.md#keypadinputbehavior).
...
### new KeypadInputServer()

> **new KeypadInputServer**(`agent`, `backing`): [`KeypadInputServer`](KeypadInputServer.md)
...
[`KeypadInputServer`](KeypadInputServer.md)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`#agent`](../interfaces/KeypadInputBehavior.md##agent)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`[reference]`](../interfaces/KeypadInputBehavior.md#%5Breference%5D)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`cluster`](../interfaces/KeypadInputBehavior.md#cluster)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`context`](../interfaces/KeypadInputBehavior.md#context)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`endpoint`](../interfaces/KeypadInputBehavior.md#endpoint)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`events`](../interfaces/KeypadInputBehavior.md#events)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`features`](../interfaces/KeypadInputBehavior.md#features)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`session`](../interfaces/KeypadInputBehavior.md#session)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`state`](../interfaces/KeypadInputBehavior.md#state)
...
> `static` `readonly` **Interface**: [`KeypadInputInterface`](../README.md#keypadinputinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/KeypadInput/interfaces/Cluster.md)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`[asyncDispose]`](../interfaces/KeypadInputBehavior.md#%5Basyncdispose%5D)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`asAdmin`](../interfaces/KeypadInputBehavior.md#asadmin)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`assertAttributeEnabled`](../interfaces/KeypadInputBehavior.md#assertattributeenabled)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`callback`](../interfaces/KeypadInputBehavior.md#callback)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`initialize`](../interfaces/KeypadInputBehavior.md#initialize)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`reactTo`](../interfaces/KeypadInputBehavior.md#reactto)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`requireAttributeEnabled`](../interfaces/KeypadInputBehavior.md#requireattributeenabled)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`sendKey`](../interfaces/KeypadInputBehavior.md#sendkey)
...
[`KeypadInputBehavior`](../interfaces/KeypadInputBehavior.md).[`toString`](../interfaces/KeypadInputBehavior.md#tostring)
