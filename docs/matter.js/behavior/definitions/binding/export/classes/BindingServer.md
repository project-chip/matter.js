...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/binding/export](../README.md) / BindingServer

# Class: BindingServer

This is the default server implementation of [BindingBehavior](../README.md#bindingbehavior).
...
> **new BindingServer**(`agent`, `backing`): [`BindingServer`](BindingServer.md)
...
[`BindingServer`](BindingServer.md)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`#agent`](../interfaces/BindingBehavior.md##agent)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`[reference]`](../interfaces/BindingBehavior.md#%5Breference%5D)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`cluster`](../interfaces/BindingBehavior.md#cluster)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`context`](../interfaces/BindingBehavior.md#context)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`endpoint`](../interfaces/BindingBehavior.md#endpoint)
...
> **binding$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`WritableFabricScopedAttribute`](../../../../../cluster/export/interfaces/WritableFabricScopedAttribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>[], `any`\>\>

#### Type declaration

##### binding$Changed

> **binding$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`WritableFabricScopedAttribute`](../../../../../cluster/export/interfaces/WritableFabricScopedAttribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>[], `any`\>\>

#### Inherited from

[`BindingBehavior`](../interfaces/BindingBehavior.md).[`events`](../interfaces/BindingBehavior.md#events)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`features`](../interfaces/BindingBehavior.md#features)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`session`](../interfaces/BindingBehavior.md#session)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`state`](../interfaces/BindingBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/Binding/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **State**: () => [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/Binding/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>

#### Returns

[`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/Binding/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/Binding/interfaces/Cluster.md)
...
> `static` `readonly` **defaults**: [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/Binding/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`[asyncDispose]`](../interfaces/BindingBehavior.md#%5Basyncdispose%5D)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`asAdmin`](../interfaces/BindingBehavior.md#asadmin)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`assertAttributeEnabled`](../interfaces/BindingBehavior.md#assertattributeenabled)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`callback`](../interfaces/BindingBehavior.md#callback)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`initialize`](../interfaces/BindingBehavior.md#initialize)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`reactTo`](../interfaces/BindingBehavior.md#reactto)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`requireAttributeEnabled`](../interfaces/BindingBehavior.md#requireattributeenabled)
...
[`BindingBehavior`](../interfaces/BindingBehavior.md).[`toString`](../interfaces/BindingBehavior.md#tostring)
