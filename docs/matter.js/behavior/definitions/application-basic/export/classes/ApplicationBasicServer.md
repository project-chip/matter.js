...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/application-basic/export](../README.md) / ApplicationBasicServer

# Class: ApplicationBasicServer

This is the default server implementation of [ApplicationBasicBehavior](../README.md#applicationbasicbehavior).
...
### new ApplicationBasicServer()

> **new ApplicationBasicServer**(`agent`, `backing`): [`ApplicationBasicServer`](ApplicationBasicServer.md)
...
[`ApplicationBasicServer`](ApplicationBasicServer.md)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`#agent`](../interfaces/ApplicationBasicBehavior.md##agent)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`[reference]`](../interfaces/ApplicationBasicBehavior.md#%5Breference%5D)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`cluster`](../interfaces/ApplicationBasicBehavior.md#cluster)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`context`](../interfaces/ApplicationBasicBehavior.md#context)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`endpoint`](../interfaces/ApplicationBasicBehavior.md#endpoint)
...
##### allowedVendorList$Changing

> **allowedVendorList$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`FixedAttribute`](../../../../../cluster/export/interfaces/FixedAttribute.md)\<[`VendorId`](../../../../../datatype/export/README.md#vendorid)[], `any`\>\>

##### application$Changing

> **application$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`FixedAttribute`](../../../../../cluster/export/interfaces/FixedAttribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>, `any`\>\>

##### applicationName$Changing

> **applicationName$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`FixedAttribute`](../../../../../cluster/export/interfaces/FixedAttribute.md)\<`string`, `any`\>\>

##### applicationVersion$Changing

> **applicationVersion$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`FixedAttribute`](../../../../../cluster/export/interfaces/FixedAttribute.md)\<`string`, `any`\>\>

##### status$Changing

> **status$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<[`ApplicationStatus`](../../../../../cluster/export/namespaces/ApplicationBasic/enumerations/ApplicationStatus.md), `any`\>\>

#### Type declaration

##### productId$Changing

> **productId$Changing**: `undefined` \| [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`OptionalFixedAttribute`](../../../../../cluster/export/interfaces/OptionalFixedAttribute.md)\<`number`, `any`\>\>
...
##### allowedVendorList$Changed

> **allowedVendorList$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`FixedAttribute`](../../../../../cluster/export/interfaces/FixedAttribute.md)\<[`VendorId`](../../../../../datatype/export/README.md#vendorid)[], `any`\>\>

##### application$Changed

> **application$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`FixedAttribute`](../../../../../cluster/export/interfaces/FixedAttribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>, `any`\>\>

##### applicationName$Changed

> **applicationName$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`FixedAttribute`](../../../../../cluster/export/interfaces/FixedAttribute.md)\<`string`, `any`\>\>

##### applicationVersion$Changed

> **applicationVersion$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`FixedAttribute`](../../../../../cluster/export/interfaces/FixedAttribute.md)\<`string`, `any`\>\>

##### status$Changed

> **status$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<[`ApplicationStatus`](../../../../../cluster/export/namespaces/ApplicationBasic/enumerations/ApplicationStatus.md), `any`\>\>

#### Type declaration

##### productId$Changed

> **productId$Changed**: `undefined` \| [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`OptionalFixedAttribute`](../../../../../cluster/export/interfaces/OptionalFixedAttribute.md)\<`number`, `any`\>\>
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`events`](../interfaces/ApplicationBasicBehavior.md#events)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`features`](../interfaces/ApplicationBasicBehavior.md#features)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`session`](../interfaces/ApplicationBasicBehavior.md#session)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`state`](../interfaces/ApplicationBasicBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/ApplicationBasic/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **State**: () => [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/ApplicationBasic/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>

#### Returns

[`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/ApplicationBasic/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/ApplicationBasic/interfaces/Cluster.md)
...
> `static` `readonly` **defaults**: [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/ApplicationBasic/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`[asyncDispose]`](../interfaces/ApplicationBasicBehavior.md#%5Basyncdispose%5D)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`asAdmin`](../interfaces/ApplicationBasicBehavior.md#asadmin)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`assertAttributeEnabled`](../interfaces/ApplicationBasicBehavior.md#assertattributeenabled)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`callback`](../interfaces/ApplicationBasicBehavior.md#callback)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`initialize`](../interfaces/ApplicationBasicBehavior.md#initialize)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`reactTo`](../interfaces/ApplicationBasicBehavior.md#reactto)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`requireAttributeEnabled`](../interfaces/ApplicationBasicBehavior.md#requireattributeenabled)
...
[`ApplicationBasicBehavior`](../interfaces/ApplicationBasicBehavior.md).[`toString`](../interfaces/ApplicationBasicBehavior.md#tostring)
