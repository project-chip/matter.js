...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/media-input/export](../README.md) / MediaInputServer

# Class: MediaInputServer

This is the default server implementation of [MediaInputBehavior](../README.md#mediainputbehavior).
...
### new MediaInputServer()

> **new MediaInputServer**(`agent`, `backing`): [`MediaInputServer`](MediaInputServer.md)
...
[`MediaInputServer`](MediaInputServer.md)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`#agent`](../interfaces/MediaInputBehavior.md##agent)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`[reference]`](../interfaces/MediaInputBehavior.md#%5Breference%5D)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`cluster`](../interfaces/MediaInputBehavior.md#cluster)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`context`](../interfaces/MediaInputBehavior.md#context)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`endpoint`](../interfaces/MediaInputBehavior.md#endpoint)
...
##### currentInput$Changing

> **currentInput$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<`number`, `any`\>\>

##### inputList$Changing

> **inputList$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>[], `any`\>\>

#### Type declaration

##### currentInput$Changed

> **currentInput$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<`number`, `any`\>\>

##### inputList$Changed

> **inputList$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>[], `any`\>\>

#### Inherited from

[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`events`](../interfaces/MediaInputBehavior.md#events)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`features`](../interfaces/MediaInputBehavior.md#features)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`session`](../interfaces/MediaInputBehavior.md#session)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`state`](../interfaces/MediaInputBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/MediaInput/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`MediaInputInterface`](../README.md#mediainputinterface)\>\>
...
> `static` `readonly` **Interface**: [`MediaInputInterface`](../README.md#mediainputinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/MediaInput/interfaces/Cluster.md)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`[asyncDispose]`](../interfaces/MediaInputBehavior.md#%5Basyncdispose%5D)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`asAdmin`](../interfaces/MediaInputBehavior.md#asadmin)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`assertAttributeEnabled`](../interfaces/MediaInputBehavior.md#assertattributeenabled)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`callback`](../interfaces/MediaInputBehavior.md#callback)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`hideInputStatus`](../interfaces/MediaInputBehavior.md#hideinputstatus)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`initialize`](../interfaces/MediaInputBehavior.md#initialize)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`reactTo`](../interfaces/MediaInputBehavior.md#reactto)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`requireAttributeEnabled`](../interfaces/MediaInputBehavior.md#requireattributeenabled)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`selectInput`](../interfaces/MediaInputBehavior.md#selectinput)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`showInputStatus`](../interfaces/MediaInputBehavior.md#showinputstatus)
...
[`MediaInputBehavior`](../interfaces/MediaInputBehavior.md).[`toString`](../interfaces/MediaInputBehavior.md#tostring)
