...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/channel/export](../README.md) / ChannelServer

# Class: ChannelServer

This is the default server implementation of [ChannelBehavior](../README.md#channelbehavior).
...
> **new ChannelServer**(`agent`, `backing`): [`ChannelServer`](ChannelServer.md)
...
[`ChannelServer`](ChannelServer.md)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`#agent`](../interfaces/ChannelBehavior.md##agent)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`[reference]`](../interfaces/ChannelBehavior.md#%5Breference%5D)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`cluster`](../interfaces/ChannelBehavior.md#cluster)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`context`](../interfaces/ChannelBehavior.md#context)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`endpoint`](../interfaces/ChannelBehavior.md#endpoint)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`events`](../interfaces/ChannelBehavior.md#events)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`features`](../interfaces/ChannelBehavior.md#features)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`session`](../interfaces/ChannelBehavior.md#session)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`state`](../interfaces/ChannelBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/Channel/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`ChannelInterface`](../README.md#channelinterface)\>\>
...
> `static` `readonly` **Interface**: [`ChannelInterface`](../README.md#channelinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/Channel/interfaces/Cluster.md)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`[asyncDispose]`](../interfaces/ChannelBehavior.md#%5Basyncdispose%5D)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`asAdmin`](../interfaces/ChannelBehavior.md#asadmin)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`assertAttributeEnabled`](../interfaces/ChannelBehavior.md#assertattributeenabled)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`callback`](../interfaces/ChannelBehavior.md#callback)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`changeChannelByNumber`](../interfaces/ChannelBehavior.md#changechannelbynumber)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`initialize`](../interfaces/ChannelBehavior.md#initialize)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`reactTo`](../interfaces/ChannelBehavior.md#reactto)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`requireAttributeEnabled`](../interfaces/ChannelBehavior.md#requireattributeenabled)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`skipChannel`](../interfaces/ChannelBehavior.md#skipchannel)
...
[`ChannelBehavior`](../interfaces/ChannelBehavior.md).[`toString`](../interfaces/ChannelBehavior.md#tostring)
