...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/boolean-state/export](../README.md) / BooleanStateServer

# Class: BooleanStateServer

This is the default server implementation of [BooleanStateBehavior](../README.md#booleanstatebehavior).
...
### new BooleanStateServer()

> **new BooleanStateServer**(`agent`, `backing`): [`BooleanStateServer`](BooleanStateServer.md)
...
[`BooleanStateServer`](BooleanStateServer.md)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`#agent`](../interfaces/BooleanStateBehavior.md##agent)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`[reference]`](../interfaces/BooleanStateBehavior.md#%5Breference%5D)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`cluster`](../interfaces/BooleanStateBehavior.md#cluster)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`context`](../interfaces/BooleanStateBehavior.md#context)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`endpoint`](../interfaces/BooleanStateBehavior.md#endpoint)
...
> **stateValue$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<`boolean`, `any`\>\>

#### Type declaration

##### stateValue$Changed

> **stateValue$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<`boolean`, `any`\>\>

#### Type declaration

##### stateChange?

> `optional` **stateChange**: [`EventObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#eventobservablee)\<[`OptionalEvent`](../../../../../cluster/export/interfaces/OptionalEvent.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>, `any`\>\>
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`events`](../interfaces/BooleanStateBehavior.md#events)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`features`](../interfaces/BooleanStateBehavior.md#features)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`session`](../interfaces/BooleanStateBehavior.md#session)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`state`](../interfaces/BooleanStateBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/BooleanState/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **State**: () => [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/BooleanState/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>

#### Returns

[`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/BooleanState/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/BooleanState/interfaces/Cluster.md)
...
> `static` `readonly` **defaults**: [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/BooleanState/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `private` **#emitStateChange**(`stateValue`): `void`
...
[packages/matter.js/src/behavior/definitions/boolean-state/BooleanStateServer.ts:17](https://github.com/project-chip/matter.js/blob/7a8cbb56b87d4ccf34bec5a9a95ab40a1711324f/packages/matter.js/src/behavior/definitions/boolean-state/BooleanStateServer.ts#L17)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`[asyncDispose]`](../interfaces/BooleanStateBehavior.md#%5Basyncdispose%5D)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`asAdmin`](../interfaces/BooleanStateBehavior.md#asadmin)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`assertAttributeEnabled`](../interfaces/BooleanStateBehavior.md#assertattributeenabled)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`callback`](../interfaces/BooleanStateBehavior.md#callback)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`initialize`](../interfaces/BooleanStateBehavior.md#initialize)

#### Source

[packages/matter.js/src/behavior/definitions/boolean-state/BooleanStateServer.ts:13](https://github.com/project-chip/matter.js/blob/7a8cbb56b87d4ccf34bec5a9a95ab40a1711324f/packages/matter.js/src/behavior/definitions/boolean-state/BooleanStateServer.ts#L13)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`reactTo`](../interfaces/BooleanStateBehavior.md#reactto)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`requireAttributeEnabled`](../interfaces/BooleanStateBehavior.md#requireattributeenabled)
...
[`BooleanStateBehavior`](../interfaces/BooleanStateBehavior.md).[`toString`](../interfaces/BooleanStateBehavior.md#tostring)
