...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/content-launcher/export](../README.md) / ContentLauncherServer

# Class: ContentLauncherServer

This is the default server implementation of [ContentLauncherBehavior](../README.md#contentlauncherbehavior).
...
### new ContentLauncherServer()

> **new ContentLauncherServer**(`agent`, `backing`): [`ContentLauncherServer`](ContentLauncherServer.md)
...
[`ContentLauncherServer`](ContentLauncherServer.md)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`#agent`](../interfaces/ContentLauncherBehavior.md##agent)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`[reference]`](../interfaces/ContentLauncherBehavior.md#%5Breference%5D)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`cluster`](../interfaces/ContentLauncherBehavior.md#cluster)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`context`](../interfaces/ContentLauncherBehavior.md#context)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`endpoint`](../interfaces/ContentLauncherBehavior.md#endpoint)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`events`](../interfaces/ContentLauncherBehavior.md#events)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`features`](../interfaces/ContentLauncherBehavior.md#features)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`session`](../interfaces/ContentLauncherBehavior.md#session)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`state`](../interfaces/ContentLauncherBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/ContentLauncher/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`ContentLauncherInterface`](../README.md#contentlauncherinterface)\>\>
...
> `static` `readonly` **Interface**: [`ContentLauncherInterface`](../README.md#contentlauncherinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/ContentLauncher/interfaces/Cluster.md)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`[asyncDispose]`](../interfaces/ContentLauncherBehavior.md#%5Basyncdispose%5D)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`asAdmin`](../interfaces/ContentLauncherBehavior.md#asadmin)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`assertAttributeEnabled`](../interfaces/ContentLauncherBehavior.md#assertattributeenabled)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`callback`](../interfaces/ContentLauncherBehavior.md#callback)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`initialize`](../interfaces/ContentLauncherBehavior.md#initialize)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`reactTo`](../interfaces/ContentLauncherBehavior.md#reactto)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`requireAttributeEnabled`](../interfaces/ContentLauncherBehavior.md#requireattributeenabled)
...
[`ContentLauncherBehavior`](../interfaces/ContentLauncherBehavior.md).[`toString`](../interfaces/ContentLauncherBehavior.md#tostring)
