...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/fault-injection/export](../README.md) / FaultInjectionServer

# Class: FaultInjectionServer

This is the default server implementation of [FaultInjectionBehavior](../README.md#faultinjectionbehavior).
...
### new FaultInjectionServer()

> **new FaultInjectionServer**(`agent`, `backing`): [`FaultInjectionServer`](FaultInjectionServer.md)
...
[`FaultInjectionServer`](FaultInjectionServer.md)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`#agent`](../interfaces/FaultInjectionBehavior.md##agent)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`[reference]`](../interfaces/FaultInjectionBehavior.md#%5Breference%5D)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`cluster`](../interfaces/FaultInjectionBehavior.md#cluster)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`context`](../interfaces/FaultInjectionBehavior.md#context)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`endpoint`](../interfaces/FaultInjectionBehavior.md#endpoint)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`events`](../interfaces/FaultInjectionBehavior.md#events)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`features`](../interfaces/FaultInjectionBehavior.md#features)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`session`](../interfaces/FaultInjectionBehavior.md#session)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`state`](../interfaces/FaultInjectionBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/FaultInjection/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`FaultInjectionInterface`](../README.md#faultinjectioninterface)\>\>
...
> `static` `readonly` **Interface**: [`FaultInjectionInterface`](../README.md#faultinjectioninterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/FaultInjection/interfaces/Cluster.md)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`[asyncDispose]`](../interfaces/FaultInjectionBehavior.md#%5Basyncdispose%5D)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`asAdmin`](../interfaces/FaultInjectionBehavior.md#asadmin)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`assertAttributeEnabled`](../interfaces/FaultInjectionBehavior.md#assertattributeenabled)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`callback`](../interfaces/FaultInjectionBehavior.md#callback)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`failAtFault`](../interfaces/FaultInjectionBehavior.md#failatfault)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`failRandomlyAtFault`](../interfaces/FaultInjectionBehavior.md#failrandomlyatfault)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`initialize`](../interfaces/FaultInjectionBehavior.md#initialize)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`reactTo`](../interfaces/FaultInjectionBehavior.md#reactto)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`requireAttributeEnabled`](../interfaces/FaultInjectionBehavior.md#requireattributeenabled)
...
[`FaultInjectionBehavior`](../interfaces/FaultInjectionBehavior.md).[`toString`](../interfaces/FaultInjectionBehavior.md#tostring)
