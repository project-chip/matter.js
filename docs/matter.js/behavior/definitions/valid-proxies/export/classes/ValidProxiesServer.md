...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/valid-proxies/export](../README.md) / ValidProxiesServer

# Class: ValidProxiesServer

This is the default server implementation of [ValidProxiesBehavior](../README.md#validproxiesbehavior).
...
### new ValidProxiesServer()

> **new ValidProxiesServer**(`agent`, `backing`): [`ValidProxiesServer`](ValidProxiesServer.md)
...
[`ValidProxiesServer`](ValidProxiesServer.md)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`#agent`](../interfaces/ValidProxiesBehavior.md##agent)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`[reference]`](../interfaces/ValidProxiesBehavior.md#%5Breference%5D)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`cluster`](../interfaces/ValidProxiesBehavior.md#cluster)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`context`](../interfaces/ValidProxiesBehavior.md#context)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`endpoint`](../interfaces/ValidProxiesBehavior.md#endpoint)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`events`](../interfaces/ValidProxiesBehavior.md#events)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`features`](../interfaces/ValidProxiesBehavior.md#features)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`session`](../interfaces/ValidProxiesBehavior.md#session)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`state`](../interfaces/ValidProxiesBehavior.md#state)
...
> `static` `readonly` **Interface**: [`ValidProxiesInterface`](../README.md#validproxiesinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/ValidProxies/interfaces/Cluster.md)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`[asyncDispose]`](../interfaces/ValidProxiesBehavior.md#%5Basyncdispose%5D)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`asAdmin`](../interfaces/ValidProxiesBehavior.md#asadmin)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`assertAttributeEnabled`](../interfaces/ValidProxiesBehavior.md#assertattributeenabled)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`callback`](../interfaces/ValidProxiesBehavior.md#callback)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`getValidProxiesRequest`](../interfaces/ValidProxiesBehavior.md#getvalidproxiesrequest)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`initialize`](../interfaces/ValidProxiesBehavior.md#initialize)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`reactTo`](../interfaces/ValidProxiesBehavior.md#reactto)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`requireAttributeEnabled`](../interfaces/ValidProxiesBehavior.md#requireattributeenabled)
...
[`ValidProxiesBehavior`](../interfaces/ValidProxiesBehavior.md).[`toString`](../interfaces/ValidProxiesBehavior.md#tostring)
