...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/mode-select/export](../README.md) / ModeSelectServer

# Class: ModeSelectServer

## Extends

- [`ClusterBehavior`](../../../../cluster/export/classes/ClusterBehavior.md)\<`this`\> & `Omit`\<[`ModeSelectServerLogic`](ModeSelectServerLogic.md), `"state"` \| `"initialize"` \| *typeof* `asyncDispose` \| `"events"` \| `"cluster"` \| `"changeToMode"`\> & [`Base`](../namespaces/ModeSelectInterface/interfaces/Base.md) & `Omit`\<`object` & `object`, `"changeToMode"`\> & `object`

## Constructors

### new ModeSelectServer()

> **new ModeSelectServer**(`agent`, `backing`): [`ModeSelectServer`](ModeSelectServer.md)
...
[`ModeSelectServer`](ModeSelectServer.md)
...
> `readonly` **state**: `Omit`\<[`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`WithFeatures`](../../../../../cluster/export/namespaces/ClusterComposer/README.md#withfeaturesclustertfeaturest)\<[`Cluster`](../../../../../cluster/export/namespaces/ModeSelect/interfaces/Cluster.md), readonly [[`OnOff`](../../../../../cluster/export/namespaces/ModeSelect/enumerations/Feature.md#onoff)]\>, [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Cluster`](../../../../../cluster/export/namespaces/ModeSelect/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`ModeSelectInterface`](../README.md#modeselectinterface)\>, [`ModeSelectInterface`](../README.md#modeselectinterface)\>\>, `"description"` \| `"onMode"` \| `"standardNamespace"` \| `"supportedModes"` \| `"currentMode"` \| `"startUpMode"`\> & `object` & `object` & `object` & `object`
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ModeSelectServerLogic`](ModeSelectServerLogic.md)\>
...
> `static` `readonly` **State**: () => [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ModeSelectServerLogic`](ModeSelectServerLogic.md)\>

#### Returns

[`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ModeSelectServerLogic`](ModeSelectServerLogic.md)\>
...
> `readonly` **currentMode**: [`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<`number`, `any`\>
...
> `readonly` **description**: [`FixedAttribute`](../../../../../cluster/export/interfaces/FixedAttribute.md)\<`string`, `any`\>
...
> `readonly` **standardNamespace**: [`FixedAttribute`](../../../../../cluster/export/interfaces/FixedAttribute.md)\<`null` \| `number`, `any`\>
...
> `readonly` **startUpMode**: [`OptionalWritableAttribute`](../../../../../cluster/export/interfaces/OptionalWritableAttribute.md)\<`null` \| `number`, `any`\>
...
> `readonly` **supportedModes**: [`FixedAttribute`](../../../../../cluster/export/interfaces/FixedAttribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>[], `any`\>
...
> `readonly` **changeToMode**: [`Command`](../../../../../cluster/export/interfaces/Command.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>, `void`, `any`\>
...
> `static` `readonly` **defaults**: [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ModeSelectServerLogic`](ModeSelectServerLogic.md)\>
