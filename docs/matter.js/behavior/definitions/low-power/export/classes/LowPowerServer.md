...
This is the default server implementation of [LowPowerBehavior](../README.md#lowpowerbehavior).
...
> **new LowPowerServer**(`agent`, `backing`): [`LowPowerServer`](LowPowerServer.md)
...
[`LowPowerServer`](LowPowerServer.md)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`#agent`](../interfaces/LowPowerBehavior.md##agent)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`[reference]`](../interfaces/LowPowerBehavior.md#%5Breference%5D)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`cluster`](../interfaces/LowPowerBehavior.md#cluster)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`context`](../interfaces/LowPowerBehavior.md#context)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`endpoint`](../interfaces/LowPowerBehavior.md#endpoint)
...
> **events**: [`Events`](../namespaces/LowPowerServer/classes/Events.md)

Access the behavior's events.

#### Overrides

[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`events`](../interfaces/LowPowerBehavior.md#events)

#### Source

[packages/matter.js/src/behavior/definitions/low-power/LowPowerServer.ts:14](https://github.com/project-chip/matter.js/blob/7a8cbb56b87d4ccf34bec5a9a95ab40a1711324f/packages/matter.js/src/behavior/definitions/low-power/LowPowerServer.ts#L14)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`features`](../interfaces/LowPowerBehavior.md#features)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`session`](../interfaces/LowPowerBehavior.md#session)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`state`](../interfaces/LowPowerBehavior.md#state)
...
> `static` `readonly` **Interface**: [`LowPowerInterface`](../README.md#lowpowerinterface)
...
> `static` `readonly` **State**: () => [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/LowPower/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`LowPowerInterface`](../README.md#lowpowerinterface)\>\>
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/LowPower/interfaces/Cluster.md)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`[asyncDispose]`](../interfaces/LowPowerBehavior.md#%5Basyncdispose%5D)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`asAdmin`](../interfaces/LowPowerBehavior.md#asadmin)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`assertAttributeEnabled`](../interfaces/LowPowerBehavior.md#assertattributeenabled)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`callback`](../interfaces/LowPowerBehavior.md#callback)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`initialize`](../interfaces/LowPowerBehavior.md#initialize)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`reactTo`](../interfaces/LowPowerBehavior.md#reactto)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`requireAttributeEnabled`](../interfaces/LowPowerBehavior.md#requireattributeenabled)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`sleep`](../interfaces/LowPowerBehavior.md#sleep)
...
[packages/matter.js/src/behavior/definitions/low-power/LowPowerServer.ts:16](https://github.com/project-chip/matter.js/blob/7a8cbb56b87d4ccf34bec5a9a95ab40a1711324f/packages/matter.js/src/behavior/definitions/low-power/LowPowerServer.ts#L16)
...
[`LowPowerBehavior`](../interfaces/LowPowerBehavior.md).[`toString`](../interfaces/LowPowerBehavior.md#tostring)
