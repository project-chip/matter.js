...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/groups/export](../README.md) / GroupsServer

# Class: GroupsServer

This is the default server implementation of [GroupsBehavior](../README.md#groupsbehavior).
...
> **new GroupsServer**(`agent`, `backing`): [`GroupsServer`](GroupsServer.md)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`#agent`](../interfaces/GroupsBehavior.md##agent)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`[reference]`](../interfaces/GroupsBehavior.md#%5Breference%5D)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`cluster`](../interfaces/GroupsBehavior.md#cluster)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`context`](../interfaces/GroupsBehavior.md#context)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`endpoint`](../interfaces/GroupsBehavior.md#endpoint)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`events`](../interfaces/GroupsBehavior.md#events)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`features`](../interfaces/GroupsBehavior.md#features)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`session`](../interfaces/GroupsBehavior.md#session)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`state`](../interfaces/GroupsBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/Groups/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`GroupsInterface`](../README.md#groupsinterface)\>\>
...
> `static` `readonly` **Interface**: [`GroupsInterface`](../README.md#groupsinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/Groups/interfaces/Cluster.md)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`[asyncDispose]`](../interfaces/GroupsBehavior.md#%5Basyncdispose%5D)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`addGroup`](../interfaces/GroupsBehavior.md#addgroup)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`addGroupIfIdentifying`](../interfaces/GroupsBehavior.md#addgroupifidentifying)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`asAdmin`](../interfaces/GroupsBehavior.md#asadmin)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`assertAttributeEnabled`](../interfaces/GroupsBehavior.md#assertattributeenabled)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`callback`](../interfaces/GroupsBehavior.md#callback)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`getGroupMembership`](../interfaces/GroupsBehavior.md#getgroupmembership)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`initialize`](../interfaces/GroupsBehavior.md#initialize)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`reactTo`](../interfaces/GroupsBehavior.md#reactto)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`removeAllGroups`](../interfaces/GroupsBehavior.md#removeallgroups)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`removeGroup`](../interfaces/GroupsBehavior.md#removegroup)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`requireAttributeEnabled`](../interfaces/GroupsBehavior.md#requireattributeenabled)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`toString`](../interfaces/GroupsBehavior.md#tostring)
...
[`GroupsBehavior`](../interfaces/GroupsBehavior.md).[`viewGroup`](../interfaces/GroupsBehavior.md#viewgroup)
