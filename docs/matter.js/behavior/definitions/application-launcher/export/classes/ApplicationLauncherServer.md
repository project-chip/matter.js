...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/application-launcher/export](../README.md) / ApplicationLauncherServer

# Class: ApplicationLauncherServer

This is the default server implementation of [ApplicationLauncherBehavior](../README.md#applicationlauncherbehavior).
...
### new ApplicationLauncherServer()

> **new ApplicationLauncherServer**(`agent`, `backing`): [`ApplicationLauncherServer`](ApplicationLauncherServer.md)
...
[`ApplicationLauncherServer`](ApplicationLauncherServer.md)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`#agent`](../interfaces/ApplicationLauncherBehavior.md##agent)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`[reference]`](../interfaces/ApplicationLauncherBehavior.md#%5Breference%5D)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`cluster`](../interfaces/ApplicationLauncherBehavior.md#cluster)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`context`](../interfaces/ApplicationLauncherBehavior.md#context)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`endpoint`](../interfaces/ApplicationLauncherBehavior.md#endpoint)
...
> **currentApp$Changing**: `undefined` \| [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`OptionalAttribute`](../../../../../cluster/export/interfaces/OptionalAttribute.md)\<`null` \| [`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>, `any`\>\>

#### Type declaration

##### currentApp$Changed

> **currentApp$Changed**: `undefined` \| [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`OptionalAttribute`](../../../../../cluster/export/interfaces/OptionalAttribute.md)\<`null` \| [`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>, `any`\>\>

#### Inherited from

[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`events`](../interfaces/ApplicationLauncherBehavior.md#events)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`features`](../interfaces/ApplicationLauncherBehavior.md#features)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`session`](../interfaces/ApplicationLauncherBehavior.md#session)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`state`](../interfaces/ApplicationLauncherBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/ApplicationLauncher/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`ApplicationLauncherInterface`](../README.md#applicationlauncherinterface)\>\>
...
> `static` `readonly` **Interface**: [`ApplicationLauncherInterface`](../README.md#applicationlauncherinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/ApplicationLauncher/interfaces/Cluster.md)
...
`ApplicationLauncherBehavior.schema`
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`[asyncDispose]`](../interfaces/ApplicationLauncherBehavior.md#%5Basyncdispose%5D)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`asAdmin`](../interfaces/ApplicationLauncherBehavior.md#asadmin)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`assertAttributeEnabled`](../interfaces/ApplicationLauncherBehavior.md#assertattributeenabled)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`callback`](../interfaces/ApplicationLauncherBehavior.md#callback)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`hideApp`](../interfaces/ApplicationLauncherBehavior.md#hideapp)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`initialize`](../interfaces/ApplicationLauncherBehavior.md#initialize)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`launchApp`](../interfaces/ApplicationLauncherBehavior.md#launchapp)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`reactTo`](../interfaces/ApplicationLauncherBehavior.md#reactto)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`requireAttributeEnabled`](../interfaces/ApplicationLauncherBehavior.md#requireattributeenabled)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`stopApp`](../interfaces/ApplicationLauncherBehavior.md#stopapp)
...
[`ApplicationLauncherBehavior`](../interfaces/ApplicationLauncherBehavior.md).[`toString`](../interfaces/ApplicationLauncherBehavior.md#tostring)
