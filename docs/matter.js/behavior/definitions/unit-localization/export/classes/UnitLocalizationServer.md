...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/unit-localization/export](../README.md) / UnitLocalizationServer

# Class: UnitLocalizationServer

This is the default server implementation of [UnitLocalizationBehavior](../README.md#unitlocalizationbehavior).
...
### new UnitLocalizationServer()

> **new UnitLocalizationServer**(`agent`, `backing`): [`UnitLocalizationServer`](UnitLocalizationServer.md)
...
[`UnitLocalizationServer`](UnitLocalizationServer.md)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`#agent`](../interfaces/UnitLocalizationBehavior.md##agent)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`[reference]`](../interfaces/UnitLocalizationBehavior.md#%5Breference%5D)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`cluster`](../interfaces/UnitLocalizationBehavior.md#cluster)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`context`](../interfaces/UnitLocalizationBehavior.md#context)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`endpoint`](../interfaces/UnitLocalizationBehavior.md#endpoint)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`events`](../interfaces/UnitLocalizationBehavior.md#events)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`features`](../interfaces/UnitLocalizationBehavior.md#features)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`session`](../interfaces/UnitLocalizationBehavior.md#session)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`state`](../interfaces/UnitLocalizationBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/UnitLocalization/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **State**: () => [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/UnitLocalization/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>

#### Returns

[`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/UnitLocalization/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/UnitLocalization/interfaces/Cluster.md)
...
> `static` `readonly` **defaults**: [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/UnitLocalization/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`[asyncDispose]`](../interfaces/UnitLocalizationBehavior.md#%5Basyncdispose%5D)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`asAdmin`](../interfaces/UnitLocalizationBehavior.md#asadmin)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`assertAttributeEnabled`](../interfaces/UnitLocalizationBehavior.md#assertattributeenabled)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`callback`](../interfaces/UnitLocalizationBehavior.md#callback)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`initialize`](../interfaces/UnitLocalizationBehavior.md#initialize)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`reactTo`](../interfaces/UnitLocalizationBehavior.md#reactto)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`requireAttributeEnabled`](../interfaces/UnitLocalizationBehavior.md#requireattributeenabled)
...
[`UnitLocalizationBehavior`](../interfaces/UnitLocalizationBehavior.md).[`toString`](../interfaces/UnitLocalizationBehavior.md#tostring)
