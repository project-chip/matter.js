...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/ota-software-update-provider/export](../README.md) / OtaSoftwareUpdateProviderServer

# Class: OtaSoftwareUpdateProviderServer

This is the default server implementation of [OtaSoftwareUpdateProviderBehavior](../README.md#otasoftwareupdateproviderbehavior).
...
### new OtaSoftwareUpdateProviderServer()

> **new OtaSoftwareUpdateProviderServer**(`agent`, `backing`): [`OtaSoftwareUpdateProviderServer`](OtaSoftwareUpdateProviderServer.md)
...
[`OtaSoftwareUpdateProviderServer`](OtaSoftwareUpdateProviderServer.md)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`#agent`](../interfaces/OtaSoftwareUpdateProviderBehavior.md##agent)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`[reference]`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#%5Breference%5D)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`cluster`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#cluster)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`context`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#context)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`endpoint`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#endpoint)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`events`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#events)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`features`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#features)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`session`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#session)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`state`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/OtaSoftwareUpdateProvider/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`OtaSoftwareUpdateProviderInterface`](../README.md#otasoftwareupdateproviderinterface)\>\>
...
> `static` `readonly` **Interface**: [`OtaSoftwareUpdateProviderInterface`](../README.md#otasoftwareupdateproviderinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/OtaSoftwareUpdateProvider/interfaces/Cluster.md)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`[asyncDispose]`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#%5Basyncdispose%5D)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`applyUpdateRequest`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#applyupdaterequest)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`asAdmin`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#asadmin)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`assertAttributeEnabled`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#assertattributeenabled)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`callback`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#callback)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`initialize`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#initialize)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`notifyUpdateApplied`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#notifyupdateapplied)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`queryImage`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#queryimage)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`reactTo`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#reactto)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`requireAttributeEnabled`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#requireattributeenabled)
...
[`OtaSoftwareUpdateProviderBehavior`](../interfaces/OtaSoftwareUpdateProviderBehavior.md).[`toString`](../interfaces/OtaSoftwareUpdateProviderBehavior.md#tostring)
