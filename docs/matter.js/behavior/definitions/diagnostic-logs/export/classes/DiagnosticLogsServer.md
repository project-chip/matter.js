...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/diagnostic-logs/export](../README.md) / DiagnosticLogsServer

# Class: DiagnosticLogsServer

This is the default server implementation of [DiagnosticLogsBehavior](../README.md#diagnosticlogsbehavior).
...
### new DiagnosticLogsServer()

> **new DiagnosticLogsServer**(`agent`, `backing`): [`DiagnosticLogsServer`](DiagnosticLogsServer.md)
...
[`DiagnosticLogsServer`](DiagnosticLogsServer.md)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`#agent`](../interfaces/DiagnosticLogsBehavior.md##agent)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`[reference]`](../interfaces/DiagnosticLogsBehavior.md#%5Breference%5D)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`cluster`](../interfaces/DiagnosticLogsBehavior.md#cluster)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`context`](../interfaces/DiagnosticLogsBehavior.md#context)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`endpoint`](../interfaces/DiagnosticLogsBehavior.md#endpoint)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`events`](../interfaces/DiagnosticLogsBehavior.md#events)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`features`](../interfaces/DiagnosticLogsBehavior.md#features)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`session`](../interfaces/DiagnosticLogsBehavior.md#session)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`state`](../interfaces/DiagnosticLogsBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/DiagnosticLogs/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`DiagnosticLogsInterface`](../README.md#diagnosticlogsinterface)\>\>
...
`DiagnosticLogsBehavior.ExtensionInterface`
...
> `static` `readonly` **Interface**: [`DiagnosticLogsInterface`](../README.md#diagnosticlogsinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/DiagnosticLogs/interfaces/Cluster.md)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`[asyncDispose]`](../interfaces/DiagnosticLogsBehavior.md#%5Basyncdispose%5D)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`asAdmin`](../interfaces/DiagnosticLogsBehavior.md#asadmin)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`assertAttributeEnabled`](../interfaces/DiagnosticLogsBehavior.md#assertattributeenabled)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`callback`](../interfaces/DiagnosticLogsBehavior.md#callback)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`initialize`](../interfaces/DiagnosticLogsBehavior.md#initialize)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`reactTo`](../interfaces/DiagnosticLogsBehavior.md#reactto)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`requireAttributeEnabled`](../interfaces/DiagnosticLogsBehavior.md#requireattributeenabled)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`retrieveLogsRequest`](../interfaces/DiagnosticLogsBehavior.md#retrievelogsrequest)
...
[`DiagnosticLogsBehavior`](../interfaces/DiagnosticLogsBehavior.md).[`toString`](../interfaces/DiagnosticLogsBehavior.md#tostring)
