...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/audio-output/export](../README.md) / AudioOutputServer

# Class: AudioOutputServer

This is the default server implementation of [AudioOutputBehavior](../README.md#audiooutputbehavior).
...
### new AudioOutputServer()

> **new AudioOutputServer**(`agent`, `backing`): [`AudioOutputServer`](AudioOutputServer.md)
...
[`AudioOutputServer`](AudioOutputServer.md)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`#agent`](../interfaces/AudioOutputBehavior.md##agent)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`[reference]`](../interfaces/AudioOutputBehavior.md#%5Breference%5D)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`cluster`](../interfaces/AudioOutputBehavior.md#cluster)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`context`](../interfaces/AudioOutputBehavior.md#context)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`endpoint`](../interfaces/AudioOutputBehavior.md#endpoint)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`events`](../interfaces/AudioOutputBehavior.md#events)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`features`](../interfaces/AudioOutputBehavior.md#features)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`session`](../interfaces/AudioOutputBehavior.md#session)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`state`](../interfaces/AudioOutputBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/AudioOutput/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`AudioOutputInterface`](../README.md#audiooutputinterface)\>\>
...
> `static` `readonly` **Interface**: [`AudioOutputInterface`](../README.md#audiooutputinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/AudioOutput/interfaces/Cluster.md)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`[asyncDispose]`](../interfaces/AudioOutputBehavior.md#%5Basyncdispose%5D)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`asAdmin`](../interfaces/AudioOutputBehavior.md#asadmin)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`assertAttributeEnabled`](../interfaces/AudioOutputBehavior.md#assertattributeenabled)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`callback`](../interfaces/AudioOutputBehavior.md#callback)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`initialize`](../interfaces/AudioOutputBehavior.md#initialize)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`reactTo`](../interfaces/AudioOutputBehavior.md#reactto)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`requireAttributeEnabled`](../interfaces/AudioOutputBehavior.md#requireattributeenabled)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`selectOutput`](../interfaces/AudioOutputBehavior.md#selectoutput)
...
[`AudioOutputBehavior`](../interfaces/AudioOutputBehavior.md).[`toString`](../interfaces/AudioOutputBehavior.md#tostring)
