...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/fan-control/export](../README.md) / FanControlServer

# Class: FanControlServer

This is the default server implementation of [FanControlBehavior](../README.md#fancontrolbehavior).
...
### new FanControlServer()

> **new FanControlServer**(`agent`, `backing`): [`FanControlServer`](FanControlServer.md)
...
[`FanControlServer`](FanControlServer.md)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`#agent`](../interfaces/FanControlBehavior.md##agent)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`[reference]`](../interfaces/FanControlBehavior.md#%5Breference%5D)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`cluster`](../interfaces/FanControlBehavior.md#cluster)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`context`](../interfaces/FanControlBehavior.md#context)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`endpoint`](../interfaces/FanControlBehavior.md#endpoint)
...
> **fanMode$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`WritableAttribute`](../../../../../cluster/export/interfaces/WritableAttribute.md)\<[`FanMode`](../../../../../cluster/export/namespaces/FanControl/enumerations/FanMode.md), `any`\>\>

##### fanModeSequence$Changing

> **fanModeSequence$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`WritableAttribute`](../../../../../cluster/export/interfaces/WritableAttribute.md)\<[`FanModeSequence`](../../../../../cluster/export/namespaces/FanControl/enumerations/FanModeSequence.md), `any`\>\>

##### percentCurrent$Changing

> **percentCurrent$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<`number`, `any`\>\>

##### percentSetting$Changing

> **percentSetting$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`WritableAttribute`](../../../../../cluster/export/interfaces/WritableAttribute.md)\<`null` \| `number`, `any`\>\>

#### Type declaration

##### fanMode$Changed

> **fanMode$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`WritableAttribute`](../../../../../cluster/export/interfaces/WritableAttribute.md)\<[`FanMode`](../../../../../cluster/export/namespaces/FanControl/enumerations/FanMode.md), `any`\>\>

##### fanModeSequence$Changed

> **fanModeSequence$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`WritableAttribute`](../../../../../cluster/export/interfaces/WritableAttribute.md)\<[`FanModeSequence`](../../../../../cluster/export/namespaces/FanControl/enumerations/FanModeSequence.md), `any`\>\>

##### percentCurrent$Changed

> **percentCurrent$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<`number`, `any`\>\>

##### percentSetting$Changed

> **percentSetting$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`WritableAttribute`](../../../../../cluster/export/interfaces/WritableAttribute.md)\<`null` \| `number`, `any`\>\>

#### Inherited from

[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`events`](../interfaces/FanControlBehavior.md#events)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`features`](../interfaces/FanControlBehavior.md#features)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`session`](../interfaces/FanControlBehavior.md#session)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`state`](../interfaces/FanControlBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/FanControl/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **State**: () => [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/FanControl/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>

#### Returns

[`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/FanControl/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/FanControl/interfaces/Cluster.md)
...
> `static` `readonly` **defaults**: [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/FanControl/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`[asyncDispose]`](../interfaces/FanControlBehavior.md#%5Basyncdispose%5D)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`asAdmin`](../interfaces/FanControlBehavior.md#asadmin)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`assertAttributeEnabled`](../interfaces/FanControlBehavior.md#assertattributeenabled)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`callback`](../interfaces/FanControlBehavior.md#callback)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`initialize`](../interfaces/FanControlBehavior.md#initialize)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`reactTo`](../interfaces/FanControlBehavior.md#reactto)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`requireAttributeEnabled`](../interfaces/FanControlBehavior.md#requireattributeenabled)
...
[`FanControlBehavior`](../interfaces/FanControlBehavior.md).[`toString`](../interfaces/FanControlBehavior.md#tostring)
