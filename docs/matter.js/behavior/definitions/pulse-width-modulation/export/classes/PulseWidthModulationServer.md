...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/pulse-width-modulation/export](../README.md) / PulseWidthModulationServer

# Class: PulseWidthModulationServer

This is the default server implementation of [PulseWidthModulationBehavior](../README.md#pulsewidthmodulationbehavior).
...
### new PulseWidthModulationServer()

> **new PulseWidthModulationServer**(`agent`, `backing`): [`PulseWidthModulationServer`](PulseWidthModulationServer.md)
...
[`PulseWidthModulationServer`](PulseWidthModulationServer.md)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`#agent`](../interfaces/PulseWidthModulationBehavior.md##agent)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`[reference]`](../interfaces/PulseWidthModulationBehavior.md#%5Breference%5D)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`cluster`](../interfaces/PulseWidthModulationBehavior.md#cluster)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`context`](../interfaces/PulseWidthModulationBehavior.md#context)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`endpoint`](../interfaces/PulseWidthModulationBehavior.md#endpoint)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`events`](../interfaces/PulseWidthModulationBehavior.md#events)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`features`](../interfaces/PulseWidthModulationBehavior.md#features)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`session`](../interfaces/PulseWidthModulationBehavior.md#session)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`state`](../interfaces/PulseWidthModulationBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/PulseWidthModulation/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`PulseWidthModulationInterface`](../README.md#pulsewidthmodulationinterface)\>\>
...
> `static` `readonly` **Interface**: [`PulseWidthModulationInterface`](../README.md#pulsewidthmodulationinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/PulseWidthModulation/interfaces/Cluster.md)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`[asyncDispose]`](../interfaces/PulseWidthModulationBehavior.md#%5Basyncdispose%5D)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`asAdmin`](../interfaces/PulseWidthModulationBehavior.md#asadmin)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`assertAttributeEnabled`](../interfaces/PulseWidthModulationBehavior.md#assertattributeenabled)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`callback`](../interfaces/PulseWidthModulationBehavior.md#callback)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`initialize`](../interfaces/PulseWidthModulationBehavior.md#initialize)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`move`](../interfaces/PulseWidthModulationBehavior.md#move)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`moveToLevel`](../interfaces/PulseWidthModulationBehavior.md#movetolevel)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`moveToLevelWithOnOff`](../interfaces/PulseWidthModulationBehavior.md#movetolevelwithonoff)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`moveWithOnOff`](../interfaces/PulseWidthModulationBehavior.md#movewithonoff)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`reactTo`](../interfaces/PulseWidthModulationBehavior.md#reactto)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`requireAttributeEnabled`](../interfaces/PulseWidthModulationBehavior.md#requireattributeenabled)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`step`](../interfaces/PulseWidthModulationBehavior.md#step)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`stepWithOnOff`](../interfaces/PulseWidthModulationBehavior.md#stepwithonoff)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`stop`](../interfaces/PulseWidthModulationBehavior.md#stop)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`stopWithOnOff`](../interfaces/PulseWidthModulationBehavior.md#stopwithonoff)
...
[`PulseWidthModulationBehavior`](../interfaces/PulseWidthModulationBehavior.md).[`toString`](../interfaces/PulseWidthModulationBehavior.md#tostring)
