...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/soil-moisture-measurement/export](../README.md) / SoilMoistureMeasurementServer

# Class: SoilMoistureMeasurementServer

This is the default server implementation of [SoilMoistureMeasurementBehavior](../README.md#soilmoisturemeasurementbehavior).
...
### new SoilMoistureMeasurementServer()

> **new SoilMoistureMeasurementServer**(`agent`, `backing`): [`SoilMoistureMeasurementServer`](SoilMoistureMeasurementServer.md)
...
[`SoilMoistureMeasurementServer`](SoilMoistureMeasurementServer.md)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`#agent`](../interfaces/SoilMoistureMeasurementBehavior.md##agent)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`[reference]`](../interfaces/SoilMoistureMeasurementBehavior.md#%5Breference%5D)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`cluster`](../interfaces/SoilMoistureMeasurementBehavior.md#cluster)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`context`](../interfaces/SoilMoistureMeasurementBehavior.md#context)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`endpoint`](../interfaces/SoilMoistureMeasurementBehavior.md#endpoint)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`events`](../interfaces/SoilMoistureMeasurementBehavior.md#events)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`features`](../interfaces/SoilMoistureMeasurementBehavior.md#features)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`session`](../interfaces/SoilMoistureMeasurementBehavior.md#session)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`state`](../interfaces/SoilMoistureMeasurementBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/SoilMoistureMeasurement/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **State**: () => [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/SoilMoistureMeasurement/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>

#### Returns

[`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/SoilMoistureMeasurement/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/SoilMoistureMeasurement/interfaces/Cluster.md)
...
> `static` `readonly` **defaults**: [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/SoilMoistureMeasurement/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`[asyncDispose]`](../interfaces/SoilMoistureMeasurementBehavior.md#%5Basyncdispose%5D)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`asAdmin`](../interfaces/SoilMoistureMeasurementBehavior.md#asadmin)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`assertAttributeEnabled`](../interfaces/SoilMoistureMeasurementBehavior.md#assertattributeenabled)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`callback`](../interfaces/SoilMoistureMeasurementBehavior.md#callback)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`initialize`](../interfaces/SoilMoistureMeasurementBehavior.md#initialize)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`reactTo`](../interfaces/SoilMoistureMeasurementBehavior.md#reactto)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`requireAttributeEnabled`](../interfaces/SoilMoistureMeasurementBehavior.md#requireattributeenabled)
...
[`SoilMoistureMeasurementBehavior`](../interfaces/SoilMoistureMeasurementBehavior.md).[`toString`](../interfaces/SoilMoistureMeasurementBehavior.md#tostring)
