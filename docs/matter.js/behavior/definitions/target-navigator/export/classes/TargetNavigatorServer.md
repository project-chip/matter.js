...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/target-navigator/export](../README.md) / TargetNavigatorServer

# Class: TargetNavigatorServer

This is the default server implementation of [TargetNavigatorBehavior](../README.md#targetnavigatorbehavior).
...
### new TargetNavigatorServer()

> **new TargetNavigatorServer**(`agent`, `backing`): [`TargetNavigatorServer`](TargetNavigatorServer.md)
...
[`TargetNavigatorServer`](TargetNavigatorServer.md)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`#agent`](../interfaces/TargetNavigatorBehavior.md##agent)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`[reference]`](../interfaces/TargetNavigatorBehavior.md#%5Breference%5D)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`cluster`](../interfaces/TargetNavigatorBehavior.md#cluster)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`context`](../interfaces/TargetNavigatorBehavior.md#context)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`endpoint`](../interfaces/TargetNavigatorBehavior.md#endpoint)
...
> **targetList$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>[], `any`\>\>

#### Type declaration

##### currentTarget$Changing

> **currentTarget$Changing**: `undefined` \| [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`OptionalAttribute`](../../../../../cluster/export/interfaces/OptionalAttribute.md)\<`null` \| `number`, `any`\>\>

#### Type declaration

##### targetList$Changed

> **targetList$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`Attribute`](../../../../../cluster/export/interfaces/Attribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>[], `any`\>\>

#### Type declaration

##### currentTarget$Changed

> **currentTarget$Changed**: `undefined` \| [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`OptionalAttribute`](../../../../../cluster/export/interfaces/OptionalAttribute.md)\<`null` \| `number`, `any`\>\>

#### Inherited from

[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`events`](../interfaces/TargetNavigatorBehavior.md#events)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`features`](../interfaces/TargetNavigatorBehavior.md#features)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`session`](../interfaces/TargetNavigatorBehavior.md#session)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`state`](../interfaces/TargetNavigatorBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/TargetNavigator/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`TargetNavigatorInterface`](../README.md#targetnavigatorinterface)\>\>
...
> `static` `readonly` **Interface**: [`TargetNavigatorInterface`](../README.md#targetnavigatorinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/TargetNavigator/interfaces/Cluster.md)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`[asyncDispose]`](../interfaces/TargetNavigatorBehavior.md#%5Basyncdispose%5D)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`asAdmin`](../interfaces/TargetNavigatorBehavior.md#asadmin)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`assertAttributeEnabled`](../interfaces/TargetNavigatorBehavior.md#assertattributeenabled)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`callback`](../interfaces/TargetNavigatorBehavior.md#callback)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`initialize`](../interfaces/TargetNavigatorBehavior.md#initialize)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`navigateTarget`](../interfaces/TargetNavigatorBehavior.md#navigatetarget)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`reactTo`](../interfaces/TargetNavigatorBehavior.md#reactto)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`requireAttributeEnabled`](../interfaces/TargetNavigatorBehavior.md#requireattributeenabled)
...
[`TargetNavigatorBehavior`](../interfaces/TargetNavigatorBehavior.md).[`toString`](../interfaces/TargetNavigatorBehavior.md#tostring)
