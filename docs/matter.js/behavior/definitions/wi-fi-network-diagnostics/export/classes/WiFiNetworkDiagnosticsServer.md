...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/wi-fi-network-diagnostics/export](../README.md) / WiFiNetworkDiagnosticsServer

# Class: WiFiNetworkDiagnosticsServer

This is the default server implementation of [WiFiNetworkDiagnosticsBehavior](../README.md#wifinetworkdiagnosticsbehavior).
...
### new WiFiNetworkDiagnosticsServer()

> **new WiFiNetworkDiagnosticsServer**(`agent`, `backing`): [`WiFiNetworkDiagnosticsServer`](WiFiNetworkDiagnosticsServer.md)
...
[`WiFiNetworkDiagnosticsServer`](WiFiNetworkDiagnosticsServer.md)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`#agent`](../interfaces/WiFiNetworkDiagnosticsBehavior.md##agent)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`[reference]`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#%5Breference%5D)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`cluster`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#cluster)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`context`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#context)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`endpoint`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#endpoint)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`events`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#events)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`features`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#features)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`session`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#session)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`state`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/WiFiNetworkDiagnostics/interfaces/Cluster.md), [`Type`](../../../../cluster/export/namespaces/ClusterBehavior/interfaces/Type.md)\<[`Of`](../../../../../cluster/export/namespaces/ClusterType/interfaces/Of.md)\<`object`\>, *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md), [`WiFiNetworkDiagnosticsInterface`](../README.md#wifinetworkdiagnosticsinterface)\>\>
...
> `static` `readonly` **Interface**: [`WiFiNetworkDiagnosticsInterface`](../README.md#wifinetworkdiagnosticsinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/WiFiNetworkDiagnostics/interfaces/Cluster.md)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`[asyncDispose]`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#%5Basyncdispose%5D)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`asAdmin`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#asadmin)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`assertAttributeEnabled`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#assertattributeenabled)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`callback`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#callback)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`initialize`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#initialize)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`reactTo`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#reactto)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`requireAttributeEnabled`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#requireattributeenabled)
...
[`WiFiNetworkDiagnosticsBehavior`](../interfaces/WiFiNetworkDiagnosticsBehavior.md).[`toString`](../interfaces/WiFiNetworkDiagnosticsBehavior.md#tostring)
