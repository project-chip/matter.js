...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/user-label/export](../README.md) / UserLabelServer

# Class: UserLabelServer

This is the default server implementation of [UserLabelBehavior](../README.md#userlabelbehavior).
...
> **new UserLabelServer**(`agent`, `backing`): [`UserLabelServer`](UserLabelServer.md)
...
[`UserLabelServer`](UserLabelServer.md)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`#agent`](../interfaces/UserLabelBehavior.md##agent)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`[reference]`](../interfaces/UserLabelBehavior.md#%5Breference%5D)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`cluster`](../interfaces/UserLabelBehavior.md#cluster)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`context`](../interfaces/UserLabelBehavior.md#context)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`endpoint`](../interfaces/UserLabelBehavior.md#endpoint)
...
> **labelList$Changing**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`WritableAttribute`](../../../../../cluster/export/interfaces/WritableAttribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>[], `any`\>\>

#### Type declaration

##### labelList$Changed

> **labelList$Changed**: [`AttributeObservable`](../../../../cluster/export/namespaces/ClusterEvents/README.md#attributeobservablea)\<[`WritableAttribute`](../../../../../cluster/export/interfaces/WritableAttribute.md)\<[`TypeFromFields`](../../../../../tlv/export/README.md#typefromfieldsf)\<`object`\>[], `any`\>\>

#### Inherited from

[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`events`](../interfaces/UserLabelBehavior.md#events)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`features`](../interfaces/UserLabelBehavior.md#features)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`session`](../interfaces/UserLabelBehavior.md#session)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`state`](../interfaces/UserLabelBehavior.md#state)
...
> `static` `readonly` **Events**: [`Type`](../../../../cluster/export/namespaces/ClusterEvents/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/UserLabel/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **State**: () => [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/UserLabel/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>

#### Returns

[`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/UserLabel/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/UserLabel/interfaces/Cluster.md)
...
> `static` `readonly` **defaults**: [`Type`](../../../../cluster/export/namespaces/ClusterState/README.md#typecb)\<[`Cluster`](../../../../../cluster/export/namespaces/UserLabel/interfaces/Cluster.md), *typeof* [`ClusterBehavior`](../../../../cluster/export/namespaces/ClusterBehavior/README.md)\>
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`[asyncDispose]`](../interfaces/UserLabelBehavior.md#%5Basyncdispose%5D)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`asAdmin`](../interfaces/UserLabelBehavior.md#asadmin)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`assertAttributeEnabled`](../interfaces/UserLabelBehavior.md#assertattributeenabled)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`callback`](../interfaces/UserLabelBehavior.md#callback)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`initialize`](../interfaces/UserLabelBehavior.md#initialize)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`reactTo`](../interfaces/UserLabelBehavior.md#reactto)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`requireAttributeEnabled`](../interfaces/UserLabelBehavior.md#requireattributeenabled)
...
[`UserLabelBehavior`](../interfaces/UserLabelBehavior.md).[`toString`](../interfaces/UserLabelBehavior.md#tostring)
