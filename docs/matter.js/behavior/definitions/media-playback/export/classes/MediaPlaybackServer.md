...
[@project-chip/matter.js](../../../../../modules.md) / [behavior/definitions/media-playback/export](../README.md) / MediaPlaybackServer

# Class: MediaPlaybackServer

This is the default server implementation of [MediaPlaybackBehavior](../README.md#mediaplaybackbehavior).
...
### new MediaPlaybackServer()

> **new MediaPlaybackServer**(`agent`, `backing`): [`MediaPlaybackServer`](MediaPlaybackServer.md)
...
[`MediaPlaybackServer`](MediaPlaybackServer.md)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`#agent`](../interfaces/MediaPlaybackBehavior.md##agent)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`[reference]`](../interfaces/MediaPlaybackBehavior.md#%5Breference%5D)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`cluster`](../interfaces/MediaPlaybackBehavior.md#cluster)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`context`](../interfaces/MediaPlaybackBehavior.md#context)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`endpoint`](../interfaces/MediaPlaybackBehavior.md#endpoint)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`events`](../interfaces/MediaPlaybackBehavior.md#events)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`features`](../interfaces/MediaPlaybackBehavior.md#features)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`session`](../interfaces/MediaPlaybackBehavior.md#session)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`state`](../interfaces/MediaPlaybackBehavior.md#state)
...
`MediaPlaybackBehavior.ExtensionInterface`
...
> `static` `readonly` **Interface**: [`MediaPlaybackInterface`](../README.md#mediaplaybackinterface)
...
> `static` `readonly` **cluster**: [`Cluster`](../../../../../cluster/export/namespaces/MediaPlayback/interfaces/Cluster.md)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`[asyncDispose]`](../interfaces/MediaPlaybackBehavior.md#%5Basyncdispose%5D)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`asAdmin`](../interfaces/MediaPlaybackBehavior.md#asadmin)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`assertAttributeEnabled`](../interfaces/MediaPlaybackBehavior.md#assertattributeenabled)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`callback`](../interfaces/MediaPlaybackBehavior.md#callback)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`initialize`](../interfaces/MediaPlaybackBehavior.md#initialize)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`next`](../interfaces/MediaPlaybackBehavior.md#next)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`pause`](../interfaces/MediaPlaybackBehavior.md#pause)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`play`](../interfaces/MediaPlaybackBehavior.md#play)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`previous`](../interfaces/MediaPlaybackBehavior.md#previous)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`reactTo`](../interfaces/MediaPlaybackBehavior.md#reactto)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`requireAttributeEnabled`](../interfaces/MediaPlaybackBehavior.md#requireattributeenabled)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`skipBackward`](../interfaces/MediaPlaybackBehavior.md#skipbackward)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`skipForward`](../interfaces/MediaPlaybackBehavior.md#skipforward)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`startOver`](../interfaces/MediaPlaybackBehavior.md#startover)
...
[packages/matter.js/src/behavior/definitions/media-playback/MediaPlaybackInterface.ts:71](https://github.com/project-chip/matter.js/blob/7a8cbb56b87d4ccf34bec5a9a95ab40a1711324f/packages/matter.js/src/behavior/definitions/media-playback/MediaPlaybackInterface.ts#L71)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`stop`](../interfaces/MediaPlaybackBehavior.md#stop)
...
[`MediaPlaybackBehavior`](../interfaces/MediaPlaybackBehavior.md).[`toString`](../interfaces/MediaPlaybackBehavior.md#tostring)
