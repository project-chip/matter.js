...
[@project-chip/matter-node.js](../../../modules.md) / [exports/device](../README.md) / PairedDevice
...
| :------ | :------ | :------ |
| `definition` | [[`DeviceTypeDefinition`](../interfaces/DeviceTypeDefinition.md), `...DeviceTypeDefinition[]`] | DeviceTypeDefinitions of the paired device as reported by the device |
| `clusters` | `undefined` \| ([`ClusterServerObj`](../../cluster/README.md#clusterserverobjae)\<[`Attributes`](../../cluster/interfaces/Attributes.md), [`Events`](../../cluster/interfaces/Events.md)\> \| [`ClusterClientObj`](../../cluster/README.md#clusterclientobjface)\<`any`, [`Attributes`](../../cluster/interfaces/Attributes.md), [`Commands`](../../cluster/interfaces/Commands.md), [`Events`](../../cluster/interfaces/Events.md)\>)[] | Clusters of the paired device as reported by the device |
| `endpointId` | [`EndpointNumber`](../../datatype/README.md#endpointnumber) | Endpoint ID of the paired device as reported by the device |
