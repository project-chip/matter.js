...
[@project-chip/matter-node.js](../../../../../modules.md) / [exports/cluster](../../../README.md) / [AudioOutput](../README.md) / Complete
...
> `readonly` **renameOutput**: [`Command`](../../../interfaces/Command.md)\<[`TypeFromFields`](../../../../tlv/README.md#typefromfieldsf)\<`object`\>, `void`, `any`\> & `object`
...
> `readonly` **id**: [`Branded`](../../../../../util/export/README.md#brandedtb)\<`1291`, `"ClusterId"`\>
