...
[@project-chip/matter-node.js](../../../../../modules.md) / [exports/cluster](../../../README.md) / [Binding](../README.md) / Cluster
...
> `readonly` **binding**: [`WritableFabricScopedAttribute`](../../../interfaces/WritableFabricScopedAttribute.md)\<[`TypeFromFields`](../../../../tlv/README.md#typefromfieldsf)\<`object`\>[], `any`\>
...
> **id**: [`Branded`](../../../../../util/export/README.md#brandedtb)\<`30`, `"ClusterId"`\>
