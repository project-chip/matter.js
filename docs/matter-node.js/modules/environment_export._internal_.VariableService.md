[@project-chip/matter-node.js](../README.md) / [Modules](../modules.md) / [environment/export](environment_export.md) / [\<internal\>](environment_export._internal_.md) / VariableService
