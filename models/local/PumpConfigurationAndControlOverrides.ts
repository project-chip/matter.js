...
LocalMatter.children.push({
    ...
    children: [
        ...
        // nothing else useful
        {
            tag: "attribute", id: 0x1d, name: "AlarmMask",
            children: [
                {
                    tag: "datatype", constraint: "0", name: "InitializationFailure",
                    details: "The device failed to complete initialization at powerup"
                },
                {
                    tag: "datatype", constraint: "1", name: "HardwareFailure",
                    details: "The device has detected a hardware fault"
                },
                {
                    tag: "datatype", constraint: "2", name: "SelfCalibrationFailure",
