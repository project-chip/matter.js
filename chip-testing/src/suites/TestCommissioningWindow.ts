...
/** Test case "TestCommissioningWindow" */
export class TestCommissioningWindow extends MinimalOnOffDeviceTestInstance {
    constructor(storage: StorageBackendMemory, overrideTestName?: string) {
        super(overrideTestName ?? "TestCommissioningWindow", "GeneralTestPicsFile.txt", storage);
    }
