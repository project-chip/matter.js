...
/** Test case "Test_TC_CADMIN_1_21" */
export class Test_TC_CADMIN_1_21 extends MinimalOnOffDeviceTestInstance {
    constructor(storage: StorageBackendMemory, overrideTestName?: string) {
        super(overrideTestName ?? "Test_TC_CADMIN_1_21", "GeneralTestPicsFile.txt", storage);
    }
}
