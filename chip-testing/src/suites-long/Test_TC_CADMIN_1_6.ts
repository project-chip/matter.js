...
/** Test case "Test_TC_CADMIN_1_6" */
export class Test_TC_CADMIN_1_6 extends MinimalOnOffDeviceTestInstance {
    constructor(storage: StorageBackendMemory, overrideTestName?: string) {
        super(overrideTestName ?? "Test_TC_CADMIN_1_6", "GeneralTestPicsFile.txt", storage);
    }
}
