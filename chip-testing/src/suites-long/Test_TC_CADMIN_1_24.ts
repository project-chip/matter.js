...
/** Test case "Test_TC_CADMIN_1_24" */
export class Test_TC_CADMIN_1_24 extends MinimalOnOffDeviceTestInstance {
    constructor(storage: StorageBackendMemory, overrideTestName?: string) {
        super(overrideTestName ?? "Test_TC_CADMIN_1_24", "GeneralTestPicsFile.txt", storage);
    }
}
